...
if ((!isset($_SESSION['validite_pw']) || empty($_SESSION['validite_pw']) || empty($_SESSION['user_id'])) && isset($_GET['otv']) && $_GET['otv'] == "true") {
    ...
    elseif (empty($_SESSION['user_id']) && isset($_GET['action']) && $_GET['action'] == "password_recovery") {
        ...
        echo '
            <div style="width:400px;margin:50px auto 50px auto;padding:25px;" class="ui-state-highlight ui-corner-all">
                ...
                <div style="margin:15px; text-align:center;">
                    <input type="button" id="but_generate_new_password" onclick="GenerateNewPassword(\'' . htmlspecialchars($_GET['key'],
                ENT_QUOTES) . '\',\'' . htmlspecialchars($_GET['login'],
                ENT_QUOTES) . '\')" style="padding:3px;cursor:pointer;" class="ui-state-default ui-corner-all" value="' . $LANG['pw_recovery_button'] . '" />
                    <br /><br />
        ...
        if (isset($_SESSION['settings']['maintenance_mode']) && $_SESSION['settings']['maintenance_mode'] == 1) {
            ...
            if (isset($_GET['session_over']) && $_GET['session_over'] == "true") {
...
echo '
    <div id="footer">
        ...
        <div style="float:right;text-align:right;">
            <i class="fa fa-clock-o"></i>&nbsp;' . $LANG['server_time'] . " : " . @date($_SESSION['settings']['date_format'],
        $_SERVER['REQUEST_TIME']) . " - " . @date($_SESSION['settings']['time_format'], $_SERVER['REQUEST_TIME']) . '
        </div>
    </div>';
// PAGE LOADING
echo '
