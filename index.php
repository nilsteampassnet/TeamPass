...
if (isset($_SESSION['login'])) {
    ...
    echo '               
                <div style="float:right;">                
                    <ul class="menu" style="" title="'.$LANG['last_items_icon_title'].'">
                ...
                <div style="float:right; margin-right:10px;">
                    <ul class="menu">
                        <li class="" style="padding: 4px;"><i class="fa fa-user fa-fw"></i>&nbsp;&nbsp;
                            <ul class="menu_200">';                

                        $rows = DB::query(
                            "SELECT DISTINCT i.label AS label, i.id AS id, i.id_tree AS id_tree
                        ...
                        foreach ($rows as $record) {
                            echo '
                                <li onclick="displayItemNumber('.$record['id'].', '.$record['id_tree'].')"><i class="fa fa-clock-o fa-fw"></i> &nbsp;'.addslashes($record['label']).'</li>';
                        }
                    echo '
                            </ul>
                        </li>
