    ...
    switch ($_POST['type']) {
        case "step1":
            ...
            if (!extension_loaded('gmp')) {
                $okExtensions = false;
                $txt .= '<span style=\"padding-left:30px;font-size:13pt;\">PHP extension \"gmp\"'.
                    '&nbsp;&nbsp;<img src=\"images/minus-circle.png\"></span><br />';
            } else {
                $txt .= '<span style=\"padding-left:30px;font-size:13pt;\">PHP extension \"gmp\"'.
                    '&nbsp;&nbsp;<img src=\"images/tick-circle.png\"></span><br />';
...
?>"
                ...
                $result3 = file_put_contents(
                    substr($skFile, 0, strlen($skFile)-6).$numberOfPairs .
                    "_". $keyLength . "_keys.inc.php", implode("\n", $file)
                );
                if (isset($result3) && $result3 === false) {
                    echo 'document.getElementById("res_step5").innerHTML = '.
                        '"Encryption Keys file could not be created. '.
                        'Please check the path and the rights.";';
                } else {
                    echo 'document.getElementById("step5_keysFile").innerHTML = '.
                        '"<img src=\"images/tick.png\">";';
                }

                //Finished
                if (
                    $result1 != false && $result3 != false
