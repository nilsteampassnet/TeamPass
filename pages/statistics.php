        ...
        <div class='row'>
            <div class='col-md-12'>
                ...
                <ul class='nav nav-tabs mb-3' id='tp-stats-main-tabs' role='tablist'>
                    <li class='nav-item'>
                        <a class='nav-link active' id='tp-stats-main-tab-ops' data-toggle='tab' href='#tp-stats-main-ops' role='tab' aria-controls='tp-stats-main-ops' aria-selected='true'>
                            <i class='fas fa-chart-line mr-1'></i><?php echo $lang->get('ops_tab_operational'); ?>
                        </a>
                    </li>
                    <li class='nav-item'>
                        <a class='nav-link' id='tp-stats-main-tab-legacy' data-toggle='tab' href='#tp-stats-main-legacy' role='tab' aria-controls='tp-stats-main-legacy' aria-selected='false'>
