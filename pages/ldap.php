                    ...
                    <form role='form-horizontal'>
                        <div class='card-body'>
                            ...
                            <div class='row mb-2<?php echo (isset($ldap_type) === true && $ldap_type === 'posix-search') ? '' : ' hidden'; ?>'>
                                ...
                                <div class='col-2'>
                                    <input type='text' class='form-control form-control-sm setting-ldap ldap-posix-search' id='ldap_bind_passwd' value='<?php echo isset($SETTINGS['ldap_bind_passwd']) ? $SETTINGS['ldap_bind_passwd'] : ''; ?>'>
                                </div>
                            </div>
                            ...
                            <div class='row mb-2<?php echo (isset($ldap_type) === true && $ldap_type === 'posix-search') ? '' : ' hidden'; ?>'>
                                ...
                                <div class='col-2'>
                                    <input type='text' class='form-control form-control-sm setting-ldap ldap-posix-search' id='ldap_search_base' value='<?php echo isset($SETTINGS['ldap_search_base']) ? $SETTINGS['ldap_search_base'] : ''; ?>'>
                                </div>
                            </div>
