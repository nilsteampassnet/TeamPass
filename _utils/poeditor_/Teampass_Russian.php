...
$LANG = array (
  ...
  array (
    ...
    'definition' => 'Генерировать новый набор ключей шифрования',
    'context' => '',
  ),
  76 => 
  array (
    'term' => 'admin_action_generate_encrypt_keys_tip',
    'definition' => 'Набор ключей шифрования очень важная часть системы безопасности TeamPass. Эти ключи используются для шифрования обмена между сервером и клиентом. Рекомендуется периодически по новой генерировать набор ключей. Обратите внимание, что процесс может занимать до 1 минуты.',
    'context' => '',
  ),
  77 => 
  array (
  ...
  array (
    ...
    'definition' => 'Папка для генерируемых TeamPass и загружаемых файлов. ВАЖНО: из соображений безопасности эта папка не должна находиться внутри WWW-папки сайта. Её необходимо расположить в защищенном месте и настроить правила перенаправления. Рекомендуется настроить расписание (cron) по очистке этой папки',
    'context' => '',
  ),
  172 => 
  array (
  ...
  array (
    ...
    'definition' => 'Информация: импорт должен осуществляться только из файла CSV. Обычно, файл, экспортированный из KeePass, имеет подходящую структуру.&lt;br /&gt; Если вы используете файл, сгенерированный другой программой, имейте ввиду, что структура файла CSV должна быть следующей: `Учетная запись`,`Имя`,`Пароль`,`URL`,`Комментарии`.',
    'context' => '',
  ),
  487 => 
  array (
  ...
  array (
    'term' => 'logs_1',
    'definition' => 'Генерировать отчет истечения срока действия паролей на ',
    'context' => '',
  ),
  559 => 
  array (
