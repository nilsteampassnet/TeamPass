...
$LANG = array (
  ...
  array (
    ...
    'definition' => 'データベースのバックアップを作成する。',
    'context' => '',
  ),
  249 => 
  array (
    'term' => 'admin_action_db_backup_key_tip',
    'definition' => '入力した暗号キーは忘れないようにどこかに記録してください。リストア時に求められます。(暗号化しない場合は空のまま実行してください。)',
    'context' => '',
  ),
  250 => 
  array (
  ...
  array (
    ...
    'definition' => 'データベースのバックアップファイルを作成し、後でリストアすることができます。',
    'context' => '',
  ),
  252 => 
  array (
    'term' => 'admin_action_db_clean_items',
    'definition' => 'データベースに残った削除済みアイテムを削除する。',
    'context' => '',
  ),
  253 => 
  array (
    'term' => 'admin_action_db_clean_items_result',
    'definition' => '個のアイテムが削除されました。',
    'context' => '',
  ),
  254 => 
  array (
    'term' => 'admin_action_db_clean_items_tip',
    'definition' => 'フォルダが削除された際に、そのフォルダに関連付けられていたアイテムとログはデータベース上にのこっていますので、これらを削除します。実行前にバックアップを作成することをお勧めします。',
    'context' => '',
  ),
  255 => 
  array (
    'term' => 'admin_action_db_optimize',
    'definition' => 'データベースを最適化する。',
    'context' => '',
  ),
  256 => 
  array (
    'term' => 'admin_action_db_restore',
    'definition' => 'データベースをリストアする。',
    'context' => '',
  ),
  257 => 
  array (
    'term' => 'admin_action_db_restore_key',
    'definition' => '暗号化キーを入力してください。',
    'context' => '',
  ),
  258 => 
  array (
    'term' => 'admin_action_db_restore_tip',
    'definition' => 'バックアップ機能で作成したSQLバックアップファイルを使用し、リストアします',
    'context' => '',
  ),
  259 => 
  array (
    'term' => 'admin_action_purge_old_files',
    'definition' => '古いキャッシュファイルを削除',
    'context' => '',
  ),
  260 => 
  array (
  ...
  array (
    ...
    'definition' => '7日以上前の一時ファイルを削除します。',
    'context' => '',
  ),
  262 => 
  array (
    'term' => 'admin_action_reload_cache_table',
    'definition' => 'キャッシュテーブルを再読み込みする',
    'context' => '',
  ),
  263 => 
  array (
  ...
  array (
    'term' => 'admin_main',
    'definition' => 'インフォメーション',
    'context' => '',
  ),
  275 => 
  array (
    'term' => 'admin_misc_cpassman_dir',
    'definition' => 'TeamPassへのフルパス',
    'context' => '',
  ),
  276 => 
  array (
    'term' => 'admin_misc_cpassman_url',
    'definition' => 'TeamPassへのフルURL',
    'context' => '',
  ),
  277 => 
  array (
  ...
  array (
    ...
    'definition' => '許可されたフォルダ',
    'context' => '',
  ),
  328 => 
  array (
    'term' => 'auth_creation_without_complexity',
    'definition' => '必要とされるパスワードの強度を無視したアイテムの作成を許可する。',
    'context' => '',
  ),
  329 => 
  array (
    'term' => 'auth_modification_without_complexity',
    'definition' => '必要とされるパスワードの強度を無視したアイテムの修正を許可する。',
    'context' => '',
  ),
  330 => 
  array (
  ...
  array (
    ...
    'definition' => '次のロールを削除します、よろしいですか？',
    'context' => '',
  ),
  367 => 
  array (
    'term' => 'confirm_edit_role',
    'definition' => '次のロールの名前を入力してください。:',
    'context' => '',
  ),
  368 => 
  array (
  ...
  array (
    ...
    'definition' => 'このページを閲覧する権限がありません。',
    'context' => '',
  ),
  427 => 
  array (
    'term' => 'error_not_exists',
    'definition' => 'ページが存在しません。',
    'context' => '',
  ),
  428 => 
  array (
    'term' => 'error_no_folders',
    'definition' => 'まずはフォルダを作成してください。',
    'context' => '',
  ),
  429 => 
  array (
  ...
  array (
    'term' => 'error_no_roles',
    'definition' => 'ロールも作成し、フォルダに関連付けをしてください。',
    'context' => '',
  ),
  431 => 
  array (
  ...
  array (
    ...
    'definition' => '禁止されたフォルダ',
    'context' => '',
  ),
  447 => 
  array (
    'term' => 'forgot_my_pw',
    'definition' => 'パスワードを忘れた',
    'context' => '',
  ),
  448 => 
  array (
  ...
  array (
    ...
    'definition' => 'あなたのパスワードがアカウントに紐付いたメールアドレスに送信されます。',
    'context' => '',
  ),
  451 => 
  array (
  ...
  array (
    ...
    'definition' => 'インポートしたアイテムすべてに"同じ権限ならだれでも修正できる" 権限を設定する。',
    'context' => '',
  ),
  485 => 
  array (
    'term' => 'import_csv_anyone_can_modify_txt',
    'definition' => 'インポートしたアイテムすべてに"誰でも修正できる"権限を設定する。',
    'context' => '',
  ),
  486 => 
  array (
    'term' => 'import_csv_dialog_info',
    'definition' => 'インフォメーション: インポートはCSV形式のファイルを使用して行われます。特に、KeePasからエクスポートされたファイルを想定した構成になってます。&lt;br /&gt;もし他のツールを使用してファイルを生成した場合は、CSVの構造が、`アカウント`,`ログイン名`,`パスワード`,`ウェブサイト`,`コメント`となっているかを確認してください。',
    'context' => '',
  ),
  487 => 
  array (
    'term' => 'import_csv_menu_title',
    'definition' => 'ファイルからアイテムをインポート(CSV/KeePass XML)',
    'context' => '',
  ),
  488 => 
  array (
  ...
  array (
    ...
    'definition' => 'KeepPassのエキスポート機能で作成したXMLファイルを使用する場合にこの機能を使用します。KeePassファイルでのみ動作します。ツリー構造の同階層レベルにフォルダやエレメントが既にある場合は、インポートされません。',
    'context' => '',
  ),
  492 => 
  array (
    'term' => 'import_keepass_to_folder',
    'definition' => 'インポート先フォルダを選択',
    'context' => '',
  ),
  493 => 
  array (
    'term' => 'import_kp_finished',
    'definition' => 'KeePassからのインポートが終了しました。&lt;br /&gt;デフォルトで新しくインポートされたフォルダに要求されるパスワードの複雑さは、”中”に設定されます。。必要に応じて設定を変更してください。',
    'context' => '',
  ),
  494 => 
  array (
  ...
  array (
    'term' => 'index_bas_pw',
    'definition' => 'アカウント又はパスワードが正しくありません。',
    'context' => '',
  ),
  498 => 
  array (
    'term' => 'index_change_pw',
    'definition' => '自分のパスワードを変更',
    'context' => '',
  ),
  499 => 
  array (
  ...
  array (
    ...
    'definition' => 'セッション残り時間',
    'context' => '',
  ),
  502 => 
  array (
    'term' => 'index_get_identified',
    'definition' => 'ログインしてください',
    'context' => '',
  ),
  503 => 
  array (
  ...
  array (
    ...
    'definition' => 'メンテナンスモードが有効になってます。管理者のみログインすることができます。',
    'context' => '',
  ),
  509 => 
  array (
    'term' => 'index_maintenance_mode_admin',
    'definition' => 'メンテナンスモードが有効になってます。 一般ユーザーは現在TeamPassにアクセスできません。',
    'context' => '',
  ),
  510 => 
  array (
  ...
  array (
    ...
    'definition' => '最後に見たアイテムを 表示/隠す',
    'context' => '',
  ),
  548 => 
  array (
    'term' => 'last_items_title',
    'definition' => '最後に見たアイテム',
    'context' => '',
  ),
  549 => 
  array (
  ...
  array (
    'term' => 'link_copy',
    'definition' => 'このアイテムのURLをクリップボードへコピー',
    'context' => '',
  ),
  552 => 
  array (
    'term' => 'link_is_copied',
    'definition' => 'このアイテムへのリンクをクリップボードにコピーしました。',
    'context' => '',
  ),
  553 => 
  array (
  ...
  array (
    ...
    'definition' => 'アカウントがロックされるログイン失敗回数(0は無制限)',
    'context' => '',
  ),
  569 => 
  array (
  ...
  array (
    ...
    'definition' => '古いパスワードを再利用する際にユーザーが入力しなければならないパスワードの回数',
    'context' => '',
  ),
  588 => 
  array (
  ...
  array (
    ...
    'definition' => 'Print out a listing of your items',
    'context' => '',
  ),
  601 => 
  array (
  ...
  array (
    'term' => 'pw_change',
    'definition' => 'アカウントのパスワード変更',
    'context' => '',
  ),
  605 => 
  array (
    'term' => 'pw_changed',
    'definition' => 'パスワードが変更されました!',
    'context' => '',
  ),
  606 => 
  array (
  ...
  array (
    ...
    'definition' => 'ユーザーのパスワード有効期限(日数指定, 0は無制限)',
    'context' => '',
  ),
  611 => 
  array (
  ...
  array (
    ...
    'definition' => '次の期間内に期限切れになるアイテムを表示:',
    'context' => '',
  ),
  621 => 
  array (
  ...
  array (
    ...
    'definition' => 'あなたのドメインのLDAPアカウントサフィックス',
    'context' => '',
  ),
  641 => 
  array (
    'term' => 'settings_ldap_domain_controler',
    'definition' => 'ドメインコントローラーのLDAPアレイ',
    'context' => '',
  ),
  642 => 
  array (
  ...
  array (
    ...
    'definition' => 'あなたのドメインのLDAPベース dn',
    'context' => '',
  ),
  644 => 
  array (
    'term' => 'settings_ldap_mode',
    'definition' => 'LDAPサーバーを使ったユーザー認証を有効にする。',
    'context' => '',
  ),
  645 => 
  array (
  ...
  array (
    ...
    'definition' => 'SSL経由でLDAPを使用する(LDAPS)',
    'context' => '',
  ),
  647 => 
  array (
    'term' => 'settings_ldap_tls',
    'definition' => 'TLS経由でLDAPを使用する',
    'context' => '',
  ),
  648 => 
  array (
  ...
  array (
    ...
    'definition' => '全てのユーザーのコネクションをDBにロギングする。',
    'context' => '',
  ),
  650 => 
  array (
    'term' => 'settings_maintenance_mode',
    'definition' => 'メンテナンスモードに設定',
    'context' => '',
  ),
  651 => 
  array (
    'term' => 'settings_maintenance_mode_tip',
    'definition' => 'このモードは管理者以外の全てのユーザーコネクションを拒絶します。',
    'context' => '',
  ),
  652 => 
  array (
  ...
  array (
    ...
    'definition' => 'TeamPassの利用状況を伝えるために、月間統計情報を作者に送信する。',
    'context' => '',
  ),
  659 => 
  array (
  ...
  array (
    'term' => 'url_copied',
    'definition' => 'URLがコピーされました!',
    'context' => '',
  ),
  681 => 
  array (
    'term' => 'used_pw',
    'definition' => '使用されているパスワード',
    'context' => '',
  ),
  682 => 
  array (
