...
$LANG = array (
  ...
  array (
    'term' => 'user_ga_code',
    'definition' => 'Enviar el código de GoogleAuthenticator por correo al usuario',
    'context' => '',
  ),
  1 => 
  array (
  ...
  array (
    ...
    'definition' => 'Su código de Google Authenticator para Teampass',
    'context' => '',
  ),
  5 => 
  array (
    'term' => 'email_ga_text',
    'definition' => 'Hola,<br><br>Por favor haz click aquí <a href=\'#link#\'>LINK</a> y actualizalo con la aplicación Google Authenticator para que obtengas tus credenciales OTP para Teampass.<br /><br />Saludos',
    'context' => '',
  ),
  6 => 
  array (
    'term' => 'settings_attachments_encryption',
    'definition' => 'Habilitar cifrado de los elementos adjuntos',
    'context' => '',
  ),
  7 => 
  array (
    'term' => 'settings_attachments_encryption_tip',
    'definition' => 'ESTA OPCIÓN PODRÍA CORROMPER ADJUNTOS EXISTENTES, por favor lea atentamente lo siguiente. Si está habilitado, los adjuntos se almacenan cifrados en el servidor. El cifrado utiliza la función SALT definida por Teampass. Esta opción necesita más recursos en el servidor. ATENCIÓN: una que vez lo modifiques, es obligatorio ejecutar el script para adaptar los adjuntos existentes. Vea la pestaña: \'Acciones específicas\'',
    'context' => '',
  ),
  8 => 
  array (
    'term' => 'admin_action_attachments_cryption',
    'definition' => 'Cifrar o descifrar los elementos adjuntos',
    'context' => '',
  ),
  9 => 
  array (
    'term' => 'admin_action_attachments_cryption_tip',
    'definition' => 'ATENCIÓN: esta acción tiene que ser ejecutada ÚNICAMENTE después de cambiar la opción asociada en la configuración de Teampass. Por favor, haga una copia de la carpeta \'upload\' antes de  ejecutar cualquier acción. por si acaso...',
    'context' => '',
  ),
  10 => 
  array (
  ...
  array (
    ...
    'definition' => 'Nombre mostrado de Google Authenticator para Teampass',
    'context' => '',
  ),
  13 => 
  array (
    'term' => 'admin_ga_website_name_tip',
    'definition' => 'Este nombre se utiliza para la cuenta de código de identificación en Google Authenticator.',
    'context' => '',
  ),
  14 => 
  array (
    'term' => 'admin_action_pw_prefix_correct',
    'definition' => 'Corregir los prefijos de contraseñas.',
    'context' => '',
  ),
  15 => 
  array (
    'term' => 'admin_action_pw_prefix_correct_tip',
    'definition' => 'Antes de ejecutar este script, POR FAVOR haga una copia de seguridad de la base de datos. Este script ejecutará una modificación del prefijo de las contraseñas. Se debería utilizar únicamente si nota que las contraseñas se muestran con un prefijo extraño.',
    'context' => '',
  ),
  16 => 
  array (
  ...
  array (
    ...
    'definition' => 'Identifícate con Google Authenticator.',
    'context' => '',
  ),
  18 => 
  array (
    'term' => 'ga_scan_url',
    'definition' => 'Por favor, escanee este código con su aplicación móvil Google Autheticator. Copie de ella el código de identificación.',
    'context' => '',
  ),
  19 => 
  array (
    'term' => 'ga_identification_code',
    'definition' => 'Código de identificación',
    'context' => '',
  ),
  20 => 
  array (
    'term' => 'ga_enter_credentials',
    'definition' => 'Debe introducir los crendenciales de usuario',
    'context' => '',
  ),
  21 => 
  array (
    'term' => 'ga_bad_code',
    'definition' => 'El código de autentificación de Google es incorrecto',
    'context' => '',
  ),
  22 => 
  array (
    'term' => 'settings_get_tp_info',
    'definition' => 'Cargar automáticamente la información de Teampass',
    'context' => '',
  ),
  23 => 
  array (
    'term' => 'settings_get_tp_info_tip',
    'definition' => 'Esta opción permite a la pagina administración cargar información de versiones y librerías usadas en el servidor de Teampass.',
    'context' => '',
  ),
  24 => 
  array (
  ...
  array (
    ...
    'definition' => 'Editar carpeta para esta Categoría',
    'context' => '',
  ),
  27 => 
  array (
    'term' => 'select_folders_for_category',
    'definition' => 'Seleccione la Carpeta para asociar con esta Categoría de campos',
    'context' => '',
  ),
  28 => 
  array (
    'term' => 'offline_mode_warning',
    'definition' => 'El modo Fuera de linea, permite exportar los items a un archivo HTML para acceder cuando no se dispone de una conexión al servidor de Teampass. Las contraseñas son cifradas por una clave.',
    'context' => '',
  ),
  29 => 
  array (
  ...
  array (
    ...
    'definition' => 'El modo Fuera de linea consiste en exportar los items en un archivo HTML. Los items son cifrados con una clave dada por el usuario.',
    'context' => '',
  ),
  32 => 
  array (
    'term' => 'offline_mode_key_level',
    'definition' => 'Calidad mínima para la clave de cifrado Fuera de linea.',
    'context' => '',
  ),
  33 => 
  array (
  ...
  array (
    ...
    'definition' => 'Crear nueva Categoría - Introducir etiqueta',
    'context' => '',
  ),
  35 => 
  array (
    'term' => 'no_category_defined',
    'definition' => 'Aun no hay Categorías definidas',
    'context' => '',
  ),
  36 => 
  array (
  ...
  array (
    ...
    'definition' => 'Introduzca el título del nuevo Campo',
    'context' => '',
  ),
  39 => 
  array (
  ...
  array (
    'term' => 'confirm_moveto',
    'definition' => 'Confirma el movimiento del campo?',
    'context' => '',
  ),
  41 => 
  array (
    'term' => 'for_selected_items',
    'definition' => 'Para el elemento seleccionado',
    'context' => '',
  ),
  42 => 
  array (
  ...
  array (
    ...
    'definition' => 'Añadir un nuevo campo en ésta categoría',
    'context' => '',
  ),
  44 => 
  array (
  ...
  array (
    ...
    'definition' => 'Guardar el orden de las categorías.',
    'context' => '',
  ),
  50 => 
  array (
  ...
  array (
    ...
    'definition' => 'Una vez activada, debes ejecutar manualmente el script que crea las carpetas personales para los usuarios existentes. Está opción únicamente creará las carpetas personales para usuarios que no tienen creada dicha carpeta.
El script \'".$txt[\'admin_action_check_pf\']."\' está habilitado en la pestaña \'".$txt[\'admin_actions_title\']."\' ',
    'context' => '',
  ),
  64 => 
  array (
  ...
  array (
    ...
    'definition' => 'Forzar el uso de HTTPS-STS (Strict Transport Security) -- Cuidado: Leer el consejo.',
    'context' => '',
  ),
  71 => 
  array (
    'term' => 'settings_enable_sts_tip',
    'definition' => 'Esto forzará el uso del protocolo HTTPS STS. Este protocolo ayuda a evitar los ataques SSL del tipo "Man-in-The Middle". DEBERÍAS tener un certificado SSL valido para poder usar esta opción. Si tienes un certificado auto-firmado y habilitas esta opción, ¡¡perderás el acceso a la aplicación!!. DEBES tener la línea \'SSLOptions +ExportCertData\' en la configuración SSL de Apache.',
    'context' => '',
  ),
  72 => 
  array (
    'term' => 'channel_encryption_no_gmp',
    'definition' => '!Extensión GMP no cargada! ¡No se puede iniciar el cifrado!',
    'context' => '',
  ),
  73 => 
  array (
...
&lt;span style=\'font-size:11px;max-width:300px;\'&gt;Si ha establecido una IP para el proxy, indique ahora su PUERTO (podría ser 8080).&lt;br /&gt;Déjelo en blanco si no hay proxy.&lt;/span&gt;',
  ...
  array (
    ...
    'definition' => '¡El Rol debe tener un nivel mínimo de complejidad requerido para las contraseñas!',
    'context' => '',
  ),
  108 => 
  array (
  ...
  array (
    ...
    'definition' => 'Esta prueba enviará un email a la dirección indicada. Si no lo recibes, por favor comprueba tus credenciales.',
    'context' => '',
  ),
  159 => 
  array (
  ...
  array (
    ...
    'definition' => 'Habilitar la introducción de elementos en el LOG historico de los elementos.',
    'context' => '',
  ),
  179 => 
  array (
    'term' => 'settings_insert_manual_entry_item_history_tip',
    'definition' => 'Si por algún motivo necesitases añadir manualmente una entrada en  el LOG histórico del elemento, activando esta característica sería posible.',
    'context' => '',
  ),
  180 => 
  array (
  ...
  array (
    ...
    'definition' => 'Migrar objetos pesonales a una cuenta de usuario.',
    'context' => '',
  ),
  211 => 
  array (
    'term' => 'migrate_pf_select_to',
    'definition' => 'Migrar objetos personales a un usuario',
    'context' => '',
  ),
  212 => 
  array (
    'term' => 'migrate_pf_user_salt',
    'definition' => 'Introduce la contraseña "SALT" para el Usuario seleccionado',
    'context' => '',
  ),
  213 => 
  array (
    'term' => 'migrate_pf_no_sk',
    'definition' => 'No has introducido tu clave SALT',
    'context' => '',
  ),
  214 => 
  array (
    'term' => 'migrate_pf_no_sk_user',
    'definition' => 'Debes introducir tu clave SALT de usuario',
    'context' => '',
  ),
  215 => 
  array (
    'term' => 'migrate_pf_no_user_id',
    'definition' => 'Debes seleccionar el usuario";',
    'context' => '',
  ),
  216 => 
  array (
...
¡Por lo tanto, no la pierda!',
  ...
  array (
    ...
    'definition' => 'URL copiada al portapapeles',
    'context' => '',
  ),
  699 => 
  array (
  ...
  array (
    ...
    'definition' => 'Vínculo de un solo uso',
    'context' => '',
  ),
  701 => 
  array (
    'term' => 'one_time_view_item_url_box',
    'definition' => 'Compartir la URL One-Time con una persona de confianza <br><br>#URL#<br><br>Recuerda que este link será visible una vez hasta el #DAY# ',
    'context' => '',
  ),
  702 => 
  array (
  ...
  array (
    'term' => 'settings_api',
    'definition' => 'Habilitar el acceso los elementos de Teampass a través de la API',
    'context' => '',
  ),
  704 => 
  array (
    'term' => 'settings_api_tip',
    'definition' => 'El acceso a la API permite acceder a los elementos desde una aplicación de terceros en formato JSON',
    'context' => '',
  ),
  705 => 
  array (
  ...
  array (
    ...
    'definition' => 'Estas son las claves que tienen permitido el acceso a Teampass. Sin una clave válida, el acceso no es posible. Debería compartir estas claves con cuidado.',
    'context' => '',
  ),
  707 => 
  array (
  ...
  array (
    ...
    'definition' => 'Lista blanca de de IPs autorizadas.',
    'context' => '',
  ),
  713 => 
  array (
    'term' => 'settings_api_ip_whitelist_tip',
    'definition' => 'Si no hay IPs listadas, entonces todas las IPs están autorizadas.',
    'context' => '',
  ),
  714 => 
  array (
  ...
  array (
    ...
    'definition' => 'Índica una etiqueta para esta nueva clave (no es necesario pero recomendado)',
    'context' => '',
  ),
  716 => 
  array (
  ...
  array (
    ...
    'definition' => 'Índica una etiqueta para esta nueva IP',
    'context' => '',
  ),
  719 => 
  array (
    'term' => 'settings_api_world_open',
    'definition' => 'No IP definida. Esta característica esta disponible desde cualquier lugar (puede ser inseguro).',
    'context' => '',
  ),
  720 => 
  array (
    'term' => 'subfolder_rights_as_parent',
    'definition' => 'Las nuevas sub-carpetas heredan los permisos de las carpetas de las que dependen.',
    'context' => '',
  ),
  721 => 
  array (
    'term' => 'subfolder_rights_as_parent_tip',
    'definition' => 'Cuando esta característica esta deshabilitada, cada nuevo sub-carpeta hereda los permisos asociados al rol del usuario que la crea. Si esta habilitada, cada nueva subcarpeta heredará los permisos de la carpeta superior.',
    'context' => '',
  ),
  722 => 
  array (
    'term' => 'show_only_accessible_folders_tip',
    'definition' => 'Por defecto, el usuario puede ver la ruta completa del árbol incluso aunque no tenga permisos de acceso a todas las carpetas. Deberías simplificar esto eliminando las carpetas del árbol a las que el usuario no tiene acceso.',
    'context' => '',
  ),
  723 => 
  array (
    'term' => 'show_only_accessible_folders',
    'definition' => 'Simplificar el árbol de elementos eliminando las carpetas a las que el usuario no tiene acceso',
    'context' => '',
  ),
  724 => 
  array (
    'term' => 'suggestion',
    'definition' => 'Sugerencias de elementos',
    'context' => '',
  ),
  725 => 
  array (
  ...
  array (
    ...
    'definition' => 'Confirma la eliminación de la sugerencia',
    'context' => '',
  ),
  729 => 
  array (
    'term' => 'suggestion_validate_confirm',
    'definition' => 'Confirme la validación de la sugerencia',
    'context' => '',
  ),
  730 => 
  array (
    'term' => 'suggestion_validate',
    'definition' => 'Ha decidido añadir esta sugerencia a la liste de elementos...por favor confirma',
    'context' => '',
  ),
  731 => 
  array (
    'term' => 'suggestion_error_cannot_add',
    'definition' => 'ERROR - La sugerencia no puede añadirse como un elemento',
    'context' => '',
  ),
  732 => 
  array (
    'term' => 'suggestion_is_duplicate',
    'definition' => 'PRECAUCIÓN: esta sugerencia tiene un elemento similar (con misma etiqueta y carpeta). Si pulsas sobre el botor AÑADIR, este elemento será actualizado con los datos sugeridos.',
    'context' => '',
  ),
  733 => 
  array (
    'term' => 'suggestion_menu',
    'definition' => 'Sugerencias',
    'context' => '',
  ),
  734 => 
  array (
    'term' => 'settings_suggestion',
    'definition' => 'Habilitar la sugerencia de elementos para usuarios de solo lectura.',
    'context' => '',
  ),
  735 => 
  array (
    'term' => 'settings_suggestion_tip',
    'definition' => 'Elementos sugeridos permite a los usuarios con permisos de solo Lectura el poder proponer nuevos elementos o su modificación. Estas sugerencias deberán ser validadas por el administrador o el gestor de usuarios.',
    'context' => '',
  ),
  736 => 
  array (
  ...
  array (
    ...
    'definition' => 'Un Bind dn que pueda enlazar y buscar usuarios en el árbol',
    'context' => '',
  ),
  741 => 
  array (
    'term' => 'settings_ldap_bind_passwd_tip',
    'definition' => 'Contraseña para el Bind dn que enlaza y busca usuarios en el árbol',
    'context' => '',
  ),
  742 => 
  array (
    'term' => 'settings_ldap_search_base_tip',
    'definition' => 'Buscar en la raiz DN para búsquedas en el arbol',
    'context' => '',
  ),
  743 => 
  array (
    'term' => 'old_saltkey',
    'definition' => 'SALT key antigua',
    'context' => '',
  ),
  744 => 
  array (
    'term' => 'define_old_saltkey',
    'definition' => 'Quiero espeficicar la clave de SALT antigua para usar (opcional)',
    'context' => '',
  ),
  745 => 
  array (
    'term' => 'admin_email_server_url_tip',
    'definition' => 'Personalizar la URL que será usada en los enlaces de los correos electrónicos si no se quiere usar la establecida por defecto.',
    'context' => '',
  ),
  746 => 
  array (
    'term' => 'admin_email_server_url',
    'definition' => 'URL del servidor para los enlaces de los correos',
    'context' => '',
  ),
  747 => 
  array (
    'term' => 'generated_pw',
    'definition' => 'Contraseña generada',
    'context' => '',
  ),
  748 => 
  array (
    'term' => 'enable_email_notification_on_user_pw_change',
    'definition' => 'Enviar un correo al Usuario cuando su contraseña haya sido modificada',
    'context' => '',
  ),
  749 => 
  array (
    'term' => 'settings_otv_expiration_period',
    'definition' => 'Espera antes de expiración de nuevos elementos compartidos mediante "una sola visión" (One Time View - OTV) (en días)',
    'context' => '',
  ),
  750 => 
  array (
    'term' => 'change_right_access',
    'definition' => 'Establece los permisos de acceso',
    'context' => '',
  ),
  751 => 
  array (
    'term' => 'write',
    'definition' => 'Escritura',
    'context' => '',
  ),
  752 => 
  array (
  ...
  array (
    'term' => 'no_access',
    'definition' => 'Sin Acceso',
    'context' => '',
  ),
  754 => 
  array (
    'term' => 'right_types_label',
    'definition' => 'Selecciona el tipo de acceso para la carpeta para el grupo de usuarios seleccionado',
    'context' => '',
  ),
  755 => 
  array (
  ...
  array (
    'term' => 'duplicate',
    'definition' => 'Duplicado',
    'context' => '',
  ),
  757 => 
  array (
    'term' => 'duplicate_title_in_same_folder',
    'definition' => '!Ya existe un elemento con el mismo nombre en la carpeta actual! ¡No se permiten nombres duplicados!',
    'context' => '',
  ),
  758 => 
  array (
    'term' => 'duplicate_item_in_folder',
    'definition' => 'Permitir claves con similar etiqueta en una carpeta común',
    'context' => '',
  ),
  759 => 
  array (
    'term' => 'find_message',
    'definition' => '<i class="fa fa-info-circle"></i> %X% objeto(s) encontrado(s)',
    'context' => '',
  ),
  760 => 
  array (
    'term' => 'settings_roles_allowed_to_print',
    'definition' => 'Define los roles que podrán imprimir los elementos.',
    'context' => '',
  ),
  761 => 
  array (
    'term' => 'settings_roles_allowed_to_print_tip',
    'definition' => 'Los roles seleccionados serán capaces de imprimir el contenido en un archivo.',
    'context' => '',
  ),
  762 => 
  array (
    'term' => 'user_profile_dialogbox_menu',
    'definition' => 'Tu información Teampass',
    'context' => '',
  ),
  763 => 
  array (
    'term' => 'admin_email_security',
    'definition' => 'Seguridad SMTP',
    'context' => '',
  ),
  764 => 
  array (
    'term' => 'alert_page_will_reload',
    'definition' => 'La página será actualizada',
    'context' => '',
  ),
  765 => 
  array (
    'term' => 'csv_import_items_selection',
    'definition' => 'Selecciona los objetos a importar',
    'context' => '',
  ),
  766 => 
  array (
    'term' => 'csv_import_options',
    'definition' => 'Selecciona las opciones de importación',
    'context' => '',
  ),
  767 => 
  array (
    'term' => 'file_protection_password',
    'definition' => 'Define el fichero contraseña',
    'context' => '',
  ),
  768 => 
  array (
    'term' => 'button_export_file',
    'definition' => 'Exporta objetos',
    'context' => '',
  ),
  769 => 
  array (
    'term' => 'error_export_format_not_selected',
    'definition' => 'El formato del fichero es necesario',
    'context' => '',
  ),
  770 => 
  array (
    'term' => 'select_file_format',
    'definition' => 'Selecciona el formato del fichero',
    'context' => '',
  ),
  771 => 
  array (
    'term' => 'button_offline_generate',
    'definition' => 'Generar archivo para modo Offline',
    'context' => '',
  ),
  772 => 
  array (
    'term' => 'upload_new_avatar',
    'definition' => 'Selecciona el archivo PNG del avatar',
    'context' => '',
  ),
  773 => 
  array (
  ...
  array (
    ...
    'definition' => 'Error: !No se encuentra el archivo!',
    'context' => '',
  ),
  776 => 
  array (
    'term' => 'click_to_change',
    'definition' => 'Clic para cambiar',
    'context' => '',
  ),
  777 => 
  array (
    'term' => 'settings_ldap_user_attribute',
    'definition' => 'Busqueda de atributo de usuario',
    'context' => '',
  ),
  778 => 
  array (
    'term' => 'settings_ldap_user_attribute_tip',
    'definition' => 'Atributo LDAP para la búsqueda de nombres de usuario',
    'context' => '',
  ),
  779 => 
  array (
    'term' => 'user_ga_code_sent_by_email',
    'definition' => 'El nuevo código de GoogleAuthenticator fue enviado a tu correo electrónico.',
    'context' => '',
  ),
  780 => 
  array (
    'term' => 'log_user_initial_pwd_changed',
    'definition' => 'Contraseña inicial establecida',
    'context' => '',
  ),
  781 => 
  array (
    'term' => 'log_user_email_changed',
    'definition' => 'El correo del usuario fue cambiado por ',
    'context' => '',
  ),
  782 => 
  array (
    'term' => 'log_user_created',
    'definition' => 'Cuenta de usuario creada',
    'context' => '',
  ),
  783 => 
  array (
    'term' => 'log_user_locked',
    'definition' => 'El usuario ha sido bloqueado',
    'context' => '',
  ),
  784 => 
  array (
    'term' => 'log_user_unlocked',
    'definition' => 'El usuario ha sido desbloqueado',
    'context' => '',
  ),
  785 => 
  array (
    'term' => 'log_user_pwd_changed',
    'definition' => 'La contraseña del usuario ha sido cambiada',
    'context' => '',
  ),
  786 => 
  array (
    'term' => 'edit_user',
    'definition' => 'Editar usuario',
    'context' => '',
  ),
  787 => 
  array (
    'term' => 'pf_change_encryption',
    'definition' => 'El algoritmo de cifrado ha sido cambiado y tus contraseñas personales han de cifrarse de nuevo. Necesitas ejecutar este proceso para usar tus contraseñas. Este proceso puede llevar varios minutos dependiendo del número de contraseñas que tengas.',
    'context' => '',
  ),
  788 => 
  array (
    'term' => 'operation_encryption_done',
    'definition' => 'El proceso de re-cifrado ha finalizado. Puedes cerrar esta ventana de aviso.',
    'context' => '',
  ),
  789 => 
  array (
    'term' => 'show_password',
    'definition' => 'Mostrar contraseña',
    'context' => '',
  ),
  790 => 
  array (
    'term' => 'change_password',
    'definition' => 'Cambiar contraseña',
    'context' => '',
  ),
  791 => 
  array (
    'term' => 'pf_sk_set',
    'definition' => 'Su clave "Salt" personal se ha establecido correctamente, puede pulsar sobre el botón Empezar',
    'context' => '',
  ),
  792 => 
  array (
    'term' => 'pf_sk_not_set',
    'definition' => '¡Su clave "Salt" personal no ha sido establecida! Por favor, introdúzcala.',
    'context' => '',
  ),
  793 => 
  array (
    'term' => 'upgrade_needed',
    'definition' => 'Actualización necesaria',
    'context' => '',
  ),
  794 => 
  array (
    'term' => 'item_menu_mov_rep',
    'definition' => 'Mover una carpeta',
    'context' => '',
  ),
  795 => 
  array (
    'term' => 'settings_default_session_expiration_time',
    'definition' => 'El tiempo de expiración de la sesión por defecto',
    'context' => '',
  ),
  796 => 
  array (
    'term' => 'duo_message',
    'definition' => 'Las comprobaciones de DUO Security se han realizado. Enviando las credenciales a Teampass.<br />Por favor, espere... la página se recargará cuando el proceso de validación haya finalizado.',
  ...
  array (
    ...
    'definition' => 'La marco de validación de DUOSecurity esta siendo cargado. Por favor, espere.',
    'context' => '',
  ),
  798 => 
  array (
    'term' => 'settings_duo',
    'definition' => 'Habilitar DUOSecurity.com como proveedor de doble factor de validación',
    'context' => '',
  ),
  799 => 
  array (
    'term' => 'settings_duo_tip',
    'definition' => 'La validación de doble factor puede ser asegurada usando DUOSecurity.com. Esta libreria garantiza un alto nivel de seguridad en cuanto a la validación del usuario.',
    'context' => '',
  ),
  800 => 
  array (
  ...
  array (
    ...
    'definition' => 'Generar una clave aleatoria consistente',
    'context' => '',
  ),
  805 => 
  array (
    'term' => 'duo_save_sk_file',
    'definition' => 'Guardar datos en el archivo sk.php',
    'context' => '',
  ),
  806 => 
  array (
    'term' => 'settings_duo_explanation',
    'definition' => 'Estas credenciales son las entregadas para la aplicación web que has creado específicamente para Teampass desde la página de administración de DUOSecurity.<br />Pulsando en el botón GUARDAR se almacenarán en el archivo sk.php.',
    'context' => '',
  ),
  807 => 
  array (
    'term' => 'admin_duo_intro',
    'definition' => 'Rellena los siguientes campos con los datos necesarios',
    'context' => '',
  ),
  808 => 
  array (
    'term' => 'admin_duo_stored',
    'definition' => '¡Credenciales almacenadas correctamente!',
    'context' => '',
  ),
  809 => 
  array (
    'term' => 'user_not_exists',
    'definition' => 'El usuario no existe!',
    'context' => '',
  ),
  810 => 
  array (
    'term' => 'dialog_admin_user_edit_title',
    'definition' => 'Editando cuenta de usuario',
    'context' => '',
  ),
  811 => 
  array (
    'term' => 'user_info_delete',
    'definition' => 'Por favor has click nuevamente para confirmar la ELIMINACIÓN de esta cuenta.',
    'context' => '',
  ),
  812 => 
  array (
    'term' => 'user_info_delete_warning',
    'definition' => 'Al hacer click en el botón Guardar, borrarás esta cuenta de Teampass.<br/>No es posible deshacer esta acción.',
    'context' => '',
  ),
  813 => 
  array (
  ...
  array (
    ...
    'definition' => 'El usuario se encuentra BLOQUEADO.',
    'context' => '',
  ),
  815 => 
  array (
    'term' => 'user_info_unlock_question',
    'definition' => '¿Desbloquear cuenta?',
    'context' => '',
  ),
  816 => 
  array (
    'term' => 'user_info_lock_question',
    'definition' => '¿Bloquear cuenta?',
    'context' => '',
  ),
  817 => 
  array (
  ...
  array (
    ...
    'definition' => 'El usuario esta ACTIVO.',
    'context' => '',
  ),
  819 => 
  array (
    'term' => 'settings_ldap_domain_posix',
    'definition' => 'Sufijo para cuenta LDAP de tu dominio',
    'context' => '',
  ),
  820 => 
  array (
    'term' => 'refresh',
    'definition' => 'Actualizar',
    'context' => '',
  ),
  821 => 
  array (
  ...
  array (
    ...
    'definition' => 'Mostrando contraseña',
    'context' => '',
  ),
  823 => 
  array (
    'term' => 'at_password_copied',
    'definition' => 'Contraseña copiada.',
    'context' => '',
  ),
  824 => 
  array (
    'term' => 'search_results',
    'definition' => 'Resultados de búsqueda',
    'context' => '',
  ),
  825 => 
  array (
  ...
  array (
    ...
    'definition' => 'Resultados de búsqueda por etiqueta',
    'context' => '',
  ),
  827 => 
  array (
    'term' => 'searching_tag',
    'definition' => 'Buscando etiqueta',
    'context' => '',
  ),
  828 => 
  array (
    'term' => 'list_items_with_tag',
    'definition' => 'Mostrar items con esta etiqueta',
    'context' => '',
  ),
  829 => 
  array (
    'term' => 'no_item_to_display',
    'definition' => 'No hay items para mostrar',
    'context' => '',
  ),
  830 => 
  array (
    'term' => 'opening_folder',
    'definition' => 'Folder de lectura ...',
    'context' => '',
  ),
  831 => 
  array (
    'term' => 'please_confirm',
    'definition' => 'Por favor confirma',
    'context' => '',
  ),
  832 => 
  array (
    'term' => 'suggestion_notify_subject',
    'definition' => '[Teampass] Una nueva sugerencia ha sido creada',
    'context' => '',
  ),
  833 => 
  array (
    'term' => 'suggestion_notify_body',
    'definition' => 'Hola, <br><br>Una nueva sugerencia ha sido creada. Necesitas validarla antes de que pueda ser vista por otros usuarios.
<br>Un extracto sobre ella:<br>Etiqueta:#tp_label#<br>- Directorio: <br>#tp_folder#<br>- Usuario: #tp_user#<br><br>Este correo se ha enviado a todos los Administradores.<br><br>Saludos',
    'context' => '',
  ),
  834 => 
  array (
    'term' => 'error_unknown',
    'definition' => '¡Un error desconocido ha ocurrido!',
    'context' => '',
  ),
  835 => 
  array (
    'term' => 'no_edit_no_delete',
    'definition' => 'Escritura pero no edición y no eliminación',
    'context' => '',
  ),
  836 => 
  array (
    'term' => 'no_edit',
    'definition' => 'Escritura pero no edición',
    'context' => '',
  ),
  837 => 
  array (
    'term' => 'role_cannot_edit_item',
    'definition' => 'No se pueden editar los items',
    'context' => '',
  ),
  838 => 
  array (
    'term' => 'no_delete',
    'definition' => 'Escritura pero no eliminación',
    'context' => '',
  ),
  839 => 
  array (
    'term' => 'role_cannot_delete_item',
    'definition' => 'No se pueden eliminar items',
    'context' => '',
  ),
  840 => 
  array (
    'term' => 'text_without_symbols',
    'definition' => 'Sólo números, letras y símbolos #&%*$@() están permitidos. ',
    'context' => '',
  ),
  841 => 
  array (
    'term' => 'my_profile',
    'definition' => 'Mi perfil.',
    'context' => '',
  ),
  842 => 
  array (
    'term' => 'at_suggestion',
    'definition' => 'Sugerencia aceptada.',
    'context' => '',
  ),
  843 => 
  array (
    'term' => 'character_not_allowed',
    'definition' => 'El carácter no está permitido.',
    'context' => '',
  ),
  844 => 
  array (
