...
$LANG = array (
  ...
  array (
    'term' => 'email_ga_text',
    'definition' => 'Здравствуйте! Пожалуйста, перейдите по <a href=\'#link#\'>ссылке</a> и сфотографируйте страницу при помощи приложения Google Authenticator, чтобы получить учетные данные OTP для TeamPass',
    'context' => '',
  ),
  6 => 
  array (
  ...
  array (
    ...
    'definition' => 'Вы потеряли свой ключ шифрования? Вот ведь незадача, эту потерю не восстановить. ВНИМАНИЕ: все существующие записи в личном разделе будут утеряны. Вы уверены в том, что его потеряли?',
    'context' => '',
  ),
  222 => 
  array (
  ...
  array (
    ...
    'definition' => 'Перед изменением ключа шифрования, сделайте полную резервную копию БД и переведите TeamPass в режим обслуживания, чтобы не было вошедших пользователей.',
    'context' => '',
  ),
  229 => 
  array (
  ...
  array (
    'term' => 'error_salt',
    'definition' => '<b>Ключ шифрования слишком длинный! Пожалуйста, не пользуйтесь Teampass пока Администратор не изменить ключ шифрования.</b> Ключ шифрования должен быть не длиннее 32 символов!',
    'context' => '',
  ),
  435 => 
  array (
  ...
  array (
    ...
    'definition' => 'Убедитесь, что используете исходный ключ шифрования, иначе шифрование будет нарушено. Перед любыми изменениями проверьте свой ключ шифрования!',
    'context' => '',
  ),
  576 => 
  array (
