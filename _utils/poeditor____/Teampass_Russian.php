...
$LANG = array (
  ...
  array (
    'term' => 'user_ga_code',
    'definition' => 'Отправить приложение GoogleAuthenticator на ящик пользователю',
    'context' => '',
  ),
  1 => 
  array (
    'term' => 'send_ga_code',
    'definition' => 'Код GoogleAuthenticator для пользователя',
    'context' => '',
  ),
  2 => 
  array (
    'term' => 'error_no_email',
    'definition' => 'У пользователя не задан почтовый ящик!',
    'context' => '',
  ),
  3 => 
  array (
  ...
  array (
    ...
    'definition' => 'Ваш код  GoogleAuthenticator для TeamPass',
    'context' => '',
  ),
  5 => 
  array (
    'term' => 'email_ga_text',
    'definition' => 'Здравствуйте! Пожалуйста, перейдите по <a href=\'#link#\'>ссылке</a> и сфотографируйте страницу при помощи приложения GoogleAuthenticator, чтобы получить учетные данные OTP для TeamPass',
    'context' => '',
  ),
  6 => 
  array (
    'term' => 'settings_attachments_encryption',
    'definition' => 'Включить шифрование приложений к элементам',
    'context' => '',
  ),
  7 => 
  array (
    'term' => 'settings_attachments_encryption_tip',
    'definition' => 'ЭТА НАСТРОЙКА МОЖЕТ ПОВРЕДИТЬ СУЩЕСТВУЮЩИЕ ПРИЛОЖЕНИЯ. Если настройка включена, то приложения к элементам хранятся на сервере зашифрованными с использованием соли (SALT) заданной в TeamPass. Это потребует больше ресурсов сервера. ВНИМАНИЕ: после изменения настройки необходимо запустить скрипт для конвертирования для уже созданных приложений. См. вкладку \'Скрипты\'',
    'context' => '',
  ),
  8 => 
  array (
    'term' => 'admin_action_attachments_cryption',
    'definition' => 'Зашифровать или расшифровать приложения к элементам',
    'context' => '',
  ),
  9 => 
  array (
  ...
  array (
    'term' => 'ga_scan_url',
    'definition' => 'Отсканируйте, пожалуйста, этот код при помощи мобильного приложения Google Authenticator. Скопируйте из него идентификационный код.',
    'context' => '',
  ),
  19 => 
  array (
  ...
  array (
    ...
    'definition' => 'Выбранная категория',
    'context' => '',
  ),
  42 => 
  array (
  ...
  array (
    ...
    'definition' => 'Использовать пароль пользователя в качестве SALTkey',
    'context' => '',
  ),
  53 => 
  array (
  ...
  array (
    ...
    'definition' => 'Кто может управлять учетной записью',
    'context' => '',
  ),
  65 => 
  array (
  ...
  array (
    ...
    'definition' => 'Не найден файл с ключами шифрования! Запустите процесс обновления.',
    'context' => '',
  ),
  75 => 
  array (
  ...
  array (
    ...
    'definition' => 'Включить по умолчанию \'Разрешить редактирование для всех\'',
    'context' => '',
  ),
  78 => 
  array (
  ...
  array (
    ...
    'definition' => 'Если Вы выходите в Интернет через прокси-сервер, то здесь нужно указать его IP-адрес. Если прокси-сервер не используется - оставьте пустым.',
    'context' => '',
  ),
  103 => 
  array (
  ...
  array (
    ...
    'definition' => 'Если задан IP-адрес прокси-сервера, укажите и его порт (напр. 8080). Если прокси-сервер не используется - оставьте пустым.',
    'context' => '',
  ),
  105 => 
  array (
  ...
  array (
    ...
    'definition' => 'Элемент был изменен. Обновите его перед тем как редактировать.',
    'context' => '',
  ),
  109 => 
  array (
  ...
  array (
    ...
    'definition' => 'Элементов редактируется сейчас',
    'context' => '',
  ),
  111 => 
  array (
  ...
  array (
    ...
    'definition' => 'На время редактирования элемента он блокируется, чтобы не производилось параллельных правок. Это делатеся путем создания токена. Эта настройка позволяет удалять токен. 0 - токен никогда не будет удален (только Администратором)',
    'context' => '',
  ),
  114 => 
  array (
  ...
  array (
    ...
    'definition' => 'Двухфакторная аутентификация Google добавляет еще один уровень безпасности. Когда пользователь пытается войти в TeamPass, создается QR-код, который пользователь должен отсканировать, чтобы получить одноразовый пароль. Внимание: для использования этой функции необходимо Интернет-соединение и сканер QR-кодов',
    'context' => '',
  ),
  126 => 
  array (
  ...
  array (
    ...
    'definition' => 'Отсканируйте QR-код',
    'context' => '',
  ),
  128 => 
  array (
  ...
  array (
    ...
    'definition' => 'Ошибка: строка не UTF8!',
    'context' => '',
  ),
  131 => 
  array (
  ...
  array (
    ...
    'definition' => 'Невозможно изменить. Этот Элемент сейчас уже редактируется!',
    'context' => '',
  ),
  133 => 
  array (
    'term' => 'error_mcrypt_not_loaded',
    'definition' => 'Не загружено расширение PHP \'mcrypt\'. Сообщите администратору.',
    'context' => '',
  ),
  134 => 
  array (
  ...
  array (
    ...
    'definition' => 'Изменен e-mail пользователя #user_login#',
    'context' => '',
  ),
  139 => 
  array (
  ...
  array (
    'term' => 'items',
    'definition' => 'Измененные',
    'context' => '',
  ),
  145 => 
  array (
    'term' => 'enable_personal_saltkey_cookie',
    'definition' => 'Хранить личный SALTKey в cookie',
    'context' => '',
  ),
  146 => 
  array (
    'term' => 'personal_saltkey_cookie_duration',
    'definition' => 'Время жизни cookie личного SALTKey (дни)',
    'context' => '',
  ),
  147 => 
  array (
  ...
  array (
    ...
    'definition' => 'Адрес отправителя (поле From Email)',
    'context' => '',
  ),
  156 => 
  array (
  ...
  array (
    ...
    'definition' => 'Проверить настроки отправки',
    'context' => '',
  ),
  158 => 
  array (
    'term' => 'admin_email_test_configuration_tip',
    'definition' => 'Этот тест отправляет письмо на указанный адрес. Если Вы его не получили - проверьте свои настройки.',
    'context' => '',
  ),
  159 => 
  array (
    'term' => 'admin_email_test_subject',
    'definition' => '[TeamPass] Тестовое сообщение',
    'context' => '',
  ),
  160 => 
  array (
    'term' => 'admin_email_test_body',
    'definition' => 'Здравствуйте,&lt;br&gt;&lt;br&gt;Письмо успешно доставлено.',
    'context' => '',
  ),
  161 => 
  array (
    'term' => 'admin_email_result_ok',
    'definition' => 'Письмо отправлено по адресу #email# ... проверьте входящие сообщения.',
    'context' => '',
  ),
  162 => 
  array (
  ...
  array (
    ...
    'definition' => 'Изменение пароля',
    'context' => '',
  ),
  164 => 
  array (
    'term' => 'email_body_item_updated',
    'definition' => 'Здравствуйте,&lt;br&gt;&lt;br&gt;Пароль для \'#item_label#\' был изменен.&lt;br /&gt;&lt;br /&gt;Можете проверить его &lt;a href=\\"".@$_SESSION[\'settings\'][\'cpassman_url\']."/index.php?page=items&group=#item_category#&id=#item_id#\\"&gt;по ссылке&lt;/a&gt;&lt;br /&gt;&lt;br /&gt;',
    'context' => '',
  ),
  165 => 
  array (
    'term' => 'email_bodyalt_item_updated',
    'definition' => 'Пароль для #item_label# был изменен.',
    'context' => '',
  ),
  166 => 
  array (
  ...
  array (
    ...
    'definition' => 'Этот скрипт принудительно совершает рассылку писем, скопившихся в БД. Операция может занять время в зависимости от количества скопившихся писем.',
    'context' => '',
  ),
  168 => 
  array (
    'term' => 'please_wait',
    'definition' => 'Подождите...',
    'context' => '',
  ),
  169 => 
  array (
  ...
  array (
    ...
    'definition' => 'Папка для создаваемых TeamPass и загружаемых файлов. ВАЖНО: из соображений безопасности эта папка не должна находиться внутри WWW-папки сайта. Её необходимо расположить в защищенном месте и настроить правила перенаправления. Рекомендуется настроить расписание (cron) по очистке этой папки',
    'context' => '',
  ),
  172 => 
  array (
    'term' => 'admin_path_to_upload_folder_tip',
    'definition' => 'Предназначена для хранения файлов, связанных с элементами ВАЖНО: из соображений безопасности эта папка не должна находиться внутри WWW-папки сайта. Её необходимо расположить в защищенном месте и настроить правила перенаправления. Эту папку нельзя очищать! файлы в ней связаны с элементами',
    'context' => '',
  ),
  173 => 
  array (
  ...
  array (
    ...
    'definition' => 'Чтобы поделиться этим элементо по почте, введите адрес почтового ящика и нажмите `Отправить`.',
    'context' => '',
  ),
  201 => 
  array (
  ...
  array (
    ...
    'definition' => 'Введите соль для выбранного пользователя',
    'context' => '',
  ),
  213 => 
  array (
    'term' => 'migrate_pf_no_sk',
    'definition' => 'Не указана соль',
    'context' => '',
  ),
  214 => 
  array (
    'term' => 'migrate_pf_no_sk_user',
    'definition' => 'Необходимо указать соль',
    'context' => '',
  ),
  215 => 
  array (
  ...
  array (
    ...
    'definition' => '[TeamPass] Созданиие Вашей учетной записи',
    'context' => '',
  ),
  217 => 
  array (
    'term' => 'email_new_user_mail',
    'definition' => 'Здравствуйте,&lt;br&gt;&lt;br&gt;Администратор создал Вашу учетную запись TeampPass.&lt;br&gt;Используйте следующие учетные данные для входа:&lt;br&gt;- Имя пользователя: #tp_login#&lt;br&gt;- Пароль: #tp_pw#&lt;br&gt;&lt;br&gt;Нажмите &lt;a href=\'#tp_link#\'&gt;ссылку&lt;/a&gt;, чтобы получить доступ.',
    'context' => '',
  ),
  218 => 
  array (
  ...
  array (
    ...
    'definition' => 'Вы потеряли свой личный ключ шифрования? Вот ведь незадача, эту потерю не восстановить. ВНИМАНИЕ: все существующие записи в личном разделе будут утеряны. Вы уверены в том, что его потеряли?',
    'context' => '',
  ),
  222 => 
  array (
  ...
  array (
    ...
    'definition' => 'Сменить основной SALTKey',
    'context' => '',
  ),
  228 => 
  array (
    'term' => 'admin_action_change_salt_key_tip',
    'definition' => 'Перед изменением SALTkey, сделайте полную резервную копию БД и переведите TeamPass в режим обслуживания, чтобы не было вошедших пользователей.',
    'context' => '',
  ),
  229 => 
  array (
  ...
  array (
    ...
    'definition' => 'Слишком большое количество затрудняет процесс отображения списка. Значение \'auto\' позволяет автоматически подстраиваться под размер экрана пользователя. Значение \'max\' принудительно заставляет показывать весь список сразу. Также можно задать конкретное количество элементов, загружаемых за один запрос',
    'context' => '',
  ),
  233 => 
  array (
  ...
  array (
    ...
    'definition' => 'Ваша учетная запись заблокирована',
    'context' => '',
  ),
  242 => 
  array (
  ...
  array (
    'term' => 'admin_action',
    'definition' => 'Подтвердите действие',
    'context' => '',
  ),
  248 => 
  array (
  ...
  array (
    ...
    'definition' => 'Введите ключ шифрования. Надежно сохраните его, он понадобится при восстановлении. (оставьте пустым, чтобы не шифровать)',
    'context' => '',
  ),
  250 => 
  array (
  ...
  array (
    ...
    'definition' => 'Введите ключ шифрования.',
    'context' => '',
  ),
  258 => 
  array (
  ...
  array (
    ...
    'definition' => 'Сбрасывает содержимое Cache таблицы. Рекомендуется делать иногда.',
    'context' => '',
  ),
  264 => 
  array (
  ...
  array (
    ...
    'definition' => 'Загружаютя данные... подождите',
    'context' => '',
  ),
  272 => 
  array (
  ...
  array (
    ...
    'definition' => 'Для большей безопасности рекомендуется настроить периодическое резервное копирование БД. Настройте на Вашем сервере задание по расписанию, которое будет выполнять скрипт \'script.backup.php\' из папки \'backups\'. Обязательно задайте путь и имя резервной копии.',
    'context' => '',
  ),
  284 => 
  array (
  ...
  array (
    ...
    'definition' => 'Для того, чтобы расшифровать файл резервной копии, укажите имя файла (без расширения и полного пути, только имя). Расшифрованный файл будет сохранен в ту же папку, что и исходный.',
    'context' => '',
  ),
  286 => 
  array (
  ...
  array (
    ...
    'definition' => 'Вы уверены, что хотите удалить из избранного?',
    'context' => '',
  ),
  366 => 
  array (
    'term' => 'confirm_del_role',
    'definition' => 'Подтвердите удаление следующей роли:',
    'context' => '',
  ),
  367 => 
  array (
    'term' => 'confirm_edit_role',
    'definition' => 'Введите новое имя для следующей роли:',
    'context' => '',
  ),
  368 => 
  array (
  ...
  array (
    ...
    'definition' => 'Отображает для каждого элемента значки копирования логина и пароля в буфер обмена',
    'context' => '',
  ),
  374 => 
  array (
  ...
  array (
    ...
    'definition' => 'Кликните и перетащите запись',
    'context' => '',
  ),
  392 => 
  array (
  ...
  array (
    'term' => 'email_body2',
    'definition' => 'был создан.&lt;br /&gt;&lt;br /&gt;Вы можете просмотреть его &lt;a href=\'',
    'context' => '',
  ),
  400 => 
  array (
  ...
  array (
    ...
    'definition' => 'Здравствуйте,&lt;br /&gt;&lt;br /&gt;Была создана Ваша учетная запись в TeamPass.&lt;br /&gt;Вы можете войти по адресу $TeamPass_url, используя предоставленные учетные данные:&lt;br /&gt;',
    'context' => '',
  ),
  406 => 
  array (
  ...
  array (
    'term' => 'error_salt',
    'definition' => 'Ключ шифрования слишком длинный! Ключ шифрования должен быть не длинее 32 символов!',
    'context' => '',
  ),
  435 => 
  array (
  ...
  array (
    ...
    'definition' => 'Ваш пароль будет отправлено по email, связанному с вашей учетной записью.',
    'context' => '',
  ),
  451 => 
  array (
  ...
  array (
    'term' => 'give_new_email',
    'definition' => 'Введите новый email для',
    'context' => '',
  ),
  464 => 
  array (
    'term' => 'give_new_login',
    'definition' => 'Выберите учетную запись',
    'context' => '',
  ),
  465 => 
  array (
    'term' => 'give_new_pw',
    'definition' => 'Введите новый пароль для',
    'context' => '',
  ),
  466 => 
  array (
  ...
  array (
    ...
    'definition' => 'Информация: импорт должен осуществляться только из файла CSV. Обычно, файл, экспортированный из KeePass, имеет подходящую структуру. Если вы используете файл, созданный другой программой, имейте ввиду, что структура файла CSV должна быть следующей: `Учетная запись`,`Имя`,`Пароль`,`URL`,`Комментарии`.',
    'context' => '',
  ),
  487 => 
  array (
  ...
  array (
    ...
    'definition' => 'Импорт из файла KeePass завершен ! По умолчанию, уровень сложности для новых папок установлен в `Средний`. Измените его на требуемый в случае необходимости.',
    'context' => '',
  ),
  494 => 
  array (
  ...
  array (
    ...
    'definition' => 'Выберите папку, в которую необходимо копировать элемент',
    'context' => '',
  ),
  527 => 
  array (
  ...
  array (
    'term' => 'link_copy',
    'definition' => 'Скопировать ссылку на этот элемент в буфер обмена',
    'context' => '',
  ),
  552 => 
  array (
    'term' => 'link_is_copied',
    'definition' => 'Ссылка на этот элемент была скопирована в буфер обмена',
    'context' => '',
  ),
  553 => 
  array (
  ...
  array (
    'term' => 'max_last_items',
    'definition' => 'Ограничить число последних просмотренных записей для пользователя (10 по умолчанию)',
    'context' => '',
  ),
  563 => 
  array (
    'term' => 'menu_title_new_personal_saltkey',
    'definition' => 'Изменить личный Saltkey',
    'context' => '',
  ),
  564 => 
  array (
  ...
  array (
    ...
    'definition' => 'Количество неуспешных попыток входа для блокировки учетной записи (0 - бесконечно)',
    'context' => '',
  ),
  569 => 
  array (
  ...
  array (
    'term' => 'new_saltkey',
    'definition' => 'Новый Saltkey',
    'context' => '',
  ),
  575 => 
  array (
    'term' => 'new_saltkey_warning',
    'definition' => 'Убедитесь, что используете исходный SaltKey, иначе шифрование будет нарушено. Перед изменениями проверьте свой SaltKey!',
    'context' => '',
  ),
  576 => 
  array (
  ...
  array (
    'term' => 'no_last_items',
    'definition' => 'Нет просмотренных записей',
    'context' => '',
  ),
  585 => 
  array (
  ...
  array (
    ...
    'definition' => 'Ваш личный saltkey',
    'context' => '',
  ),
  596 => 
  array (
    'term' => 'personal_salt_key_empty',
    'definition' => 'Не введен личный saltkey!',
    'context' => '',
  ),
  597 => 
  array (
    'term' => 'personal_salt_key_info',
    'definition' => 'Этот ключ шифрования будет использоваться для шифрования и дешифрования ваших паролей. Он не будет сохранён в базе данных, вы - единственный человек, кому он должен быть известен. Не потеряйте его!',
    'context' => '',
  ),
  598 => 
  array (
    'term' => 'please_update',
    'definition' => 'Необходима более новая версия!',
    'context' => '',
  ),
  599 => 
  array (
  ...
  array (
    ...
    'definition' => 'Все пароли и все конфиденциальные данные будут записаны в этот файл без какого-либо шифрования! Записав файл, содержащий незашифрованные элементы и пароли, вы берете на себя полную ответственность дальнейшей защиты этого списка!',
    'context' => '',
  ),
  603 => 
  array (
  ...
  array (
    ...
    'definition' => 'Укажите несколько контроллеров, если хотите, чтобы производилась балансировка LDAP-запросов. Разделитель - запятая(,) Напр.: domain_1,domain_2,domain_3',
    'context' => '',
  ),
  643 => 
  array (
  ...
  array (
    ...
    'definition' => 'Когда опция активна, на домашней странице пользователей появится кнопка, которая позволить экспортировать в PDF-файл элементы, которые он может видеть. Обратите внимание, что пароли будут сохранены в незашифрованном виде!',
    'context' => '',
  ),
  655 => 
  array (
  ...
  array (
    ...
    'definition' => 'Отправлять ежемесячную статистику использования программы автору',
    'context' => '',
  ),
  659 => 
  array (
    'term' => 'settings_send_stats_tip',
    'definition' => 'Эти статистические данные являются полностью анонимными! Не передаются IP-адрес, передается только следующие данные: количество элементов, папок, пользователей, версия TeamPass, включены ли личные папки, включен ли LDAP. Большое спасибо, если Вы включите отправку статистических данных. Благодаря этому вы поможете дальнейшему развитию TeamPass.',
    'context' => '',
  ),
  660 => 
  array (
  ...
  array (
    ...
    'definition' => 'Показывать блок последних просмотренных записей на главной странице',
    'context' => '',
  ),
  664 => 
  array (
  ...
  array (
    ...
    'definition' => 'Подтвердите восстановление этого объекта',
    'context' => '',
  ),
  692 => 
  array (
  ...
  array (
    ...
    'definition' => 'Поделиться одноразовой ссылкой с человеком, которому Вы доверяете: #URL# Помните, что эта ссылка будет доступна только один раз до #DAY#',
    'context' => '',
  ),
  702 => 
  array (
  ...
  array (
    ...
    'definition' => 'Назначить метку для IP-адреса',
    'context' => '',
  ),
  719 => 
  array (
  ...
  array (
    'term' => 'suggestion',
    'definition' => 'Предложения элемента',
    'context' => '',
  ),
  725 => 
  array (
  ...
  array (
    ...
    'definition' => 'Подтвердите удаление предложения',
    'context' => '',
  ),
  729 => 
  array (
    'term' => 'suggestion_validate_confirm',
    'definition' => 'Подтвердите одобрение предложения',
    'context' => '',
  ),
  730 => 
  array (
  ...
  array (
    ...
    'definition' => 'Внимание: это предложение содержит существующий элемент (с такой же метко и папкой). Если Вы нажмете "Добавить", этот существующий элемент будет обновлен данными из этого предложения.',
    'context' => '',
  ),
  733 => 
  array (
  ...
  array (
    'term' => 'old_saltkey',
    'definition' => 'Старая соль',
    'context' => '',
  ),
  744 => 
  array (
    'term' => 'define_old_saltkey',
    'definition' => 'Я хочу указать старую соль (необязательно)',
    'context' => '',
  ),
  745 => 
  array (
  ...
  array (
    ...
    'definition' => 'Назначьте выбранной группе пользователей тип доступа для данной папки',
    'context' => '',
  ),
  755 => 
  array (
