...
$LANG = array (
  ...
  array (
    ...
    'definition' => 'La clé personnelle de salage est sauvegardée dans un cookie',
    'context' => '',
  ),
  146 => 
  array (
    'term' => 'personal_saltkey_cookie_duration',
    'definition' => 'Durée avant expiration du cookie de la clé personelle de salage',
    'context' => '',
  ),
  147 => 
  array (
  ...
  array (
    ...
    'definition' => 'Réinitialiser ma clé personnelle de salage',
    'context' => '',
  ),
  221 => 
  array (
    'term' => 'new_saltkey_warning_lost',
    'definition' => 'Vous ne vous souvenez plus de la clé de salage? Celle-ci ne pourra être récupérée. <br>En ré-initialisant votre clé de salage, tous vos anciens éléments personnels seront supprimés !',
    'context' => '',
  ),
  222 => 
  array (
...
Le fichier décodé sera sauvegardé dans le répertoire des sauvegardes.',
  ...
  array (
    ...
    'definition' => 'Vous devez saisir votre clé personnelle de salage !',
    'context' => '',
  ),
  300 => 
  array (
  ...
  array (
    ...
    'definition' => 'Votre clé personnelle de salage',
    'context' => '',
  ),
  477 => 
  array (
    'term' => 'home_personal_saltkey_button',
    'definition' => 'Saisir la clé de salage',
    'context' => '',
  ),
  478 => 
  array (
    'term' => 'home_personal_saltkey_info',
    'definition' => 'Vous devez saisir votre clé personnelle de salage pour pouvoir accéder à vos éléments personnels.',
    'context' => '',
  ),
  479 => 
  array (
    'term' => 'home_personal_saltkey_label',
    'definition' => 'Saisir votre clé personnelle de salage',
    'context' => '',
  ),
  480 => 
  array (
  ...
  array (
    'term' => 'new_saltkey',
    'definition' => 'Nouvelle clé de salage',
    'context' => '',
  ),
  575 => 
  array (
    'term' => 'new_saltkey_warning',
    'definition' => 'Merci de vous assurer d\'utiliser la clé de salage originelle. Sans quoi le nouveau chiffrement sera corrompu ! Avant tout changement, merci de tester votre clé de salage.',
    'context' => '',
  ),
  576 => 
  array (
  ...
  array (
    ...
    'definition' => 'La clé de salage doit impérativement avoir 16 caractères !',
    'context' => '',
  ),
  845 => 
  array (
  ...
  array (
    ...
    'definition' => 'Groupe LDAP dans lequel faire la recherche',
    'context' => '',
  ),
  860 => 
  array (
    'term' => 'settings_ldap_usergroup_tip',
    'definition' => 'Groupe LDAP dans lequel les utilisateurs doivent être membre pour pouvoir se connecter. Exemple : cn=sysadmins,ou=groups,dc=example,dc=com',
    'context' => '',
  ),
  861 => 
  array (
    'term' => 'server_password_change_enable',
    'definition' => 'Activer le changement automatique du mot de passe du compte du serveur (en utilisant une connexion SSH)',
    'context' => '',
  ),
  862 => 
  array (
    'term' => 'error_login_missing',
    'definition' => 'L\'identifiant est manquant !',
    'context' => '',
  ),
  863 => 
  array (
    'term' => 'error_pwd_missing',
    'definition' => 'Le Mot de Passe est manquant !',
    'context' => '',
  ),
  864 => 
  array (
    'term' => 'error_url_missing',
    'definition' => 'L\'URL est manquant !',
    'context' => '',
  ),
  865 => 
  array (
    'term' => 'error_ssh_credentials_missing',
    'definition' => 'Les identifiants du SSH sont manquants !',
    'context' => '',
  ),
  866 => 
  array (
    'term' => 'error_url_must_be_ssh',
    'definition' => 'L\'URL doit commencer avec le protocole SSH !',
    'context' => '',
  ),
  867 => 
  array (
    'term' => 'auto_update_server_password_info',
    'definition' => 'En cliquant sur le bouton COMMENCER, les différentes actions seront réalisées :<ul><li>Une connexion SSH sera ouverte avec le serveur Linux en utilisant les identifiants et l\'URL fournis,</li><li>Le mot de passe de l\'utilisateur sera changé,</li><li>Le nouveau mot de passe sera sauvegardé dans Teampass,</li><li>La connexion SSH sera fermée.</li></ul><br><b>Merci de vous assurer que l\'utilisateur dispose des privilèges Root sur le serveur avant de commencer (sinon vous disposez de champs supplémentaires pour saisir les identifiants d\'un compte root).',
    'context' => '',
  ),
  868 => 
  array (
    'term' => 'update_server_password',
    'definition' => 'Mettre à jour le mot de passe du serveur',
    'context' => '',
  ),
  869 => 
  array (
    'term' => 'error_personal_sk_expected',
    'definition' => 'Vous devez d\'abord saisir votre clé de salage personnelle !',
    'context' => '',
  ),
  870 => 
  array (
    'term' => 'click_to_generate',
    'definition' => 'Cliquer pour générer',
    'context' => '',
  ),
  871 => 
  array (
    'term' => 'error_new_pwd_missing',
    'definition' => 'Un nouveau mot de passe est nécessaire !',
    'context' => '',
  ),
  872 => 
  array (
    'term' => 'ssh_pwd',
    'definition' => 'Mot de passe SSH',
    'context' => '',
  ),
  873 => 
  array (
    'term' => 'ssh_user',
    'definition' => 'Identifiant SSH',
    'context' => '',
  ),
  874 => 
  array (
    'term' => 'ssh_action_performed_with_error',
    'definition' => 'Une erreur a été relevée.<br>Vérifiez la réponse du serveur et faites la correction nécessaire.',
    'context' => '',
  ),
  875 => 
  array (
    'term' => 'ssh_action_performed',
    'definition' => 'Le mot de passe a été mis à jour pour cet objet.<br>Vous pouvez maintenant fermer cette boite de dialogue.',
    'context' => '',
  ),
  876 => 
  array (
    'term' => 'ssh_answer_from_server',
    'definition' => 'Réponse du serveur',
    'context' => '',
  ),
  877 => 
  array (
    'term' => 'ssh_password_frequency_change_info',
    'definition' => 'Vous désirez peut-etre que le changement se fasse de façon automatique à une fréquence définie. Pour cela, il est nécessaire de définir la fréquence à laquelle le mot de passe de l\'utilisateur du serveur devra être changé (mettre à 0 pour désactiver la tache).<br>Merci de noter que cela ne fonctionnera que si votre administrateur a activé la tâche dans le crontab du serveur.',
    'context' => '',
  ),
  878 => 
  array (
    'term' => 'ssh_password_frequency_change',
    'definition' => 'Fréquence de changement du mot de passe (en mois)',
    'context' => '',
  ),
  879 => 
  array (
    'term' => 'ssh_scheduled_change',
    'definition' => 'Planifier un changement',
    'context' => '',
  ),
  880 => 
  array (
    'term' => 'ssh_one_shot_change',
    'definition' => 'Changement direct',
    'context' => '',
  ),
  881 => 
  array (
