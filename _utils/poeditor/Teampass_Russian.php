...
$LANG = array (
  ...
  array (
    ...
    'definition' => 'Это имя используется для идентификационного кода учетной записи в Google Authenticator.',
    'context' => '',
  ),
  14 => 
  array (
  ...
  array (
    ...
    'definition' => 'Разрешить ручную вставку в журнал истории элементов',
    'context' => '',
  ),
  179 => 
  array (
  ...
  array (
    ...
    'definition' => 'Добавить запись в журнал истории',
    'context' => '',
  ),
  181 => 
  array (
  ...
  array (
    ...
    'definition' => 'Чтобы поделиться этим элементом по почте, введите email и нажмите кнопку \'Отправить\'.',
    'context' => '',
  ),
  201 => 
  array (
  ...
  array (
    ...
    'definition' => 'Нажмите на ячейку для изменения её содержимого',
    'context' => '',
  ),
  522 => 
  array (
  ...
  array (
    'term' => 'logs_passwords',
    'definition' => 'Журнал создания паролей',
    'context' => '',
  ),
  560 => 
  array (
  ...
  array (
    ...
    'definition' => 'Укажите несколько контроллеров, если хотите, чтобы производилась балансировка LDAP запросов.<br />Разделитель - запятая(,)<br />Например: domain_1,domain_2,domain_3',
    'context' => '',
  ),
  643 => 
  array (
    'term' => 'settings_ldap_domain_dn',
    'definition' => 'LDAP база DN вашего домена',
    'context' => '',
  ),
  644 => 
  array (
    'term' => 'settings_ldap_mode',
    'definition' => 'Включить аутентификацию через LDAP сервер',
    'context' => '',
  ),
  645 => 
  array (
  ...
  array (
    ...
    'definition' => 'LDAP пароль для подключения',
    'context' => '',
  ),
  739 => 
  array (
    'term' => 'settings_ldap_search_base',
    'definition' => 'LDAP база поиска',
    'context' => '',
  ),
  740 => 
  array (
  ...
  array (
    ...
    'definition' => 'Укажите пароль DN пользователя, который может подключаться к базе и осуществлять поиск',
    'context' => '',
  ),
  742 => 
  array (
...
',
  ...
  array (
    ...
    'definition' => 'Создание файла для работы в автономном режиме',
    'context' => '',
  ),
  772 => 
  array (
  ...
  array (
    ...
    'definition' => 'Ключ шифрования должен быть длиной в 16 символов!',
    'context' => '',
  ),
  845 => 
  array (
  ...
  array (
    ...
    'definition' => 'Всего элементов',
    'context' => '',
  ),
  847 => 
  array (
    'term' => 'finalizing',
    'definition' => 'Заканчиваем',
    'context' => '',
  ),
  848 => 
  array (
    'term' => 'treating_items',
    'definition' => 'Обработка элементов',
    'context' => '',
  ),
  849 => 
  array (
    'term' => 'number_of_items_treated',
    'definition' => 'Количество обработанных элементов',
    'context' => '',
  ),
  850 => 
  array (
    'term' => 'error_sent_back',
    'definition' => 'Произошла следующая ошибка',
    'context' => '',
  ),
  851 => 
  array (
  ...
  array (
    ...
    'definition' => 'Стратегия загрузки дерева',
    'context' => '',
  ),
  854 => 
  array (
    'term' => 'syslog_enable',
    'definition' => 'Включить логирование с помощью Syslog',
    'context' => '',
  ),
  855 => 
  array (
    'term' => 'syslog_host',
    'definition' => 'Syslog сервер',
    'context' => '',
  ),
  856 => 
  array (
    'term' => 'syslog_port',
    'definition' => 'Syslog порт',
    'context' => '',
  ),
  857 => 
  array (
    'term' => 'error_bad_credentials',
    'definition' => 'Учетные данные не совпадают!',
    'context' => '',
  ),
  858 => 
  array (
    'term' => 'reload_page_after_user_account_creation',
    'definition' => 'Ваша учетная запись была создана. Страница будет автоматически перезагружена через 3 секунды...',
    'context' => '',
  ),
  859 => 
  array (
    'term' => 'settings_ldap_usergroup',
    'definition' => 'LDAP группа для поиска',
    'context' => '',
  ),
  860 => 
  array (
    'term' => 'settings_ldap_usergroup_tip',
    'definition' => 'LDAP группа, в которой должен находится пользователь чтобы войти. Например: cn=sysadmins,ou=groups,dc=example,dc=com',
    'context' => '',
  ),
  861 => 
  array (
    'term' => 'server_password_change_enable',
    'definition' => 'Включить смену пароля на удалённом сервере (используя SSH соединение)',
    'context' => '',
  ),
  862 => 
  array (
    'term' => 'error_login_missing',
    'definition' => 'Имя пользователя не найдено!',
    'context' => '',
  ),
  863 => 
  array (
    'term' => 'error_pwd_missing',
    'definition' => 'Пароль не найден!',
    'context' => '',
  ),
  864 => 
  array (
    'term' => 'error_url_missing',
    'definition' => 'URL не найден!',
    'context' => '',
  ),
  865 => 
  array (
    'term' => 'error_ssh_credentials_missing',
    'definition' => 'Учетные данные SSH не найдены!',
    'context' => '',
  ),
  866 => 
  array (
    'term' => 'error_url_must_be_ssh',
    'definition' => 'URL должен начинаться с протокола SSH!',
    'context' => '',
  ),
  867 => 
  array (
    'term' => 'auto_update_server_password_info',
    'definition' => 'После нажатия кнопки \'Начать\' автоматически выполнятся следующие шаги:<ul><li>Подключение через SSH к серверу Linux с помощью учётных данных и поля \'URL\', </li><li>Смена пароля пользователя на Linux сервере</il><li>Сохранение нового пароля в TeamPass</il><li>Закрытие SSH соединения</li></ul><br /><b>Пожалуйста, убедитесь, что пользователь имеет привилегии суперпользователя на сервере (если нет, укажите логин и пароль суперпользователя) перед началом работы.</b>',
    'context' => '',
  ),
  868 => 
  array (
    'term' => 'update_server_password',
    'definition' => 'Обновить пароль сервера',
    'context' => '',
  ),
  869 => 
  array (
    'term' => 'error_personal_sk_expected',
    'definition' => 'Сначала вы должны ввести свой личный ключ шифрования!',
    'context' => '',
  ),
  870 => 
  array (
    'term' => 'click_to_generate',
    'definition' => 'Нажмите для создания',
    'context' => '',
  ),
  871 => 
  array (
    'term' => 'error_new_pwd_missing',
    'definition' => 'Новый пароль не найден!',
    'context' => '',
  ),
  872 => 
  array (
    'term' => 'ssh_pwd',
    'definition' => 'SSH пароль',
    'context' => '',
  ),
  873 => 
  array (
    'term' => 'ssh_user',
    'definition' => 'SSH пользователь',
    'context' => '',
  ),
  874 => 
  array (
    'term' => 'ssh_action_performed_with_error',
    'definition' => 'Действие было выполнено с ошибкой.<br>Проверьте ответ от сервера и сделайте корректировку.',
    'context' => '',
  ),
  875 => 
  array (
    'term' => 'ssh_action_performed',
    'definition' => 'Пароль для данного элемента обновлен.<br /><br />Вы можете закрыть это окно.',
    'context' => '',
  ),
  876 => 
  array (
    'term' => 'ssh_answer_from_server',
    'definition' => 'Ответ от сервера',
    'context' => '',
  ),
  877 => 
  array (
    'term' => 'ssh_password_frequency_change_info',
    'definition' => 'Возможно вы захотите чтобы это выполнялось автоматически с определенным интервалом. Для этого вам необходимо выбрать интервал с которым пользовательские пароли на сервере должны быть изменены (выберите 0 для отключения задачи). <br /> Обратите внимание, это будет работать только если администратор включил задачу в расписании сервиса cron.',
    'context' => '',
  ),
  878 => 
  array (
    'term' => 'ssh_password_frequency_change',
    'definition' => 'Интервал изменения пароля (в месяцах)',
    'context' => '',
  ),
  879 => 
  array (
    'term' => 'ssh_scheduled_change',
    'definition' => 'Запланированное изменение',
    'context' => '',
  ),
  880 => 
  array (
    'term' => 'ssh_one_shot_change',
    'definition' => 'Однократное изменение',
    'context' => '',
  ),
  881 => 
  array (
  ...
  array (
    ...
    'definition' => 'Автоматическая смена пароля пользователя включена',
    'context' => '',
  ),
  883 => 
  array (
    'term' => 'server_password_change_enable_tip',
    'definition' => 'Данная опция разрешает пользователям автоматически изменять пароль пользователя на сервере, расположенном в поле URL с помощью соединения SSH.<br>Обратите внимание, автоматическое изменение с определенным интервалом может производится если файл <i>/files/script.ssh.php</i> добавлен в crontab этого сервера. Рекомендуется запускать его один раз в день.',
    'context' => '',
  ),
  884 => 
  array (
    'term' => 'can_manage_all_users',
    'definition' => 'Человеческие Ресурсы<br><i>Может управлять всеми пользователями независимо от его/ее группы.<br>Также будет повышен до роли Менеджера.<br>Не может изменить существующего администратора (только администратор может удалить права администратора у пользователя).</i>',
    'context' => '',
  ),
  885 => 
  array (
    'term' => 'error_bad_credentials_more_than_3_times',
    'definition' => 'Учетные данные не совпадают!<br>Пожалуйста, подождите 10 секунд прежде чем попробовать снова.',
    'context' => '',
  ),
  886 => 
  array (
