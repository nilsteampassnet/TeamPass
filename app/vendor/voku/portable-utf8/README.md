...
</td><td><a href="#fix_utf8mixed-str-mixed">fix_utf8</a>
...
</td></tr><tr><td><a href="#showsupportbool-useecho-string">showSupport</a>
...
</td><td><a href="#strspnstring-str-string-mask-int-offset-intnull-length-string-encoding-int">strspn</a>
...
</td></tr><tr><td><a href="#substr_in_bytestring-str-int-offset-intnull-length-string">substr_in_byte</a>
...
**Parameters:**
- `mixed $str you can use a string or an array of strings`

**Return:**
- `mixed <p>Will return the fixed input-"array" or
...
**Parameters:**
- `string $str <p>The input string.</p>`
- `array<(int|string), mixed> $result <p>The result will be returned into this reference parameter.</p>`
- `bool $clean_utf8 [optional] <p>Remove non UTF-8 chars from the string.</p>`
...
## showSupport(bool $useEcho): string
<a href="#voku-php-readme-class-methods">↑</a>
...
## strspn(string $str, string $mask, int $offset, int|null $length, string $encoding): int
<a href="#voku-php-readme-class-methods">↑</a>
...
## substr_in_byte(string $str, int $offset, int|null $length): string
<a href="#voku-php-readme-class-methods">↑</a>
...
**Return:**
- `string <p>The portion of <i>str</i> specified by the <i>offset</i> and
...
- `string $str_add_on <p>Replacement for the stripped string.</p>`
