...
return array(
    ...
    'compliance_report_posture_summary_tip' => 'Les comptages faibles, compromis, sur-partagés et expirés sont recalculés en direct à chaque exécution ; réutilisés et orphelins proviennent du dernier scan approfondi (qui nécessite un contexte de déchiffrement). Comptages uniquement — ni mot de passe ni nom d’élément.',
    'compliance_report_freshness' => 'Fraîcheur',
    'compliance_report_source_live' => 'En direct (recalculé maintenant)',
    'compliance_report_source_scan' => 'Dernier scan',
    'compliance_report_scan_never' => 'Dernier scan · jamais exécuté (ouvrez le tableau de bord Sécurité pour scanner)',
    ...
    'access_reviews_manager_scope_note' => 'En tant que gestionnaire, vous pouvez examiner les accès dans les dossiers que vous gérez, mais vous ne pouvez révoquer que sur les dossiers où vous avez un accès en écriture. Les campagnes que vous lancez vous sont privées.',
