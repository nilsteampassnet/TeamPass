...
return array(
    ...
    'settings_websocket_title_goal' => 'Activer la communication en temps réel pour recevoir instantanément les mises à jour et notifications.',
    'settings_websocket_enabler' => 'Activer les WebSockets',
    'settings_websocket_enabler_tip' => 'Permet à l’application d’utiliser les WebSockets pour les mises à jour d’état en temps réel, afin de réduire les interrogations du serveur.',
    'settings_websocket_host' => 'Hôte WebSocket',
    'settings_websocket_host_tip' => 'Adresse IP ou FQDN sur lequel le serveur WebSocket est accessible (par exemple 127.0.0.1 ou ws.domain.com).',
    'settings_websocket_port' => 'Port WebSocket',
    'settings_websocket_port_tip' => 'Port TCP utilisé par le serveur WebSocket (souvent 8080 par défaut, ou 8443 pour SSL).',
    ...
    'settings_realtime_title_goal' => 'Configurer les fonctionnalités en temps réel, dont les WebSockets et le stockage de sessions haute performance.',
