...
return array(
    ...
    'fix_personal_items_empty_tip' => 'Cet outil permet de corriger le problème lorsque les éléments personnels sont vides après une mise à niveau de Teampass. Il nécessite d’avoir restauré une copie de la table teampass_items depuis Teampass version 2. La table doit être nommée teampass_items_v2.',
    ...
    'error_ajax_request' => 'La requête AJAX a échoué',
    'admin_tasks_status' => 'État des tâches',
    'database_integrity' => 'Intégrité de la base de données',
    ...
    'newly_created_user_belongs_to_role' => 'L’utilisateur nouvellement créé appartient au rôle',
    ...
    'error_no_user_password_exists' => 'Erreur : aucun mot de passe utilisateur n’existe',
    'error_no_user_encryption_keys' => 'Erreur : aucune clé de chiffrement utilisateur',
    ...
    'bck_onthefly_use_for_restore' => 'Utiliser pour restaurer',
    ...
    'bck_restore_navigation_locked' => 'Une restauration de base de données est en cours. La navigation est temporairement verrouillée pendant l’opération. Merci de garder cette fenêtre ouverte.',
    ...
    'ops_kpi_connections_web' => 'Connexions Web',
    'ops_kpi_connections_api' => 'Connexions API',
    ...
    'ops_items_personal_vs_shared_inventory' => 'Inventaire perso vs partagé',
    ...
    'inactive_users_delete' => 'Supprimer',
    ...
    'inactive_users_mgmt_title' => 'Gestion des utilisateurs inactifs',
    ...
    'inactive_users_mgmt_enable' => 'Activer la gestion des utilisateurs inactifs',
    ...
    'health_backup_tasks' => 'Tâches de sauvegarde',
    ...
    'health_modified' => 'Modifié',
    'health_task' => 'Tâche',
    'health_created' => 'Créé',
    'health_finished' => 'Terminé',
    'health_error' => 'Erreur',
    ...
    'health_backup_task_logs' => 'Logs des tâches de sauvegarde',
    ...
    'health_backup_treated_objects' => 'Objets traités',
    ...
    'health_corrupted_items_count' => 'Éléments corrompus',
    ...
    'health_apache_error_log' => 'Log d’erreurs Apache',
    'health_apache_log_loading' => 'Chargement…',
    'health_apache_log_failed' => 'Impossible de lire le log Apache.',
    'health_apache_log_not_found_fmt' => 'Fichier de log introuvable : %s',
    'health_apache_log_not_readable_fmt' => 'Fichier de log non lisible par l’utilisateur du serveur web : %s',
    'health_apache_log_note_fmt' => 'Dernières %d lignes',
    'health_apache_log_lines' => 'Lignes',
    ...
    'settings_category_essentials_title' => 'Réglages essentiels',
    'settings_category_essentials_goal' => 'Les plus utilisés',
    'settings_category_networks_title' => 'Réseaux',
    'settings_category_networks_goal' => 'Filtrage IP et contrôle d’accès',
    'settings_category_networks_under_construction' => 'En construction',
    ...
    'network_security_mode_tip' => 'Le mode Reverse proxy / WAF fait lire à TeamPass l’adresse du client dans l’en-tête du proxy, et uniquement si REMOTE_ADDR correspond à un proxy de confiance. C’est cette adresse qui est enregistrée dans le journal d’audit et sur laquelle porte le compteur anti-bruteforce par IP : laissez donc Accès direct sélectionné si aucun proxy ne se trouve devant TeamPass.',
    ...
    'health_logs_mode_tip' => 'Utilise l’auto-détection par défaut. Passe en mode manuel uniquement si ton installation utilise des fichiers de logs personnalisés.',
    'health_logs_mode_auto' => 'Auto-détection',
    'health_logs_mode_manual' => 'Surcharge manuelle',
    'health_webserver_log_path' => 'Chemin du log d’erreurs du serveur web',
    'health_webserver_log_path_tip' => 'Chemin absolu vers le fichier de log d’erreurs du serveur web.',
    'health_php_fpm_log_path' => 'Chemin du log PHP-FPM',
    'health_php_fpm_log_path_tip' => 'Chemin absolu vers le fichier de log PHP-FPM ou du pool.',
    ...
    'bck_externalized_remote_files_not_available' => 'La liste distante n’est pas disponible pour cette destination.',
    ...
    'extension_token_label_placeholder' => 'Libellé (ex. mon ordinateur portable)',
    ...
    'extension_token_generated' => 'Jeton d’extension de navigateur généré',
    'extension_token_revoked' => 'Jeton d’extension de navigateur révoqué',
    ...
    'api_session_revoked' => 'Session API révoquée',
    ...
    'kb_restore_article' => 'Restaurer',
    'kb_deleted_articles' => 'Articles supprimés',
    'kb_category' => 'Catégorie',
    'kb_anyone_can_modify' => 'Tout le monde peut modifier cet article',
    'kb_no_articles' => 'Aucun article trouvé',
    'kb_article_saved' => 'Article enregistré',
    'kb_article_deleted' => 'Article supprimé',
    'kb_article_restored' => 'Article restauré',
    'kb_linked_items' => 'Éléments liés',
    'kb_search_item_placeholder' => 'Rechercher des éléments par libellé…',
    'kb_no_linked_items' => 'Aucun élément lié',
    'kb_no_items_found' => 'Aucun élément trouvé',
    'licence_server' => 'Serveur de licences',
    'password_generation_not_compliant_with_folder_complexity' => 'Les options de génération du mot de passe sélectionnées ne permettent pas d’atteindre la complexité requise pour le dossier. Veuillez ajuster les options ou la longueur et réessayer.',
    ...
    'import_from_managers' => 'Autres gestionnaires',
    'import_select_source_manager' => 'Sélectionnez le gestionnaire de mots de passe depuis lequel vous migrez',
    ...
    'security_dashboard_admin_view' => 'Posture de l’organisation',
    ...
    'settings_notification_center_tip' => 'Affiche une cloche dans la barre supérieure regroupant les événements personnels (résultats de scan de sécurité, fins de tâches d’arrière-plan, changements de droits, clés prêtes). Fonctionne avec ou sans le serveur WebSocket.',
    ...
    'rotation_status_overdue' => 'En retard',
    'rotation_status_due_soon' => 'Échéance proche',
    ...
    'lapr_ssh_key_passphrase' => 'Phrase de passe de la clé (optionnel)',
    ...
    'lapr_trust_new_hostkey' => 'Approuver la nouvelle clé d’hôte',
    ...
    'lapr_rotation_suspended' => 'Rotations suspendues après trop d’échecs',
    ...
    'tools_fix_items_otp_warning' => 'Cette opération est irréversible. Par précaution, sauvegardez la table teampass_sharekeys_items avant de commencer.',
    ...
    'at_email_template_updated' => 'Modèle d\'email modifié',
    'at_email_template_reset' => 'Modèle d\'email réinitialisé',
