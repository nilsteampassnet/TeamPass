...
return array(
    ...
    'settings_oauth2_api_enabled_tip' => 'Lorsque cette option est activée, les utilisateurs OAuth2 (SSO) peuvent générer un jeton d’accès personnel depuis leur profil pour authentifier l’API REST et l’extension navigateur. Les utilisateurs locaux et LDAP continuent d’utiliser leur clé API. Désactivé par défaut.',
    'extension_tokens' => 'Jetons pour l’extension navigateur',
    'extension_tokens_tip' => 'Les jetons d’accès personnels permettent aux utilisateurs OAuth2/SSO d’authentifier l’API REST et l’extension navigateur. Chaque jeton n’est affiché qu’une seule fois et peut être révoqué à tout moment.',
    'extension_token_generate' => 'Générer un nouveau jeton',
    'extension_token_label_placeholder' => 'Libellé (ex. : mon ordinateur portable)',
    'extension_token_copy_once' => 'Copiez ce jeton maintenant. Pour des raisons de sécurité, il ne sera plus affiché.',
    ...
    'extension_token_generated' => 'Jeton d’extension navigateur généré',
    'extension_token_revoked' => 'Jeton d’extension navigateur révoqué',
