...
return array(
    ...
    'health_check_php_fpm_detected' => 'PHP is running under PHP-FPM (fpm-fcgi). For 100+ concurrent users set pm.max_children to at least 50, and keep request_terminate_timeout high enough for long tasks (imports, exports, item moves).',
