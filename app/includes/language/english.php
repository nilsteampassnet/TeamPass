...
return array(
    ...
    'settings_notification_center_tip' => 'Show a bell in the top bar collecting personal events (security scan results, password expiry, new knowledge-base articles, background task completions, access right changes, keys ready). Works with or without the WebSocket server.',
