...
global $LANG;
$LANG = array(
    'select_date_showing_items_expiration' => 'عرض المواعيد حتى',
    'renewal_page_info' => 'تُعرض جميع المواعيد القادمة افتراضيًا، مع العناصر المنتهية أولًا. اختر تاريخًا لتقييد القائمة.',
    'renewal_all_deadlines' => 'جميع المواعيد',
    'renewal_notice_period' => 'يجب تجديد كلمة المرور في هذا المجلد كل #days# يومًا.',
    'renewal_notice_none' => 'لا يحدد هذا المجلد موعدًا لتجديد كلمة المرور.',
    'renewal_notice_explanation' => 'يشير انتهاء الصلاحية إلى ضرورة تجديد كلمة المرور. ولا يؤدي إلى حذف العنصر أو منع المستخدمين المصرح لهم من الاطلاع عليه.',
    'renewal_notice_due' => 'موعد التجديد: #date#.',
    'renewal_notice_estimate' => 'تاريخ تقديري عند الإنشاء اليوم؛ تبدأ المدة عند حفظ العنصر.',
    'renewal_notice_existing' => 'يُحسب من آخر تغيير لكلمة المرور أو من تاريخ الإنشاء. يحافظ النقل على عمر كلمة المرور؛ ويؤدي تغييرها إلى إعادة حساب الموعد عند الحفظ.',
    'renewal_notice_expired' => 'انتهت الصلاحية بالفعل وفق قاعدة التجديد الفعلية.',
    'renewal_notice_unknown' => 'الموعد غير متاح: سجل كلمة المرور وتاريخ الإنشاء مفقودان.',
    'renewal_notice_unavailable' => 'تعذر التحقق من قاعدة التجديد. يرجى المحاولة مجددًا.',
    'renewal_notice_move_confirm' => 'هل تريد النقل إلى هذا المجلد؟',
    'item_renewal_enable' => 'تحديد مدة تجديد لهذا العنصر',
    'item_renewal_period' => 'مدة تجديد العنصر (بالأيام)',
    'item_renewal_help' => 'متاح للعناصر الشخصية والمشتركة، حتى عند تعطيل انتهاء صلاحية المجلدات. تُطبَّق أقصر مدة نشطة. تعطيل هذا الخيار يُبقي قواعد المجلد النشطة سارية.',
    'renewal_period_invalid' => 'أدخل عددًا صحيحًا من 1 إلى 36500 يومًا، أو عطّل التجديد الفردي.',
    'at_renewal_period' => 'تم تغيير مدة تجديد العنصر (بالأيام؛ 0 = معطّل)',
    'renewal_notice_effective' => 'مدة التجديد الفعلية: #days# يومًا.',
    'renewal_notice_source_item' => 'تُطبَّق القاعدة الفردية للعنصر.',
    'renewal_notice_source_folder' => 'تُطبَّق قاعدة المجلد.',
    'renewal_notice_source_lapr' => 'هذا العنصر مرتبط بـ LAPR. لا ينطبق عليه انتهاء الصلاحية المعتاد لكلمة المرور.',
    'renewal_notice_source_none' => 'لا يوجد موعد تجديد نشط لهذا العنصر.',
    'renewal_effective_days' => 'المدة الفعلية (بالأيام)',
    'renewal_individual_policies' => 'عناصر لها قاعدة فردية',
    'renewal_covered_items' => 'عناصر لها موعد نشط',
    'renewal_effective_overdue' => 'متأخرة وفق القاعدة الفعلية',
    'renewal_folder_overdue' => 'متأخرة وفق اتفاقية مستوى الخدمة للمجلد',
    'renewal_badge_scheduled' => 'انتهاء الصلاحية',
    'renewal_badge_soon' => 'تنتهي قريبًا',
    'renewal_badge_expired' => 'منتهية الصلاحية',
    'renewal_badge_unknown' => 'التجديد مفعّل',
    'compliance_report_rotation_overdue' => 'تجديدات متأخرة',
    'compliance_report_rotation_overdue_tip' => 'بيانات اعتماد مشتركة تجاوزت موعد التجديد الفعلي أو سيحل موعدها خلال 14 يومًا. تُطبَّق أقصر مدة نشطة للعنصر أو المجلد، مع عرض الأكثر تأخرًا أولًا.',
    'compliance_report_rotation_sla_tip' => 'صف لكل مجلد مشترك: اتفاقية مستوى الخدمة النشطة للتجديد، والقواعد الفردية، وبيانات الاعتماد المشمولة، والعدد الفعلي للعناصر المتأخرة. تُحسب مخالفات اتفاقية المجلد بصورة منفصلة. تُبرز المجلدات التي لا تحتوي على اتفاقية نشطة.',
    ...
    'email_body_scheduled_backup_report' => '<table width="100%" border="0" cellpadding="10" cellspacing="0"><tr bgcolor="#203f7d"><td colspan="4"><font color="#ffffff"><b>تقرير النسخ الاحتياطي</b></font></td></tr><tr bgcolor="#e8edf5"><td width="18%"><b>النتيجة</b></td><td width="32%"><font color="#203f7d"><b>#tp_status#</b></font></td><td width="18%"><b>التاريخ</b></td><td width="32%">#tp_datetime#</td></tr><tr><td><b>الحجم</b></td><td>#tp_size#</td><td><b>الاحتفاظ</b></td><td>#tp_retention_days# يوم</td></tr></table><br><table width="100%" border="0" cellpadding="7" cellspacing="0"><tr bgcolor="#d9d9d9"><td colspan="2"><b>معلومات إضافية — النسخ الاحتياطي المجدول</b></td></tr><tr><td width="22%"><b>المجلد</b></td><td>#tp_output_dir#</td></tr><tr bgcolor="#eeeeee"><td><b>الملف</b></td><td>#tp_file#</td></tr><tr><td><b>آخر تنظيف</b></td><td>#tp_purge_deleted# ملف</td></tr><tr bgcolor="#eeeeee"><td><b>التشخيص</b></td><td>#tp_message#</td></tr></table>#tp_externalized_report#<br><table width="100%" border="0" cellpadding="7" cellspacing="0"><tr bgcolor="#eeeeee"><td>تم إنشاء هذا الإشعار تلقائيًا بواسطة TeamPass.</td></tr></table>',
    'email_body_scheduled_backup_externalized_report' => '<br><table width="100%" border="0" cellpadding="10" cellspacing="0"><tr bgcolor="#203f7d"><td colspan="4"><font color="#ffffff"><b>نقل النسخة الاحتياطية إلى وجهة خارجية</b></font></td></tr><tr bgcolor="#e8edf5"><td width="18%"><b>النتيجة</b></td><td width="32%"><font color="#203f7d"><b>#tp_externalized_status#</b></font></td><td width="18%"><b>الوجهة</b></td><td width="32%">#tp_externalized_destination#</td></tr><tr><td><b>الحجم</b></td><td>#tp_externalized_size#</td><td><b>الاحتفاظ</b></td><td>#tp_externalized_retention_days# يوم / #tp_externalized_retention_count# ملف</td></tr></table><br><table width="100%" border="0" cellpadding="7" cellspacing="0"><tr bgcolor="#d9d9d9"><td colspan="4"><b>معلومات إضافية — النقل إلى وجهة خارجية</b></td></tr><tr><td width="18%"><b>الهدف</b></td><td width="32%">#tp_externalized_target#</td><td width="18%"><b>المحاولة</b></td><td width="32%">#tp_externalized_retry#</td></tr><tr bgcolor="#eeeeee"><td><b>التنظيف</b></td><td colspan="3">#tp_externalized_purge_deleted# ملف</td></tr><tr><td><b>الملف</b></td><td colspan="3">#tp_externalized_file#</td></tr><tr bgcolor="#eeeeee"><td><b>التشخيص</b></td><td colspan="3">#tp_externalized_message#</td></tr></table>',
    '' => ''
);
