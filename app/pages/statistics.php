...
<link rel="stylesheet" href="./assets/css/statistics.css?v=<?php echo TP_VERSION . '.' . TP_VERSION_MINOR . '.ops-redesign-2'; ?>">
                                ...
                                <div class='row mt-3'>
                                    ...
                                    <div class='col-lg-3 col-sm-6'>
                                        <dl class='mb-0 tp-ops-activity-kpi'>
                                            ...
                                            <dd>
                                                <span id='tp-kpi-created-total'>-</span>
                                                <small id='tp-kpi-created-sources'></small>
                                            </dd>
                                        </dl>
                                    </div>
                                </div>
