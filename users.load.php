                ...
                if ( $("#change_user_pw_newpw").val() == $("#change_user_pw_newpw_confirm").val() ) {
                    ...
                    $.post(
                        ...
                        function(data){
                            ...
                            } elseif (data[0].error == "key_not_conform") {
...
function ChangeUserParm(id, parameter)
{
    ...
    } elseif (parameter == "personal_folder") {
        var val = $("#"+parameter+"_"+id+":checked").val();
        if (val == "on" ) val = 1;
        else val = 0;
    } elseif (parameter == "gestionnaire") {
        var val = $("#"+parameter+"_"+id+":checked").val();
        if (val == "on" ) val = 1;
        else val = 0;
    } elseif (parameter == "admin") {
        var val = $("#"+parameter+"_"+id+":checked").val();
        if (val == "on" ) val = 1;
        else val = 0;
    } elseif (parameter == "read_only") {
            var val = $("#"+parameter+"_"+id+":checked").val();
            if (val == "on" ) val = 1;
            else val = 0;
        }
