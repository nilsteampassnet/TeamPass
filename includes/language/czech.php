...
$txt['copy_to_clipboard_small_icons_tip'] = "<span style='width:300px;'>Tím lze zredukovat nároky na operační paměť pro uživatele starších počítačů.<br> Informace o položkách pak sice nejsou načítány, nelze ale ani rychle kopírovat uživatelská jména a hesla položek.</span> ";
...
$txt['settings_ldap_mode_tip'] = "Aktivujte pouze pokud máte server LDAP a chcete jej používat k autorizaci.<br><span style='max-width:300px;'>Konfiguraci LDAP je třeba provést manuelně. Musíte upravit soubor <b>adLDAP.php</b> umístěný v <i>/includes/libraries/adLDAP</i>. Pozměňte všechny chráněné parametry mezi řádky 68 až 128 tak, aby odpovídaly konfiguraci Vašeho serveru LDAP.</span>";
