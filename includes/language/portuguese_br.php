...
return array(
    ...
    'email_body_new_user' => 'Olá,<br><br>Este é um e-mail gerado pelo gerenciador de senhas Teampass.<br><br>Um administrador criou para você uma conta de usuário no Teampass. Na próxima vez que você se autenticar no Teampass, por favor, use as seguintes credenciais:<ul><li>Conta: #login#</li><li>Senha: #password#</li><li>Código de criptografia: #code#</li></ul><br><br><br>Atenciosamente',
    ...
    'password_is_not_correct' => 'Essa senha está incorreta',
    ...
    'output' => 'Saída',
    'remove_install_folder' => 'A pasta de instalação foi removida',
    ...
    'only_display_folders_to_depth' => 'Somente exibir pastas com profundidade',
    ...
    'password_overview_delay_tip' => 'Essa configuração permite definir o número de segundos para ocultar as senhas exibidas para o usuário.',
    'select_date_showing_items_expiration' => 'Listas os itens expirados na data',
    'renewal_page_info' => 'Esta página permite identificar os itens atualmente expirados ou próximos de expirar.',
    ...
    'export_items' => 'Exportando itens',
    'loading_item' => 'Carregando item',
    'otv_message' => 'Você pode compartilhar esse item com alguém sem uma conta no Teampass. A Visualização-Única permite que seu convidado acesse campos básicos desse item uma única vez sem estar autenticado no Teampass. Por favor, note que esse link é válido para o período de ##otv_expiration_period## dias. Copie e compartilhe o link abaixo.',
    ...
    'remaining_emails_to_send' => 'E-mails restantes a serem enviados',
    ...
    'enable_personal_folder_for_this_user' => 'Habilitar "Pastas Pessoais" para esse usuário',
    'special' => 'Especial',
    ...
    'admin_action_check_pf' => 'Atualizar Pastas Pessoais para todos os usuários (cria as pastas se ainda não existirem)',
    ...
    'settings_delay_for_item_edition' => 'Depois de quanto tempo (em minutos) uma edição de Item é considerada como uma falha',
    ...
    'fontawesome_icon_tip' => 'Você pode especificar um código de ícone Font Awesome selecionado em <a href="https://fontawesome.com/v5.15/icons?d=gallery&p=2&s=solid&m=free" target="_blank">Free and Solid icons</a> (em inglês). Deixe em branco para usar o ícone padrão.',
