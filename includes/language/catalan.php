...
$txt['add_role_tip'] = "Afegeix un nou rol.";
$txt['admin'] = "Administració";
...
$txt['admin_action'] = "Si us plau valida la teva acció";
$txt['admin_actions_title'] = "Accions Específiques";
...
$txt['admin_action_check_pf'] = "Actualitza Directoris Personals per tots els usuaris (els crea si no existeixen)";
$txt['admin_action_db_backup'] = "Fes una còpia de seguretat de la base de dades.";
...
$txt['admin_action_db_backup_start_tip'] = "Inici";
$txt['admin_action_db_backup_tip'] = "It is a good practice to create a backup that could be used to restore your database.";
$txt['admin_action_db_clean_items'] = "Eŀlimina els elements orfes de la base de dades";
$txt['admin_action_db_clean_items_result'] = "Els items han estat esborrats.";
...
$txt['admin_action_db_optimize'] = "Optimitza la base de dades";
$txt['admin_action_db_restore'] = "Restaura la base de dades";
$txt['admin_action_db_restore_key'] = "Si us plau introdueix la clau de xifrat.";
...
$txt['admin_action_purge_old_files'] = "Purga els fitxers antics";
$txt['admin_action_purge_old_files_result'] = "els fitxers han estat esborrats.";
$txt['admin_action_purge_old_files_tip'] = "Això esborrarà tots els fitxers temporals que tinguin més de 7 dies.";
...
$txt['admin_functions'] = "Role management";
$txt['admin_groups'] = "Folder management";
$txt['admin_help'] = "Ajuda";
$txt['admin_info'] = "Some information concerning the tool";
$txt['admin_info_loading'] = "Loading data ... please wait";
$txt['admin_ldap_configuration'] = "Configuració LDAP";
$txt['admin_ldap_menu'] = "Opcions LDAP";
$txt['admin_main'] = "Information";
$txt['admin_misc_cpassman_dir'] = "Ruta sencera del TeamPass";
$txt['admin_misc_cpassman_url'] = "URL sencera del TeamPass";
$txt['admin_misc_custom_login_text'] = "Custom Login text";
$txt['admin_misc_custom_logo'] = "Full url to Custom Login Logo";
$txt['admin_misc_favicon'] = "URL sencera del fitxer favicon";
$txt['admin_misc_title'] = "Personalitza";
...
$txt['admin_settings'] = "Ajustos";
$txt['admin_settings_title'] = "Ajustos de TeamPass";
...
$txt['admin_upload_title'] = "Pujades";
$txt['admin_url_to_files_folder'] = "URL to Files folder";
$txt['admin_url_to_upload_folder'] = "URL to Upload folder";
$txt['admin_users'] = "User management";
$txt['admin_views'] = "Vistes";
$txt['alert_message_done'] = "Fet!";
$txt['alert_message_personal_sk_missing'] = "Has d'introduir la teva clau personal SALT!";
$txt['all'] = "all";
$txt['anyone_can_modify'] = "Permet que qualsevol que tingui accés a l'element el pugui modificar.";
$txt['associated_role'] = "Quin rol a associar a aquesta carpeta :";
...
$txt['at_delete'] = "Esborrat";
$txt['at_del_file'] = "Fitxer eŀliminat";
$txt['at_description'] = "Descripció";
$txt['at_email'] = "email";
$txt['at_field'] = "Field";
$txt['at_file'] = "Fitxer";
...
$txt['at_pw'] = "Contrasenya canviada";
$txt['at_restored'] = "Restaurat";
...
$txt['changelog'] = "Últimes notícies";
...
$txt['check_all_text'] = "Marca tots";
$txt['close'] = "Close";
$txt['complexity'] = "Complexity";
$txt['complex_asked'] = "Required complexity";
$txt['complex_asked'] = "Required complexity";
$txt['complex_level0'] = "Molt fluixa";
$txt['complex_level1'] = "Fluixa";
$txt['complex_level2'] = "Mitjana";
$txt['complex_level3'] = "Forta";
$txt['complex_level4'] = "Molt forta";
...
$txt['confirm_del_role'] = "Si us plau confirma l'esborrat del següent rol:";
$txt['confirm_edit_role'] = "Si us plau introdueix el nom del següent rol.";
...
$txt['description'] = "Descripció";
$txt['description'] = "Descripció";
$txt['disable_notify'] = "Disable notify";
$txt['disconnect'] = "Logout";
$txt['disconnection'] = "Desconnexió";
...
$txt['div_dialog_message_title'] = "Informació";
$txt['done'] = "Fet";
$txt['drag_drop_helper'] = "Drag and drop item";
$txt['duplicate_folder'] = "Allow multiple folders with the same name.";
$txt['duplicate_item'] = "Allow multiple items with the same name.";
$txt['email'] = "Email";
...
$txt['enable_favourites'] = "Habilita que els usuaris guardin Favorits";
$txt['enable_notify'] = "Enable notify";
$txt['enable_personal_folder'] = "Habilita directori Personal";
$txt['enable_personal_folder_feature'] = "Habilita la funcionalitat de directori Personal";
...
$txt['encrypt_key'] = "Clau de xifrat";
$txt['errors'] = "errors";
...
$txt['error_no_folders'] = "Hauries de començar creant alguns directoris.";
$txt['error_no_password'] = "Es necessari que introdueixis la teva contrasenya!";
...
$txt['error_password_confirmation'] = "Les contrasenyes han de ser la mateixa";
...
$txt['functions'] = "Roles";
$txt['function_alarm_no_group'] = "Aquest rol no està associat a cap Directori!";
...
$txt['give_function_tip'] = "Afegeix un rol nou";
...
$txt['group_pw_duration'] = "Període de renvació";
$txt['group_pw_duration_tip'] = "En mesos. 0 per deshabilitar.";
$txt['group_select'] = "Select folder";
$txt['group_title'] = "Folder label";
$txt['history'] = "History";
$txt['home'] = "Home";
$txt['home_personal_menu'] = "Accions personals";
$txt['home_personal_saltkey'] = "La teva clau SALT personal";
$txt['home_personal_saltkey_button'] = "Desa ho!";
$txt['home_personal_saltkey_info'] = "You should enter your personal saltkey if you need to use your personal items.";
$txt['home_personal_saltkey_label'] = "Introdueix la teva clau personal SALT";
$txt['html'] = "html";
$txt['importing_details'] = "Llista de detalls";
$txt['importing_folders'] = "Important directoris";
$txt['importing_items'] = "Important elements";
...
$txt['import_csv_menu_title'] = "Importa elements d'un fitxer (CSV/KeePass XML)";
...
$txt['import_keepass_to_folder'] = "Seŀlecciona la carpeta destí";
...
$txt['import_to_folder'] = "Select the items you want to import to folder:";
$txt['index_add_one_hour'] = "Extend session by 1 hour";
$txt['index_alarm'] = "ALARM!!!";
$txt['index_bas_pw'] = "Contrasenya incorrecta per aquest compte!";
$txt['index_change_pw'] = "Change your password";
$txt['index_change_pw'] = "Canvia la teva contrasenya";
$txt['index_change_pw_button'] = "Canvia";
$txt['index_change_pw_confirmation'] = "Confirma";
$txt['index_expiration_in'] = "session expiration in";
$txt['index_get_identified'] = "Si us plau identifique't!";
...
$txt['index_maintenance_mode_admin'] = "Mode de Manteniment activat. Ara els usuaris no poden accedir a TeamPass.";
$txt['index_new_pw'] = "Nova contrasenya";
$txt['index_password'] = "Contrasenya";
$txt['index_pw_error_identical'] = "Les contrasenyes han de ser idèntiques!";
$txt['index_pw_expiration'] = "Actual password expiration in";
$txt['index_pw_level_txt'] = "Complexitat";
$txt['index_refresh_page'] = "Refresca la página";
$txt['index_session_duration'] = "Durada de la sessió";
...
$txt['index_welcome'] = "Benvingut";
$txt['info'] = "Information";
$txt['info_click_to_edit'] = "Clica sobre una ceŀla per editar el seu valor";
...
$txt['item_menu_add_to_fav'] = "Afegir a favorits";
$txt['item_menu_collab_disable'] = "L'edició no està permesa";
$txt['item_menu_collab_enable'] = "L'edició està permesa";
$txt['item_menu_copy_elem'] = "Copia l'item";
$txt['item_menu_copy_login'] = "Copia \"login\"";
$txt['item_menu_copy_pw'] = "Copia la contrasenya";
$txt['item_menu_del_elem'] = "Delete item";
$txt['item_menu_del_from_fav'] = "Esborra de favorits";
...
$txt['item_menu_mask_pw'] = "Emmascara la contrasenya";
...
$txt['kbs'] = "KBs";
$txt['kb_menu'] = "Base de coneixement";
$txt['keepass_import_button_text'] = "Browse XML file";
$txt['label'] = "Etiqueta";
$txt['lastname'] = "Last name";
$txt['last_items_icon_title'] = "Mostra/Amaga últims elements vistos";
$txt['last_items_title'] = "Últims elements vistos";
...
$txt['mask_pw'] = "Emmascara/Mostra la contrasenya";
$txt['max_last_items'] = "Màxim nombre de últims elements vistos per usuari (10 per defecte)";
$txt['menu_title_new_personal_saltkey'] = "Changing your Personal Saltkey";
$txt['minutes'] = "minuts";
$txt['modify_button'] = "Modify";
$txt['more'] = "More";
$txt['move'] = "Move to";
$txt['my_favourites'] = "Els meus favorits";
$txt['name'] = "Name";
$txt['nb_false_login_attempts'] = "Number of false login attempts before account is disabled (0 to disable)";
$txt['nb_folders'] = "Número de directoris";
$txt['nb_items'] = "Número d'elements";
...
$txt['new_role_title'] = "Nou titol de rol";
...
$txt['nom'] = "Nom";
$txt['none'] = "Cap";
$txt['none_selected_text'] = "Cap seŀleccionat";
...
$txt['no_last_items'] = "Elements no vistos";
$txt['no_previous_pw'] = "No previous password";
$txt['no_restriction'] = "Sense restricció";
$txt['numbers'] = "Numbers";
...
$txt['personal_folder'] = "Directori Personal";
...
$txt['personal_salt_key'] = "La teva clau salt";
$txt['personal_salt_key_empty'] = "La clau personal salt no ha estat introduïda!";
...
$txt['print'] = "Imprimeix";
$txt['print_out_menu_title'] = "Imprimeix fora una llista dels teus items";
$txt['print_out_pdf_title'] = "TeamPass - Llista d'items exportats";
...
$txt['pw_changed'] = "Contrasenya canviada!";
...
$txt['pw_used'] = "Aquesta contrasenya ja ha estat emprada!";
$txt['readme_open'] = "Obre el fitxer de llegeix-me sencer";
$txt['read_only_account'] = "Read Only";
$txt['refresh_matrix'] = "Refrescar Matriu";
...
$txt['secure'] = "Assegurar";
$txt['see_item_title'] = "Detalls de l'element";
$txt['see_logs'] = "See Logs";
$txt['select'] = "select";
$txt['select'] = "Select";
$txt['select_folders'] = "Seŀlecciona carpetes";
...
$txt['settings_anyone_can_modify'] = "Activa una opció per cada element que permeti que qualsevol el modifiqui.";
...
$txt['settings_kb'] = "Habilitar Base de Coneixemnt (beta)";
...
$txt['settings_ldap_domain'] = "Sufix del compte LDAP per el teu domini";
$txt['settings_ldap_domain_controler'] = "Vector de controladors de domini LDAP";
...
$txt['settings_ldap_domain_dn'] = "Base dn LDAP per el teu domini";
...
$txt['settings_ldap_mode'] = "Habilita l'autenticació d'usuari a través del servidor LDAP";
...
$txt['settings_printing'] = "Habilitar impressió d'items en un fitxer PDF";
...
$txt['settings_richtext'] = "Habilita richtest per la descripció de l'item";
...
$txt['settings_send_stats'] = "Envia estadístiques mensuals a l'autor per que pugui entendre millor el teu us de TeamPass.";
...
$txt['show'] = "Mostra";
$txt['show_help'] = "Mostra l'ajuda";
$txt['show_last_items'] = "Mostra el bloc d'últims elements a la pàgina principal";
$txt['size'] = "Size";
...
$txt['time_format'] = "Format de temps";
$txt['to'] = "to";
$txt['uncheck_all_text'] = "Desmarca tots";
...
$txt['user_alarm_no_function'] = "Aquest usuari no te Rols!";
