...
return array(
    ...
    'day' => 'Ημέρα',
    'reset' => 'Επαναφορά',
    'error_while_creating_file' => 'Σφάλμα κατά τη δημιουργία αρχείου',
    ...
    'started' => 'Ξεκίνησε',
    'recovery_keys_not_downloaded' => 'Δεν έγινε λήψη κλειδιών ανάκτησης',
    'no_recovery_keys' => 'Δεν έχω κλειδιά ανάκτησης',
    'provide_recovery_keys' => 'Δώστε τα κλειδιά ανάκτησης σας',
    'public_key' => 'Δημόσιο κλειδί',
    'private_key' => 'Ιδιωτικό κλειδί',
    'download_recovery_keys' => 'Λήψη κλειδιών ανάκτησης',
    ...
    'recovery_keys_download_date' => 'Ημερομηνία λήψης κλειδιών ανάκτησης',
    'keys_not_recovered' => 'Τα δημόσια και ιδιωτικά κλειδιά δεν αποθηκεύτηκαν',
    ...
    'keys_management' => 'Διαχείριση κλειδιών',
    ...
    'display_warning_icons' => 'Εμφάνιση εικονιδίων προειδοποίησης',
    ...
    'no_subfolders' => 'Δεν υπάρχουν υποφάκελοι',
    'show_hide_folders' => '',
    ...
    'newly_created_user_belongs_to_role' => 'Ο νέος χρήστης ανήκει στον ρόλο',
    'show_files' => 'Εμφάνιση λίστας αρχείων',
    'successfully_deleted' => 'Διαγράφηκε επιτυχώς',
    'ignore_file' => 'Αγνόηση αρχείου',
    ...
    'error_fetching_password' => 'Σφάλμα κατά την ανάκτηση κωδικού',
    'user_is_not_auth_with_oauth2' => 'Ο χρήστης δεν θα πρέπει να ταυτοποιείται με Entra/Azure AD',
    'oauth2_need_user_old_password' => '',
    'tenant_id' => 'Tenant ID',
    'server_connected_to_internet' => 'Ο διακομιστής είναι συνδεδεμένος στο διαδίκτυο',
    'server_not_connected_to_internet' => 'Ο διακομιστής δεν είναι συνδεδεμένος στο διαδίκτυο',
    ...
    'test_configuration' => 'Δοκιμή διαμόρφωσης',
    'setup_wizard' => 'Οδηγός εγκατάστασης',
    'login_with_sso' => 'Σύνδεση με SSO',
    ...
    'git_commit_value' => 'Τιμή commit Git',
    ...
    'user_keys_management' => 'Διαχείριση κλειδιών χρήστη',
    ...
    'at_import' => 'Εισαγωγή',
    'error_no_user_password_exists' => 'Δεν βρέθηκε κωδικός χρήστη. Παρακαλώ συνδεθείτε ξανά!',
    'error_no_user_encryption_keys' => 'Ο χρήστης δεν έχει κλειδιά κρυπτογράφησης. Συνδεθείτε ξανά!',
