...
return array(
    ...
    'personal_items' => 'Προσωπικά αντικείμενα',
    ...
    'no_data_to_display' => 'Δεν υπάρχουν δεδομένα',
    'server' => 'Διακομιστής',
    ...
    'operation_progress' => 'Η λειτουργία βρίσκεται σε εξέλιξη',
    ...
    'copy_item' => 'Αντιγραφή αντικειμένου',
    'new_item' => 'Νέο αντικείμενο',
