...
return array(
    ...
    'tasks_manager' => 'Tasks manager',
    'tasks_manager' => 'Tasks manager',
    'tasks' => 'Tasks',ser_not_active' => 'Tasks in progress - User not active',
    'tasks' => 'Tasks',
    'task_in_progress_user_not_active' => 'Tasks in progress - User not active',r',
    'task_in_progress_user_not_active' => 'Tasks in progress - User not active',
    'enable_tasks_manager' => 'Enable heavy tasks to be performed by cron manager',t some tasks take long time. This permits to enable to handle those tasks using a background job performed by server cron manager. See documentation for more details.',
