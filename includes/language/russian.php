...
$LANG = array (
    ...
    'new_category_label' => 'Название новой категории:',
    ...
    'settings_item_extra_fields' => 'Дополнительные поля',
    ...
    'settings_encryptClientServer_tip' => 'AES-256 шифрование включено по умолчанию. Данная опция необходима, если не используется SSL сертификат для шифрования обмена между клиентом и сервером. Если используется SSL или TeamPass работает во внутренней сети, то эту опцию можно отключить для ускорения отображения данных в Teampass. (!) Помните, что использование SSL протокола является наиболее безопасным и защищенным вариантом.',
    ...
    'admin_action_generate_encrypt_keys_tip' => 'Набор ключей шифрования очень важная часть системы безопасности TeamPass. Эти ключи используются для шифрования обмена между сервером и клиентом. Рекомендуется периодически по новой создавать набор ключей. Обратите внимание, что процесс может занимать несколько минут.',
    ...
    'admin_setting_enable_delete_after_consultation' => 'Включить возможность ограничения количества просмотров элемента',
    'admin_setting_enable_delete_after_consultation_tip' => 'Когда включено, пользователи могут задавать количество просмотров, после которого элемент будет автоматически удален.',
    'enable_delete_after_consultation' => 'Элемент будет удален после того как его просмотрят',
    'times' => 'раз.',
    'automatic_deletion_activated' => 'Разрешить автоматическое удаление',
    ...
    'notify_activated' => 'Разрешить уведомления',
    'at_email' => 'email',
    ...
    'admin_misc_custom_logo' => 'URL к собственному логотипу входа',
    'admin_misc_favicon' => 'URL к файлу favicon',
    ...
    'associate_kb_to_items' => 'Выберите элементы, которые вы хотите связать с базой знаний',
    ...
    'index_add_one_hour' => 'Продлить сессию',
    'index_alarm' => 'ТРЕВОГА!!!',
    ...
    'index_expiration_in' => 'Сессия истекает через',
    ...
    'settings_ldap_domain_controler_tip' => 'Укажите несколько контроллеров, если хотите, чтобы производилась балансировка LDAP запросов. Разделитель - запятая(,) Например: dc1,dc2,dc3',
    ...
    'support_page' => 'Для получения поддержки посетите сайт TeamPass.',
    'symbols' => 'Символы',
    'tags' => 'Теги',
    ...
    'admin_api' => 'API',
    'settings_api' => 'Разрешить доступ к элементам через API',
    ...
    'show_only_accessible_folders' => 'Скрывать папки без доступа',
    ...
    'admin_email_server_url' => 'URL для ссылок в письмах',
    ...
    'admin_email_security' => 'Шифрование SMTP',
    ...
    'error_export_format_not_selected' => 'Требуется указать формат для экспортируемого файла',
    ...
    'settings_default_session_expiration_time' => 'Длительность сессии по умолчанию (мин.)',
    'duo_message' => 'Проверка DUO Security закончена. Ваши учетные данные передаются в TeamPass. Пожалуйста, подождите... страница будет перезагружена, как только аутентификация завершится.',
    'duo_loading_iframe' => 'Фрейм DUO Security аутентификации сейчас будет загружен. Пожалуйста, подождите.',
    ...
    'character_not_allowed' => 'Символ недопустим!',
    ...
    'syslog_host' => 'Имя или IP-адрес syslog сервера',
    ...
    'month' => 'месяц',
    'server_auto_update_password_enabled_tip' => 'Разрешить автоматическую смену пароля пользователем.',
    ...
    'error_bad_credentials_more_than_3_times' => 'Пожалуйста, подождите 10 секунд прежде чем попробовать снова.',
    ...
    'must_select_items' => 'Вы должны выбрать элементы!',
    ...
    'considering_sending_anonymous_statistics' => 'Пожалуйста, обратите внимание на отправку анонимной статистики',
    'anonymous_statistics_definition' => 'Используйте следующую форму, чтобы определить данные, которыми вы можете поделиться (пожалуйста, подумайте о том, чтобы оставить все пункты выделенными)',
    ...
    'save_statistics_choice' => 'Сохранить настройки',
    'communication_means' => 'Контакты и обратная связь',
    'email_format_is_not_correct' => 'Email введен некорректно',
    'url_format_is_not_correct' => 'URL введен некорректно',
    'Dont_update_with_this_data' => 'Не обновляйте элемент с этими данными',
    ...
    'what_action_to_perform' => 'Выберите действие для выполнения',
    'confirm_database_reencryption' => 'Это приведёт к повторному шифрованию базы данных новой солью. Подтверждаете?',
    'previous_backup_exists' => 'Существует предыдущая резервная копия.<br />Вы хотите вернуться к предыдущим данным?',
    'previous_backup_exists_delete' => 'Вы хотите уничтожить старые данные?',
    ...
    'wipe_backup_data' => 'Вы решили стереть данные резервного копирования. Это необходимо сделать после проверки данных. Подтверждаете?',
    'bad_psk' => 'Личная соль введена некорректно!',
    'bad_psk_confirmation' => 'Подтверждение личной соли введено некорректно!',
    'psk_required' => 'Необходимо ввести личную соль!',
    ...
    'no_username_needed' => 'Имя пользователя не требуется',
    'feature_support_canal' => 'Для получения поддержки и справки, пожалуйста, используйте',
    'file_is_now_ready' => 'Файл готов.',
    'category' => 'Категория',
    'knowledge_base' => 'База знаний',
    'anyone_can_modify_it' => 'Кто угодно может редактировать это',
    ...
    'admin_script_backup_secret' => 'Пароль для резервного копирования',
    'admin_script_backup_secret_tip' => 'Для запуска резервного копирования нужен отдельный пароль. Он будет добавлен в список параметров script.backup.p',
    'access_level_for_roles' => 'Предоставить доступ всем ролям',
    ...
    'newly_created_user_is_administrated_by' => 'Недавно созданный пользователь администрируется',
    ...
    'request_access_to_item' => 'Запросить доступ к этому элементу',
    ...
    'settings_ldap_and_local_authentication_tip' => 'Включите эту опцию, чтобы разрешить вход пользователям, прошедшим проверку подлинности LDAP или в локальном списке пользователей Teampass.',
    'user_profile_api_key' => 'Ваш ключ API',
    'report_a_bug' => 'Сообщить о ошибке',
    'enable_http_request_login' => 'Автоматический вход с использованием учетных данных HTTP-заголовка',
    'duration_login_attempt' => 'Секунд до автоматического входа:',
    'newly_created_user_role' => 'Созданный пользователь имеет роль',
    'at_user_updated' => 'Пользователь #user_login# обновлен',
    'human_resources' => 'Суперменеджер',
    'login_attempts' => 'Попыток входа после последнего успешного соединения',
    'settings_secure_display_image' => 'Включить безопасный показ изображений',
    'settings_secure_display_image_tip' => 'Безопасный показ изображений разрешает читать изображения через PHP когда пользователь делает предпросмотр вложенного в элемент изображения. Преимущество: вложение хранится вне папки сайта и к нему не сможет получить доступ взломщик. Недостаток: этот метод заметно медленнее, чем предпросмотр непосредственно по ссылке.',
    'provide_yubico_identifiers' => 'Укажите Ваш идентификатор Yubico',
    'admin_yubico_authentication_setting' => 'Включить аутентификацию Yubico',
    'yubico_user_id' => 'ID клиента',
    'yubico_user_key' => 'Секретный ключ',
    'yubico_bad_code' => 'Неверная информация о Yubico',
    'show_yubico_info_form' => 'Показать форму с информацией пользователя Yubico',
    'press_your_yubico_key' => 'Нажмите свой ключ Yubico',
    'position_in_list' => 'Позиция в списке',
    'visible_by' => 'Виден для',
    'restrict_visibility_to' => 'Ограничить видимость для',
    'every_roles' => 'Всем ролям',
    'masked_text' => 'Маскированный текст',
    'textarea' => 'Поле ввода текста',
    'error_field_is_mandatory' => 'Как минимум одно обязательное поле не заполнено',
    'is_mandatory' => 'Обязательное',
    'main_template' => 'Использовать как шаблон',
    'create_item_based_upon_template_tip' => 'Эта функция позволяет выбирать набор дополнительных полей при создании элемента. Обратите внимание, что функция дополнительных полей также должна быть активна.',
    'create_item_based_upon_template' => 'Использовать шаблоны для создания элементов',
    'log_in' => 'Вход',
    'filter' => 'Фильтр',
    'upload_empty_file' => 'Разрешить пустые файлы',
    'upload_any_extension_file' => 'Разрешить файлы с любым расширением',
    'upload_any_extension_file_tip' => 'Когда включено, разрешает пользователю загружать файлы любых типов.',
