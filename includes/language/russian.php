...
return array(
    ...
    'filters' => 'Фильтры',
    'show_user_password' => 'Отобразить пароль после выполнения',
    'open_website' => 'Открыть URL',
    ...
    'exporting_items' => 'Экспортируются элементы',
    ...
    'part_of_groups' => 'Присвоенные роли',
    ...
    'where_shall_items_be_created' => 'Где должны быть созданы элементы',
    ...
    'send_waiting_emails' => 'Отправка ожидающих писем',
    'ip' => 'IP',
    ...
    'your_attention_is_required' => 'Внимание',
    'favorite' => 'Добавить в избранное',
    'unfavorite' => 'Удалить из избранного',
    'you_need_to_select_at_least_one_folder' => 'Вам нужно выбрать хотя бы папку',
    'no_value_defined_please_fix' => 'Значение не определено',
    'apply' => 'Принять',
    'from' => 'От',
    ...
    'log_in' => 'Войти',
    'create_item_based_upon_template' => 'Создать элемент по шаблону',
    ...
    'admin_email_auth_pwd' => 'Пароль от почтового сервера',
    ...
    'at_email' => 'email',
    'enable_email_notification_on_item_shown' => 'Отправлять уведомление на имеил администратора при открытии элемента',
    'share_sent_ok' => 'Письмо отправлено',
    'see_item_title' => 'Подробности об элементе',
    'email_on_open_notification_subject' => 'Уведомление о просмотре пароля элемента',
    ...
    'email_request_access_subject' => 'Для вас имеется запрос доступа к вашему элементу',
    ...
    'admin_action_reload_cache_table_tip' => 'Сбрасывает кэш таблицы элементов. Рекомендуется запускать время от времени.',
    'admin_help' => 'Справка',
    ...
    'admin_setting_activate_expiration_tip' => 'Когда включено, устаревшие элементы не будут показываться пользователям. Назначьте срок действия пароля (в днях) где-нибудь перед включением этой функции.',
    ...
    'index_add_one_hour' => 'Продлить сеанс',
    ...
    'restricted_to_roles' => 'Разрешить назначать ограничения на пароли для пользователей и ролей',
    'root' => 'root',
    'secure' => 'Спецсимволы',
    ...
    'settings_kb_tip' => 'Добавляет элемент меню, через который можно получить доступ к базе знаний. База знаний - этой база FAQ, позволяющая создавать справку и заметки, и прикреплять их к элементам.',
    ...
    'settings_log_accessed' => 'Включить протоколирование просмотра пользователями элементов',
    ...
    'settings_printing_tip' => 'Добавляет в меню элемента функцию экспорта, позволяющую экспортировать папки в PDF или CSV файл. При этом в CSV пароли будут экспортированы в незашифрованном виде, а в PDF могут быть экспортированы с защитой с помощью пароля.',
    ...
    'yes' => 'Да',
    'one_time_view_item_url_box' => 'Поделиться одноразовой ссылкой с человеком, которому вы доверяете <br><br>#URL#<br><br>Помните, что эта ссылка будет доступна только один раз, и истечёт к #DAY#',
    ...
    'show_only_accessible_folders_tip' => 'По умолчанию пользователь видит полное дерево папок элементов, даже если он имеет доступ не ко всем папкам. Эта опция позволяет скрыть отображение папок, к которым пользователь не имеет доступа, чтобы упростить просмотр.',
    ...
    'suggestion_notify_subject' => 'Поступило новое предложение о парольном элементе.',
    ...
    'mass_operation' => 'Массовая операция над элементами',
    ...
    'documentation_canal' => 'Полная документация',
    ...
    'item_copying' => 'Элемент копируется',
    ...
    'generate_new_keys' => 'Перегенерировать ключи шифрования',
