...
$LANG = array (
    ...
    'error_custom_fields_not_similar_in_source_and_target_folders' => 'Przenoszenie folderu nie jest możliwe, ponieważ pola niestandardowe nie są podobne.',
    'is_super_manager' => 'Czy jest super menedżerem?',
    ...
    'user_language' => 'Twój język',
    'admin_agses_hosted' => 'Usługi hostingowe AGSES',
    'admin_agses_hosted_tip' => 'Usługi hostingowe AGSES',
    'user_profile_agses_enable' => 'Włącz uwierzytelnianie Agses',
    'user_profile_agses_card_id' => 'Twoje ID karty Agses',
    'admin_agses_authentication_setting' => 'Włącz dwuskładnikowe uwierzytelnianie Agses',
    'admin_agses_authentication_setting_tip' => 'Włącz dwuskładnikowe uwierzytelnianie Agses',
    'index_agses_key' => 'Kod Agses',
    'admin_agses_hosted_url' => 'URL',
    'admin_agses_hosted_id' => 'ID',
    'admin_agses_hosted_apikey' => 'Klucz API',
    'admin_agses_save' => 'Zapisz ustawienia Agses',
    'admin_agses_wait' => 'Proszę czekać... Trwa łączenie z serwerem AGSES.',
    'agses_error_missing_api_data' => 'Brakujące dane konfiguracyjne AGSES',
    'agses_error_missing_user_card_id' => 'Nie prowadzono ID karty AGSES',
    'ga_temporary_bad_code' => 'Podano zły tymczasowy kod. Sprawdź swój email i skopiuj - wklej kod ponownie.',
    ...
    'user_s_rights_on_folders' => 'Prawa do katalogów dla użytkownika',
    'folders_not_visible_are_not_displayed' => 'Foldery, które nie są wyświetlone na liście nie są widoczne dla użytkownika',
    'create_item_without_password' => 'Pozwól na dodanie pozycji bez zdefiniowanego hasła',
    'share_user_rights' => 'Współdziel prawa użytkownika',
    ...
    '2FA_new_code_by_user_not_allowed' => 'To zostało wyłączone. Proszę wyślij prośbę o nowy kod do twojego Administratora.',
    ...
    'error_cannot_delete_subfolders_exist' => 'Ten katalog nie może zostać usunięty, dopóki istnieje co najmniej jeden podkatalog.',
    ...
    'must_select_items' => 'Musisz wybrać elementy!',
    ...
    'show_suggestions' => 'Nowe sugestie',
    'show_changes' => 'Zmień propozycje',
    'suggest_password_change' => 'Zasugeruj zmianę hasła',
    'suggest_password_change_intro' => 'Dokonaj propozycji zmian przy użyciu następnych pól.',
    'suggestion_done' => 'Sugestia została zapisana',
    'suggest_change_password_blank' => 'Pozostaw to pole puste, jeśli nie chcesz dokonać zmiany hasła',
    'item_id' => 'ID elementu',
    'approve' => 'Zatwierdź',
    'reject' => 'Odrzuć',
    'click_to_edit' => 'Kliknij aby edytować',
    'otv_is_enabled' => 'Użytkownik może zaproponować jednorazowe linki',
    'notify_me_on_change' => 'Powiadom mnie przy zmianie',
    'copy_folder' => 'Kopiuj katalog',
    'copy_folder_info' => 'Ta opcja pozwala na kopiowanie folderów wraz z podfolderami i wszystkimi pozycjami. Wszystkie dane zostaną zduplikowane z takimi samymi nazwami oraz prawami',
    'copy_folder_source' => 'Katalog do skopiowania',
    'new_folder_name' => 'Nazwa nowego katalogu',
    'copy_folder_destination' => 'Katalog docelowy',
    ...
    'considering_sending_anonymous_statistics' => 'Proszę rozważ wysyłanie anonimowych statystyk',
    'anonymous_statistics_definition' => 'Użyj następnego formularza do zdefiniowania danych, które chcesz udostępnić (rozważ proszę zaznaczenie wszystkich opcji)',
    ...
    'save_statistics_choice' => 'Zapisz swoje ustawienia',
    'communication_means' => 'Środki komunikacji',
    'email_format_is_not_correct' => 'Format adresu email jest niepoprawny',
    'url_format_is_not_correct' => 'Format adresu URL jest niepoprawny',
    'Dont_update_with_this_data' => 'Nie aktualizuj elementu tymi danymi',
    ...
    'what_action_to_perform' => 'Wybierz akcję do wykonania',
    'confirm_database_reencryption' => 'Ta czynność zaszyfruje bazę danych nowym kluczem "saltkey". Potwierdź operację.',
    'previous_backup_exists' => 'Istnieje kopia zapasowa. <br>Czy chcesz przywrócić dane z kopii zapasowej?',
    'previous_backup_exists_delete' => 'Czy chcesz usunąć te stare dane?',
    ...
    'wipe_backup_data' => 'Zdecydowałeś usunąć kopię zapasową danych. To powinno być wykonane po weryfikacji danych. Proszę potwierdź.',
    'bad_psk' => 'Ten osobisty klucz soli nie jest poprawny!',
    'bad_psk_confirmation' => 'Potwierdzenie osobistego klucza soli nie jest poprawne!',
    'psk_required' => 'Osobisty klucz "sól" jest wymagany.',
    ...
    'no_username_needed' => 'Nazwa użytkownika niewymagana',
    'feature_support_canal' => 'Dla wsparcia i pomocy, proszę użyj',
    'file_is_now_ready' => 'Plik jest gotowy.',
    'category' => 'Kategoria',
    'knowledge_base' => 'Baza wiedzy',
    'anyone_can_modify_it' => 'Każdy może to zmodyfikować',
    'manage_entries_in_kb' => 'Zarządzaj wpisami w KB',
    'add_new_kb' => 'Dodaj nowy KB',
    'nothing_to_do' => 'Nie ma nic do zrobienia.',
    'continue' => 'Kontynuuj',
