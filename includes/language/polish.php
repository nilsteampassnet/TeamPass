...
$LANG = array (
    ...
    'at_field' => 'Pole',
    'category_in_folders_title' => 'Pokaż w folderach',
    'category_in_folders' => 'Wybierz foldery w których chcesz używać niestandardowych pól',
    ...
    'new_category_label' => 'Nowa nazwa kategorii',
    ...
    'for_selected_items' => 'Edytuj kategorię lub etykietę (dla zaznaczonych pozycji)',
    'move' => 'Przenieś do',
    ...
    'html' => 'html',
    'more' => 'Więcej',
    'save_categories_position' => 'Zachowaj kolejność kategorii',
    'reload_table' => 'Przeładuj tabele',
    'settings_ldap_type' => 'Typ serwera LDAP',
    'use_md5_password_as_salt' => 'Użyj hasła logowania jako osobistego klucza SALT (prostsze, mniej bezpieczne)',
    ...
    'is_administrated_by_role' => 'Użytkownik jest zarządzany jest przez',
    ...
    'masked' => 'Ukryte',
    'type' => 'Wpisz',
    'select_type_of_field' => 'Wybierz rodzaj pola',
    'define_new_field' => 'Zdefiniuj nowe pole',
    'data_is_text' => 'Dane są tekstem',
    'data_is_masked' => 'Dane są ukryte',
    'at_export' => 'Eksportuj',
    'setting_disabled_by_admin' => 'Ta opcja jest wyłączona przez administratora',
    'confirm_change_field_type' => 'Potwierdź zmianę rodzaju pola',
    'admin_script_backup_secret' => 'Klucz do wykonania kopi zapasowej',
    'admin_script_backup_secret_tip' => 'Musisz podać hasło kopi zapasowej by rozpocząć kopię zapasową. Musi być dodana jako parametr do  script.backup.php . Przykład: scripts.backup.php?key=your_passkey',
    'access_level_for_roles' => 'Przypisanie dostępu dla Ról',
    ...
    'error_psk_should_be_changed' => 'Z powodu zmiany polisy, możesz musieć zmienić osobisty klucz "Saltkey"',
    ...
    'create_github_bug_report' => 'Zaraportuj nowy błąd',
    'deselect_all' => 'Odznacz wszystkie',
    'request_access_to_item' => 'Poproś o dostęp do tego elementu',
    'request_access_to_item_info' => 'Podaj przyczynę, dla której chcesz uzyskać dostęp do tego elementu',
    ...
    'report_a_bug' => 'Raportuj błąd',
    'enable_http_request_login' => 'Automatyczne logowanie przez dane uwierzytelniające nagłówka http',
    'duration_login_attempt' => 'Sekund do automatycznego logowania',
    'newly_created_user_role' => 'Nowo utworzeni użytkownicy posiadają rolę',
    'at_user_updated' => 'Dane użytkownika #user_login# zostały zaktualizowane',
    'human_resources' => 'Manager użytkowników',
    'login_attempts' => 'Prób logowania od ostatniego zalogowania się',
    'settings_secure_display_image' => 'Włącz obrazek zabezpieczający',
    'settings_secure_display_image_tip' => 'Obrazek zabezpieczający pozwala odczytać obraz wykorzystując PHP kiedy użytkownik podejrzy obraz dołączony do elementu. Zalety: załącznik jest przechowywany poza witryną i nie jest dostępny dla hakera. Wady: jest nieco wolniejszy niż podgląd bezpośrednio z adresu URL.',
