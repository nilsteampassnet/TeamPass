...
return array(
    ...
    'email_body_new_user' => 'こんにちは<br><br>これメールは Teampass パスワード マネージャーから自動生成されています.<br><br>管理者が Teampass のユーザー アカウントを作成しました。次回 Teampass にログインする際、次のログイン情報を使用してください:<ul><li>ログインID: #login#</li><li>パスワード: #password#</li><li>暗号化コード: #code#</li></ul><br><br><br>',
