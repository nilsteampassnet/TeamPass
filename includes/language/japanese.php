...
return array(
    ...
    'error_fetching_password' => 'パスワード取得中にエラーが発生しました',
    'user_is_not_auth_with_oauth2' => 'User should not authenticate with Entra/Azure AD',
    'oauth2_need_user_old_password' => '',
    'tenant_id' => 'テナントID',
    'server_connected_to_internet' => 'サーバーはインターネットに接続されています',
    'server_not_connected_to_internet' => 'サーバーはインターネットに接続されていません',
