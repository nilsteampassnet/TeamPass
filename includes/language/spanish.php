...
$LANG = array (
    ...
    'email_ga_subject' => '[TeamPass] Su código de Google Authenticator para TeamPass',
    ...
    'ga_enter_credentials' => 'Debe introducir las credenciales de usuario',
    ...
    'settings_get_tp_info_tip' => 'Cuando está habilitada, la información tal como las versiones actuales de software, parches de bugs y noticias sobre lanzamientos, son mostrados en la página de administrador desde los servicios remotos.',
    'at_field' => 'Campo',
    ...
    'offline_menu_title' => 'Exportar ítems para el modo Off-line',
    'settings_offline_mode' => 'Exportación de modo HTML Offline activado',
    'settings_offline_mode_tip' => 'El modo Fuera de línea consiste en exportar los ítems en un archivo HTML. Los ítems son cifrados con una clave dada por el usuario.',
    'offline_mode_key_level' => 'Calidad mínima para la clave de cifrado Fuera de línea.',
    ...
    'move' => 'Mover a',
    'field_add_in_category' => 'Añadir un nuevo campo en esta categoría',
    'rename' => 'Renombrar',
    ...
    'settings_tree_counters_tip' => 'Está opción mostrará 3 contadores por cada carpeta: el número de elementos en la carpeta; el número de elementos en las subcarpetas y el número de subcarpetas. Está opción requiere más consultas SQL y puede demorar más tiempo en mostrar el árbol.',
    'settings_encryptClientServer' => 'El intercambio cliente-servidor está cifrado.',
    'settings_encryptClientServer_tip' => 'El cifrado AES-256 está habilitado por defecto. Se debería activar si no utilizas certificados SSL para securizar el intercambio de información entre cliente-servidor. Si estás utilizando el protocolo SSL o si estás usando TeamPass en una Intranet, puedes desactivar esta opción para agilizar el tiempo de carga en TeamPass.  /!\\ Recuerda que la solución más segura es utilizar SSL entre ciente y servidor.',
    ...
    'enable_personal_folder_feature_tip' => 'Una vez activada, debes ejecutar manualmente el script que crea las carpetas personales para los usuarios existentes. Está opción únicamente creará las carpetas personales para usuarios que no tienen creada dicha carpeta',
    ...
    'setting_can_create_root_folder' => 'Autorizado a crear nuevas carpetas en Raíz',
    ...
    'admin_action_generate_encrypt_keys_tip' => 'El juego de llaves es un aspecto muy importante en la seguridad de la instalación de su TeamPass. De hecho, estas llaves se utilizan para cifrar la comunicación entre Servidor y Cliente. Aunque este fichero este securizado fuera de la zona web de su servidor, es recomendable regenerar las mismas de cuando en cuando. Tenga en cuenta que esta operación puede llevar no más de 1 minuto.',
    ...
    'email_subject_item_updated' => '[TeamPass] La clave ha sido actualizada',
    ...
    'settings_insert_manual_entry_item_history' => 'Habilitar la introducción de elementos en el LOG histórico de los elementos.',
    ...
    'automatic_del_after_date_text' => 'o después de la fecha',
    ...
    'error_times_before_deletion' => 'El número de consultas antes de la eliminación tiene que ser mayor que 0',
    ...
    'pdf' => 'PDF',
    'csv' => 'CSV',
    'user_admin_migrate_pw' => 'Migrar objetos personales a una cuenta de usuario.',
    ...
    'email_new_user_mail' => 'Hola,&lt;br /&gt;&lt;br /&gt;Un administrador ha creado su cuenta para TeamPass.&lt;br /&gt;Puede usar las siguientes credenciales para iniciar sesión:&lt;br /&gt;- Usuario: #tp_login#&lt;br /&gt;- Contraseña: #tp_pw#&lt;br /&gt;&lt;br /&gt;Haga clic &lt;a href=\'#tp_link#\'&gt;aquí&lt;/a&gt; para acceder.&lt;br /&gt;&lt;br /&gt;Saludos.',
    ...
    'email_subject_on_user_login' => '[TeamPass] Información: Un usuario se ha conectado',
    ...
    'admin_action_purge_old_files_tip' => 'Esto borrará todos los archivos temporales con más de 7 días.',
    ...
    'can_create_root_folder' => 'Puede crear carpetas en el nivel raíz',
    ...
    'confirm' => 'Confirmar',
    'confirm_delete_group' => 'Ha decidido eliminar esta Carpeta y todos los elementos incluidos en ella... ¿Está seguro?',
    ...
    'email_subject' => '[TeamPass] Creando un nuevo elemento en el Administrador de Contraseñas',
    ...
    'error_cpassman_dir' => 'No hay una ruta física establecida para TeamPass. Por favor, seleccione la pestaña \'Configuración de TeamPass\' en la página de Configuraciones de Administrador.',
    ...
    'error_group_complex' => 'La Carpeta debe tener un nivel de complejidad de contraseña mínimo requerido',
    ...
    'error_not_authorized' => 'No está autorizado a ver esta página.',
    'error_not_exists' => 'Esta página no existe.',
    'error_no_folders' => 'Debería empezar creando alguna carpeta.',
    ...
    'forgot_pw_email_body' => 'Hola,&lt;br /&gt;&lt;br /&gt;este es un correo generado por TeamPass.&lt;br /&gt;&lt;br /&gt;Su nueva contraseña para acceder a TeamPass es:',
    'forgot_pw_email_body_1' => 'Hola,&lt;br /&gt;&lt;br /&gt;este es un correo generado por TeamPass.&lt;br /&gt;&lt;br /&gt;Sus credenciales de identificación para TeamPass son:&lt;br /&gt;',
    'forgot_pw_email_subject' => '[TeamPass] Su contraseña',
    'forgot_pw_email_subject_confirm' => '[TeamPass] Su contraseña paso 2',
    'functions' => 'Roles',
    'function_alarm_no_group' => 'Este rol no está asociado a ninguna Carpeta',
    ...
    'item_menu_collab_enable' => 'La edición está permitida',
    ...
    'not_allowed_to_see_pw' => 'No está autorizado a ver ese elemento',
    ...
    'pdf_del_title' => 'Seguimiento de la renovación de contraseñas',
    ...
    'personal_salt_key_info' => 'Esta clave Salt se usará para cifrar y descifrar sus contraseñas',
    ...
    'print_out_warning' => '¡Todas las claves y datos confidenciales se escribirán en este archivo sin encriptar! Al hacer esto usted está asumiendo la completa responsabilidad sobre la protección de esta lista.',
    'pw' => 'Contraseña',
    ...
    'pw_life_duration' => 'Tiempo de vida de la contraseña de los usuarios antes de expirar (en días, 0 para deshabilitar)',
    ...
    'settings_ldap_mode' => 'Permitir autenticación de usuarios a través de servidor LDAP',
    ...
    'settings_ldap_tls' => 'Usar LDAP a través de TSL',
    ...
    'settings_maintenance_mode_tip' => 'En el modo de mantenimiento, solo podrán acceder los Administradores. Actívelo antes de realizar cambios significativos, como cambiar la clave salt.',
    ...
    'settings_send_stats' => 'Enviar estadísticas mensuales al autor para un mejor entendimiento del uso de TeamPass',
    ...
    'timezone_selection' => 'Zona horaria seleccionada',
    'time_format' => 'Formato de la hora',
    'uncheck_all_text' => 'Deseleccionar todo',
    'unlock_user' => 'El usuario está bloqueado. ¿Desea desbloquear esta cuenta?',
    ...
    'views_confirm_restoration' => 'Por favor confirme la restauración de este elemento',
    ...
    'settings_api_ip_whitelist' => 'Lista blanca de IPs autorizadas.',
    ...
    'settings_api_world_open' => 'No IP definida. Esta característica está disponible desde cualquier lugar (puede ser inseguro).',
    'subfolder_rights_as_parent' => 'Las nuevas sub-carpetas heredan los permisos de las carpetas de las que dependen.',
    'subfolder_rights_as_parent_tip' => 'Cuando esta característica está deshabilitada, cada nuevo sub-carpeta hereda los permisos asociados al rol del usuario que la crea. Si esta habilitada, cada nueva subcarpeta heredará los permisos de la carpeta superior.',
    ...
    'suggestion_add' => 'Agregar una sugerencia para el ítem',
    'comment' => 'Comentario',
    ...
    'settings_ldap_search_base_tip' => 'Buscar en la raíz DN para búsquedas en el árbol',
    ...
    'settings_ldap_user_attribute' => 'Búsqueda de atributo de usuario',
    ...
    'duo_loading_iframe' => 'El marco de validación de DUOSecurity está siendo cargado. Por favor, espere.',
    'settings_duo' => 'Habilitar DUOSecurity.com como proveedor de doble factor de validación',
    'settings_duo_tip' => 'La validación de doble factor puede ser asegurada usando DUOSecurity.com. Esta librería garantiza un alto nivel de seguridad en cuanto a la validación del usuario.',
    'admin_duo_akey' => 'AKEY',
    'admin_duo_ikey' => 'IKEY',
    'admin_duo_skey' => 'SKEY',
    'admin_duo_host' => 'HOST',
    ...
    'user_info_delete' => 'Por favor has clic nuevamente para confirmar la ELIMINACIÓN de esta cuenta.',
    'user_info_delete_warning' => 'Al hacer clic en el botón Guardar, borrarás esta cuenta de TeamPass.<br/>No es posible deshacer esta acción.',
    'edit' => 'Editar',
    ...
    'list_items_with_tag' => 'Mostrar ítems con esta etiqueta',
    'no_item_to_display' => 'No hay ítems para mostrar',
    ...
    'suggestion_notify_body' => 'Hola, <br><br>Una nueva sugerencia ha sido creada. Necesitas validarla antes de que pueda ser vista por otros usuarios',
    'error_unknown' => '¡Un error desconocido ha ocurrido!',
    'no_edit_no_delete' => 'Escritura, pero ni edición ni eliminación',
    ...
    'reload_page_after_user_account_creation' => 'Tu cuenta ha sido creada. Esta página se recargará automáticamente en 3 segundos ...',
    ...
    'update_server_password' => 'Actualiza la contraseña del servidor',
    'error_personal_sk_expected' => '¡Debes introducir primero tu clave salt personal!',
    'click_to_generate' => 'Clic para generar',
    ...
    'csv_import_information' => 'El archivo CSV necesita cumplir las siguientes reglas:<ul><li>La primera línea debe ser la cabecera,</li><li>La cabecera debe contener 5 columnas,</li><li>El carácter de separación es la coma `,`,</li><li>El carácter para encapsular es las comillas dobles `"`,</li><li>Las columnas esperadas son: `Etiqueta` , `Login` , `Contraseña` , `URL` , `Comentarios`.</li></ul> ',
    ...
    'error_only_numbers_in_folder_name' => 'El nombre de carpeta no puede contener solo números. Por favor, escribe un nombre de carpeta que incluya letras.',
    ...
    'encrypted_data' => 'Los datos están encriptados en la base de datos',
    'not_encrypted_data' => 'Los datos no están encriptados en la base de datos',
    'error_custom_fields_not_similar_in_source_and_target_folders' => 'No es posible mover la carpeta ya que los campos personalizados no son similares.',
    ...
    'admin_agses_hosted' => 'Servicio alojado por AGSES',
    'admin_agses_hosted_tip' => 'Servicio alojado por AGSES',
    'user_profile_agses_enable' => 'Habilitar autenticación Agses',
    'user_profile_agses_card_id' => 'Tu ID de tarjeta Agses',
    'admin_agses_authentication_setting' => 'Habilitar la autenticación de dos pasos de Agses',
    'admin_agses_authentication_setting_tip' => 'Habilitar la autenticación de dos pasos de Agses',
    'index_agses_key' => 'Código Agses',
    'admin_agses_hosted_url' => 'Enlace',
    'admin_agses_hosted_id' => 'ID',
    'admin_agses_hosted_apikey' => 'Clave API',
    'admin_agses_save' => 'Guardar configuración de AGSES',
    'admin_agses_wait' => 'Espere ... contactando con el servidor AGSES.',
    'agses_error_missing_api_data' => 'Faltan datos de configuración de AGSES',
    'agses_error_missing_user_card_id' => 'No se ha proporcionado un ID de tarjeta AGSES',
    'ga_temporary_bad_code' => 'El código temporal que ha ingresado es incorrecto. Comprueba tu correo electrónico, pega el código y vuelve a intentarlo.',
    ...
    'user_s_rights_on_folders' => 'Derechos sobre las carpetas de usuario',
    'folders_not_visible_are_not_displayed' => 'Las carpetas que no aparecen en esta lista no son vistas por el usuario',
    'create_item_without_password' => 'Permitir que el elemento se cree sin ninguna contraseña definida',
    'share_user_rights' => 'Compartir derechos de usuario',
    'share_rights_info' => 'Esta ventana de diálogo le permite compartir los derechos de un usuario con una selección de usuarios. <br>Note que los usuarios seleccionados tendrán sus derechos existentes resetedos y reemplazados con exactamente los mismos derechos que el usuario de origen.',
    ...
    '2FA_new_code_by_user_not_allowed' => 'Esto se ha inhabilitado. Solicite un nuevo código a su Administrador.',
    ...
    'error_cannot_delete_subfolders_exist' => 'Esta carpeta no se puede eliminar mientras al menos una subcarpeta exista.',
    ...
    'must_select_items' => '¡Debe seleccionar elementos!',
    ...
    'show_suggestions' => 'Nuevas sugerencias',
    'show_changes' => 'Propuestas de cambio',
    'suggest_password_change' => 'Sugerir un cambio de contraseña',
    'suggest_password_change_intro' => 'Haga sus propuestas de cambio usando los campos siguientes.',
    'suggestion_done' => 'Se ha almacenado la sugerencia.',
    'suggest_change_password_blank' => 'Deje este campo vacío si no desea sugerir una contraseña',
    'item_id' => 'Identificación del elemento',
    'approve' => 'Aprobar',
    'reject' => 'Rechazar',
    'click_to_edit' => 'Clic para editar',
    'otv_is_enabled' => 'El usuario puede proponer enlaces de una-sola-vista',
    'notify_me_on_change' => 'Notificarme si hay cambios',
    'copy_folder' => 'Copiar carpeta',
    'copy_folder_info' => 'Esta función permite copiar el contenido de una carpeta que incluye subcarpetas y elementos. Todos los que se duplicarán con exactamente mismos nombres y derechos.',
    'copy_folder_source' => 'Carpeta a copiar',
    'new_folder_name' => 'Nuevo nombre de la carpeta',
    'copy_folder_destination' => 'Carpeta de destino',
    ...
    'considering_sending_anonymous_statistics' => 'Por favor considere enviar estadísticas anónimas',
    'anonymous_statistics_definition' => 'Utilice el siguiente formulario para definir los datos que puede compartir (por favor, considere mantener todas las opciones marcadas)',
    ...
    'save_statistics_choice' => 'Guardar la configuración',
    'communication_means' => 'Medios de comunicación',
    'email_format_is_not_correct' => 'El formato de correo electrónico no es correcto',
    'url_format_is_not_correct' => 'El formato de URL no es correcto',
    'Dont_update_with_this_data' => 'No actualizar el elemento con estos datos',
    ...
    'revert' => '¿Revertir?',
    'revert_the_database' => 'Ha decidido revertir la base de datos. Por favor confírmalo',
    'wipe_backup_data' => 'Ha decidido borrar los datos de copia de seguridad. Esto debe hacerse después de la verificación de los datos. Por favor confírmalo',
    'bad_psk' => '¡Ese saltkey personal no es correcto!',
    ...
    'masked' => 'Enmascarado',
    'type' => 'Tipo',
    'select_type_of_field' => 'Seleciona tipo de campo',
    ...
    'newly_created_user_is_administrated_by' => 'El usuario creado recientemente es administrado por',
    'open_bug_report_in_github' => 'Abrir informe de problema en Github',
    'bug_report_to_github' => 'Completa el contenido del informe, cópialo en el portapapeles y pégalo en la página de nueva incidencia en GitHub',
    ...
    'create_item_based_upon_template' => 'Uso de la plantilla para el elemento',
    'log_in' => 'Iniciar sesión',
    'filter' => 'Filtro',
    'upload_empty_file' => 'Subir ficheros vacíos',
    'upload_any_extension_file' => 'Subir ficheros con cualquier extensión',
    'upload_any_extension_file_tip' => 'Cuando está activada, esta opción permite a los usuarios subir ficheros de cualquier tipo.',
    '2factors_expected_for_admin' => 'El Administrador requiere 2FA para acceder',
    '2factors_expected_for_admin_tip' => 'Por defecto, el Administrador ha de utilizar 2FA para accedcer. Si no está activada, el Administrador no requerirá 2FA para acceder incluso si 2FA está activo para cualquier otro usuario. Asegúrate de probar la autenticación de doble factor con otra cuenta antes de activarlo para el administrador, ya que podrías bloquear el acceso al sistema de manera permanente.',
    '' => ''
);
