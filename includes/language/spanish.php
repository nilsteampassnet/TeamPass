...
return array(
    ...
    'error_fetching_password' => 'Error al recuperar la contraseña',
    'unable_to_clear_clipboard' => 'No se puede borrar el portapapeles manualmente',
    'clipboard_unsafe' => 'El portapapeles no se ha podido borrar automáticamente, ¡esto no es seguro!',
    'clipboard_clear_now' => '¡Borrar ahora!',
    'clipboard_clearing_failed' => 'Falló el borrado del portapapeles',
    'clipboard_error' => 'Error del portapapeles',
    'csv_import_success' => 'Archivo CSV importado correctamente',
    'number_of_items_failed' => 'Número de elementos con error',
    'import_error_item_creation' => 'Error al crear el elemento',
    'import_no_items_to_process' => 'No hay elementos para procesar',
    'import_error_no_rights' => 'No tienes permisos para crear carpetas al importar elementos',
    'password_minimal_complexity_target_for_folders' => 'Complejidad mínima de contraseña para las carpetas nuevas',
    'access_right_for_roles_for_folders' => 'Permisos de acceso para roles en las carpetas nuevas',
    'import_folders_success' => 'Carpetas importadas correctamente',
    'to_be_imported' => 'Por importar',
    'please_wait_folders_in_construction' => 'Por favor, espera, las carpetas se están creando',
    'please_wait_items_in_construction' => 'Por favor, espera, los elementos se están creando',
    'import_csv_keys_generation_strategy' => 'Estrategia de generación de claves',
    'import_csv_keys_generation_strategy_tip' => 'Al importar elementos, puedes elegir entre generar nuevas claves para los elementos sobre la marcha o usar el gestor de tareas.',
    'max_parallel_tasks' => 'Número máximo de tareas paralelas',
    'max_parallel_tasks_tip' => 'Esta opción establece el número máximo de tareas de proceso que pueden ejecutarse simultáneamente. Es importante ajustar este número en función de la capacidad de los vCPUs para evitar la sobrecarga del sistema. Comienza con un número conservador y ajústalo según el rendimiento observado.',
    'item_copied' => 'Elemento copiado',
    'item_updated' => 'Elemento actualizado',
    'done_tasks_history_delay_in_days' => 'Periodo de conservación del historial de tareas (en días)',
    'oauth2_synchronization' => 'Sincronización OAuth2',
    'oauth2_user_has_no_mail' => 'El usuario no tiene una dirección de correo electrónico',
    ...
    'account_in_construction_please_wait_email' => 'Tu cuenta se está creando en este momento. Recibirás un correo electrónico cuando esté lista.',
    'oauth_selfregistered_user_belongs_to_role' => 'Rol para usuarios autorregistrados',
    'oauth_self_register_groups' => 'Grupos permitidos para el autorregistro',
    'oauth_self_register_groups_tip' => 'Lista de grupos separados por comas que tienen permitido el autorregistro. Déjalo vacío si quieres desactivar el autorregistro. El autorregistro permite crear una cuenta de usuario en Teampass sin la necesidad de un administrador. El usuario podrá iniciar sesión con sus credenciales de AD y se creará automáticamente en Teampass.',
    'oauth_selfregistered_user_belongs_to_role_tip' => 'Este rol se asignará al usuario cuando se cree si no pertenece a ningún grupo que ya exista en Teampass.',
    'file_not_exists' => 'El archivo no existe',
    'path_not_a_file' => 'La ruta no es un archivo',
    'file_not_writable' => 'El archivo no tiene permisos de escritura',
    ...
    'unknown_files_should_be_deleted' => 'Se recomienda eliminar estos archivos para prevenir conflictos entre versiones.',
    'remaining_lock_time' => 'Tiempo de bloqueo restante',
    'seconds' => 'segundos',
    'users_fetch_error' => 'Ocurrió un error al obtener los usuarios',
    'at_phone_number' => 'Número de teléfono',
    'at_otp_secret' => 'Clave secreta OTP',
    'item_checkbox' => 'Casilla de verificación del elemento',
    ...
    'user_password_changed' => 'Su contraseña ha cambiado. Por favor, introduzca su contraseña anterior para recifrar sus elementos personales. Una vez hecho esto, espere unos minutos antes de acceder a sus elementos personales.',
    'no_previous_valide_private_key' => 'Ninguna clave privada anterior corresponde a la contraseña proporcionada.',
    'copy_sub_directories' => 'Copiar subdirectorios',
    ...
    'settings_category_system_title' => 'Ajustes del sistema y mantenimiento',
    ...
    'settings_category_items_goal' => 'Controla cómo se organizan y gestionan los elementos y carpetas.',
    'settings_category_collaboration_title' => 'Funcionalidades colaborativas y avanzadas',
    'settings_category_collaboration_goal' => 'Proporciona herramientas y funcionalidades adicionales para el trabajo en equipo.',
    'settings_category_integration_goal' => 'Define integraciones y automatización de procesos.',
    'settings_category_integration_title' => 'Integraciones y automatización',
    'settings_category_logging_title' => 'Registros e historial',
    'settings_category_logging_goal' => 'Gestiona los registros y el seguimiento de acciones para auditoría y trazabilidad.',
    'build_missing_api_keys' => 'Generar claves de API para usuarios que no la tengan',
    ...
    'attention_user_password_change' => 'Atención: su contraseña ha cambiado, es necesario recifrar sus elementos personales.',
    'your_current_password' => 'Su contraseña actual',
    'please_fill_in_all_required_fields' => 'Por favor, rellene todos los campos obligatorios.',
    ...
    'purging_in_progress' => 'Purga en progreso',
    'confirm_purge_old_users' => '¿Está seguro de que desea purgar los usuarios que han estado en la lista de eliminados durante más tiempo del periodo de retención especificado?',
    ...
    'confirm_purge_user' => '¿Está seguro de que desea purgar a este usuario?',
