...
return array(
    ...
    'email_body_user_added_from_ldap_encryption_code' => 'Hola,<br><br>Este es un correo electrónico generado por el gestor de contraseñas Teampass.<br><br>Ahora tienes una cuenta en Teampass. Puedes utilizar tus credenciales LDAP para iniciar la sesión.<br><br>En el primer inicio de sesión, se espera un código de cifrado de ti, por favor, utiliza:<br><br><b>#enc_code#</b><br><br><br>Saludos',
    'settings_ldap_user_object_filter' => 'Filtro de objetos del usuario',
    'settings_ldap_user_object_filter_tip' => 'El filtro que se utilizará para buscar objetos de usuario. Varios filtros se separan por una coma (,). Ejemplo: (objectCategory=Persona),(sAMAccountName=*)',
    ...
    'ldap_user_has_changed_his_password' => 'Tu contraseña de autentificación ha sido cambiada en tu LDAP desde la última vez que te conectaste en Teampass. Necesitamos adaptar tu clave de cifrado. Por favor, indica tu contraseña anterior y la actual.',
    ...
    'email_body_temporary_encryption_code' => 'Hola,<br><br>Este es un correo electrónico generado por el gestor de contraseñas Teampass.<br><br>Se han realizado algunos cambios en tu cuenta que requieren una nueva codificación de los elementos para la seguridad de los datos. La próxima vez que conectes a Teampass, utiliza el siguiente código:<br><br><b>#enc_code#</b><br><br><br>Saludos',
    ...
    'logout_confirm' => '¿Cerrar de sesión?',
    'saved' => 'Guardado',
    ...
    'users' => 'Usuarios',
    'folders' => 'Carpetas',
    'find_message' => 'Objeto(s) encontrado(s)',
    ...
    'email_body_item_updated' => 'Hola:<br><br>La contraseña para &apos;#item_label#&apos; ha sido actualizada.<br /><br />Puede comprobarla <a href="#url#/index.php?page=items&group=#item_category#&id=#item_id#">AQUÍ</a><br /><br />Saludos',
    ...
    'settings_upload_imageresize_options' => '¿Redimensionar las imágenes?',
    ...
    'user_profile_api_key' => 'Clave API',
    ...
    'admin_2factors_authentication_setting_tip' => 'La autenticación Google en dos pasos permite añadir un nivel más de seguridad en la autenticación. Cuando el usuario quiere logarse a Teampass, se genera un código QR. Este código tiene que ser escaneado por el usuario para obtener un password de un solo uso.<br><strong>ADVERTENCIA:</strong> Este paso extra necesita una conexión a Internet y un lector de códigos QR (por ejemplo un smartphone)',
    ...
    'email_share_item_subject' => '[TeamPass] Un elemento ha sido compartido contigo',
    ...
    'upload_any_extension_file' => 'Subir cualquier tipo de fichero',
    'upload_any_extension_file_tip' => 'Cuando está activada, esta opción permitirá a los usuarios cargar cualquier tipo de ficheros.',
    'log_in' => 'Log In',
    ...
    'admin_proxy_ip_tip' => 'Si su conexión a internet requiere un proxy, indíquelo aquí. Déjelo en blanco si no hay proxy.',
    ...
    'settings_ldap_elusers_tip' => 'Esta característica permite a los usuarios en la base de datos autenticarse mediante LDAP. Deshabilita esta opción si quiere navegar por cualquier directorio LDAP.',
    ...
    'settings_delay_for_item_edition_tip' => 'Cuando se edita un elemento, el elemento se bloquea para impedir ediciones paralelas. Para ello se reserva una especie de token. Este parámetro permite borrar el token tras un cierto tiempo. Si el valor se establece a 0, el token nunca se borrará.',
    ...
    'admin_email_test_subject' => '[TeamPass] Correo electrónico de prueba desde el administrador',
    'admin_email_test_body' => 'Este es un correo electrónico para verificar la configuración del servidor de correo electrónico. Si puedes leer esto, felicidades!',
    ...
    'admin_path_to_files_folder_tip' => 'La carpeta de Archivos (Files) se usa para almacenar todos los archivos generados por TeamPass y también algunos archivos subidos.<br><strong>IMPORTANTE:</strong> por razones de seguridad, esta carpeta no tiene que estar en la carpeta WWW de su sitio web. Tiene que estar en una zona protegida con una regla de redirección en la configuración del Servidor.<br><strong>IMPORTANTE 2:</strong> Puede ser bueno programar una tarea CRON para limpiar periódicamente esta carpeta.',
    'admin_path_to_upload_folder_tip' => 'La carpeta de Upload se usa para almacenar todos los archivos subidos asociados a los Elementos.<br><strong>IMPORTANTE:</strong> por razones de seguridad, esta carpeta no tiene que estar en la carpeta WWW de su sitio web. Tiene que estar en una zona protegida con una regla de redirección en la configuración del Servidor.<br><strong>IMPORTANTE 2:</strong> ¡Esta carpeta nunca debe ser eliminada! Esos archivos están asociados a Elementos.',
    ...
    'admin_setting_enable_delete_after_consultation_tip' => 'Cuando esta activado, el creador del elemento puede decidir si el elemento va a ser eliminado automáticamente después de ser visto X veces.',
    'at_email' => 'email',
    ...
    'pdf' => 'PDF',
    'email_subject_new_user' => '[TeamPass] Se ha creado una cuenta para tí',
    ...
    'settings_anyone_can_modify_tip' => 'Cuando está activado, añade una casilla en el elemento que permite a su creador posibilitar la modificación de este elemento por cualquier usuario.',
    'settings_default_language' => 'Define el idioma por defecto',
    'settings_kb' => 'Habilitar Base de Conocimientos (beta)',
    'settings_kb_tip' => 'Una vez activado, esto agregará una página en la cual usted puede construir su Base de Conocimientos.',
    ...
    'suggestion_notify_subject' => '[Teampass] Se ha creado una nueva sugerencia',
    ...
    'error_bad_credentials_more_than_3_times' => '¡Credenciales incorrectas!<br> Por favor, espere 10 segundos antes de intentarlo de nuevo.',
    ...
    'enable_tasks_log_tip' => 'Permite registrar todas las tareas realizadas por el trabajo de cron dentro de la tabla <i>processes_log</i>. Podría ser útil para verificar eventos.',
    'items_and_folders_statistics' => 'Estadísticas de ítems y carpetas',
    'item_copying' => 'El ítem está siendo copiado',
    'upgrade_requested' => 'La base de datos de Teampass no está actualizada',
    'upgrade_requested_more' => 'Algunas inconsistencias han sido identificadas entre los archivos y la configuración. El administrador debe realizar un proceso de actualización antes de continuar.',
    'settings_ldap_group_object_filter' => 'Filtro de objetos de grupo LDAP',
    'settings_ldap_group_object_filter_tip' => 'Filtro LDAP a usar para encontrar el grupo de objetos. Por ejemplo: (objectClass=group1)(objectClass=group2)',
    'settings_ad_users_with_ad_groups' => 'Roles de usuario en AD mapeados con sus grupos de AD',
    'settings_ad_users_with_ad_groups_tip' => 'Permisos para mapear roles de usuario de AD con sus grupos de AD. Estos roles serán añadidos a un perfil predeterminado.',
    'settings_ad_user_auto_creation' => 'Usuario de AD a ser creado automáticamente',
    'settings_ad_user_auto_creation_tip' => 'Permite que un usuario de AD se cree automáticamente en Teampass cuando inicia sesión por primera vez. Tenga en cuenta que si la opción "Funciones de usuario de AD asignadas con sus grupos de AD" está habilitada, obtendrá las funciones asignadas con sus grupos de AD.',
    'settings_ldap_guid_attibute' => 'Atributo LDAP GUID',
    'settings_ldap_guid_attibute_tip' => 'Atributos LDAP a usar para identificar el GUID de un objeto. Por ejemplo: objectGUID, objectSid, GUID, gidNumber, ...',
    'ad_group' => 'Grupo de AD',
    'mapped_with_role' => 'Mapeado con rol',
    'ad_groupe_and_roles_mapping' => 'Mapeo de roles y grupos de AD',
    'select_adgroup_mapping' => 'Seleccione el rol a mapear con el grupo actual de AD',
    'enable_backlog_mail' => 'Habilitar envío de backlog por email',
    ...
    'tasks_cron_not_running' => 'El trabajo de cron no está configurado. Edite crontab con el usuario de su servidor (generalmente www-data) con el comando "crontab -u www-data -e". O presione el botón para intentar su creación automáticamente.',
    'tasks_cron_running' => 'El trabajo cron está configurado correctamente',
    'currently_using_version' => 'Versión actualmente cargada',
    'git_commit_value' => 'Valor de Git commit',
    'generate_new_keys' => 'Generar nuevas claves',
    'generate_new_keys_info' => 'Si continúa, generará nuevas claves de cifrado para todos los objetos a los que tenga acceso. Esto solo debe hacerse si no muestra ninguna contraseña.',
    'generate_new_keys_end' => 'El proceso se está realizando en segundo plano y puede tardar varios minutos. Ahora puede cerrar esta ventana.',
    'confirm_password' => 'Necesitamos que confirme su contraseña',
    'no_code_is_requested' => 'Ningún código es requerido.',
    'user_encryption_ongoing' => 'La cuenta está siendo cifrada. Su petición no puede continuar. Por favor espere hasta que haya finalizado.',
    'teampass_information' => 'Información de Teampass',
    'show_password' => 'Mostrar contraseña',
    'new_user_info_by_mail' => 'Los nuevos usuarios recibirán un email con sus credenciales',
    'login_credentials' => 'Credenciales de acceso',
    'email_body_user_config_1' => 'Hola #lastname#,<br><br>Este es un correo electrónico generado por Teampass.<br>Se esperan las siguientes credenciales la próxima vez que use Teampass:<br><br><ul><li>Usuario: #login#</li><li>Contraseña: #password#</li><li>Código de cifrado: #code#</li></ul><br><br>Saludos.',
    'email_body_user_config_3' => 'Hola #lastname#,<br><br>Este es un correo electrónico generado por Teampass.<br><br>Se espera la siguiente contraseña la próxima vez que use Teampass:<br><br><b>#password#</b><br><br>Saludos.',
    'email_body_user_config_4' => 'Hola #lastname#,<br><br>Este es un correo electrónico generado por Teampass.<br><br>Su cuenta de Teampass está completamente lista.<br><br>Saludos.',
    'email_body_user_config_5' => 'Hola #lastname#,<br><br>Este es un correo electrónico generado por Teampass.<br><br>Se espera el siguiente código la próxima vez que use Teampass:<br><br><b>#code#</b><br><br>Saludos.',
    'email_body_user_config_6' => 'Hola #lastname#,<br><br>Este es un correo electrónico generado por Teampass.<br><br>Se esperan las siguientes credenciales la próxima vez que use Teampass:<br><br><ul><li>Usuario: #login#</li><li>Contraseña: #password#</li></ul><br><br>Saludos.',
    'error_data_not_valid' => 'Los datos no son válidos',
    'mfa_enabled' => 'MFA habilitado',
    'mfa_disabled_for_user' => 'MFA deshabilitado para usuario',
    'users_personal_folder' => 'Carpeta personal del usuario',
    'maintenance_operations' => 'Operaciones de mantenimiento',
    'maintenance_operations_tip' => 'Operaciones de mantenimiento seleccionadas en la base de datos Teampass.',
    ...
    'run_weekday' => 'Ejecutar día de la semana',
    'monday' => 'Lunes',
    'tuesday' => 'Martes',
    'wednesday' => 'Miércoles',
    'thursday' => 'Jueves',
    ...
    'day' => 'Día',
    'reset' => 'Restablecer',
    'error_while_creating_file' => 'Error al crear el fichero',
    'new_keys_generated' => 'Nuevas claves generadas',
    'user_creation' => 'Creación de usuario',
    'user_deletion' => 'Eliminación de usuario',
    'maximum_session_expiration_time' => 'Tiempo máximo de expiración de la sesión',
    ...
    'next_passwords_were_valid_until_date' => 'Las siguientes contraseñas eran válidas hasta la fecha',
    'feature_disabled_by_administrator' => 'Característica desactivada por el administrador',
    'shared_globaly' => 'Compartido globalmente',
    'settings_otv_subdomain' => 'nombre del subdominio OTV',
    'settings_otv_subdomain_tip' => 'Subdominio dedicado para enlaces de una sola vez. Considere que su URL principal de Teampass está aislada de Internet; todos podrían acceder a este subdominio para compartir este elemento con alguien fuera de su organización. Desde la perspectiva de la seguridad, es mucho más seguro con este tipo de mecánica. Nota: Esto requeriría tener una entrada DNS para este subdominio que apunte a su servidor Teampass.',
    'existing_valid_otv_links' => 'Enlaces válidos para OTV',
    'started' => 'Iniciado',
    'recovery_keys_not_downloaded' => 'Claves de recuperación no descargadas',
    'no_recovery_keys' => 'No tengo claves de recuperación. Esto borrará todas las contraseñas de mis artículos personales.',
    ...
    'download_recovery_keys_confirmation' => 'Estás a punto de descargar tus claves de recuperación. Guárdelos en un lugar seguro ya que deberían ser obligatorios en caso de desastre.',
    ...
    'keys_not_recovered_explanation' => 'Para evitar la pérdida de contraseñas, debe almacenar de forma segura sus claves personales de Teampass.',
