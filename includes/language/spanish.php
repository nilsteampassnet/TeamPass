...
return array(
    ...
    'oauth2_need_user_old_password' => 'Para la primera conexión SSO, por favor proporcione su contraseña anterior',
    ...
    'oauth' => 'OAuth',
    'admin_oauth_configuration' => 'Configuración de OAuth',
    'settings_oauth_mode' => 'Habilitar el modo OAuth',
    'settings_oauth_mode_tip' => 'OAuth solo es posible con el proveedor de Microsoft Entra (Azure AD).',
    'app_name' => 'Nombre de la aplicación',
    'app_name_tip' => 'Esto se mostrará en el botón de inicio de sesión SSO.',
    'client_id' => 'ID de cliente',
    'client_secret' => 'Secreto de cliente',
    'callback_url' => 'URL de retorno',
    'callback_url_tip' => 'Copie la URL de retorno (URI de redirección) a continuación y configúrela en su proveedor de OAuth.',
    'scopes' => 'Ámbitos',
    'scopes_tip' => 'Ámbitos a solicitar del proveedor OAuth. Separe varios ámbitos con una coma.',
    ...
    'error_item_currently_being_updated' => 'El elemento está siendo actualizado y no se puede editar',
    ...
    'enable_refresh_task_last_execution' => 'Mostrar la fecha y hora de la última ejecución de la tarea',
    'generate_an_otp' => 'Generar un OTP',
    'qrcode_label' => 'Etiqueta del QRCode',
    'generate_qrcode' => 'Generar QRCode',
    ...
    'regenerate_only_personal_items_keys' => 'Solo regenerar mis claves de elementos personales (requiere sus claves públicas y privadas). Esto no afectará a los elementos compartidos.',
    ...
    'email_body_user_config_2' => 'Hola #lastname#,<br><br>Este es un correo electrónico generado por el gestor de contraseñas Teampass.<br><br>Utiliza tus credenciales de AD para autenticarte.<br><br>El siguiente código se espera la próxima vez que uses Teampass:<br><br><b>#code#</b><br><br><br>Saludos',
    ...
    'provide_label' => 'Proporcionar una etiqueta',
    'enable_backlog_mail' => 'Habilitar el envío de correos electrónicos de retraso',
    'ad_user_created_automatically' => 'Tu cuenta ha sido creada automáticamente por Teampass. Tus claves están en creación. Recibirás un correo electrónico cuando tu cuenta esté activada.',
    ...
    'folder_creation_rights_as_user_groups' => 'Mismos grupos a los que perteneces',
    ...
    'at_import' => 'Importar',
    'error_no_user_password_exists' => 'No se encontró contraseña de usuario. ¡Por favor, vuelve a conectarte!',
    'error_no_user_encryption_keys' => 'El usuario no tiene claves de cifrado. ¡Por favor, vuelve a conectarte!',
    ...
    'error_mcrypt_not_loaded' => 'La extensión PHP requerida mcrypt no está cargada. Informa a tu administrador si ves este mensaje.',
    'at_user_added' => 'Usuario #user_login# agregado',
    ...
    'at_user_email_changed' => 'Correo electrónico de usuario #user_login# cambiado',
    'at_user_pwd_changed' => 'Contraseña de usuario #user_login# cambiada',
    'at_user_initial_pwd_changed' => 'Cambio de contraseña inicial de usuario #user_login#',
    ...
    'index_pw_expiration' => 'Expiración actual de la contraseña en',
    ...
    'please_update' => '¡Por favor actualiza el software y la base de datos!',
    'pw' => 'Contraseña',
    'pw_generate' => 'Generar',
    ...
    'pw_hash_not_correct' => 'El hash de la contraseña no es correcto',
    ...
    'select_valid_2fa_credentials' => 'Por favor, asegúrate de seleccionar un método 2FA válido',
    'duo_config_error' => '= Error de configuración de Duo =<br /> Verifica tu configuración de Duo <br />',
    'duo_error_failopen' => 'No se pudo conectar a Duo, 2FA no puede realizarse pero la configuración está configurada para continuar.',
    'duo_error_secure' => 'Duo no está disponible actualmente. <br />El inicio de sesión no puede continuar, contacta a tu administrador si el problema persiste.',
    'duo_error_check_config' => '<br /><br />Administrador, por favor confirma que tu configuración de Duo es correcta.<br />',
    'duo_error_auth' => 'Error al intentar completar la autenticación de Duo. <br />',
    'duo_redirect_uri' => 'Redirigiendo al aviso de Duo',
    'duo_no_data' => 'Faltan datos o no se encontraron estados guardados de Duo, por favor inicia sesión de nuevo.',
    'duo_no_state_received' => 'No se recibió estado de Duo. Inténtalo de nuevo o contacta a tu administrador.',
    'duo_error_state' => 'Desajuste de estado de Duo. Por favor, inicia sesión de nuevo.',
    'duo_error_decoding' => 'Error al decodificar el resultado de Duo. Contacta a tu administrador si el problema persiste.',
    'duo-run-config-check' => 'Verificar configuración de Duo',
    'duo-config-check-success' => 'La configuración de Duo es correcta y el servidor de Teampass puede comunicarse con la API de Duo.',
    'duo_login_mismatch' => 'Error: el nombre de usuario de la solicitud original de Duo no coincide con el inicio de sesión enviado.',
    'duo_error_url' => 'Error al crear la URL del aviso universal de DUO',
    'duo_error_decrypt' => 'Error al completar la autenticación de Duo, por favor inicia sesión de nuevo.',
    'wrong_mfa_code' => 'Código MFA incorrecto',
    'teampass_ldap_user_missing' => 'Este usuario aún no ha sido importado en Teampass.',
    'edit' => 'Editar',
    ...
    'ssh_action_performed_with_error' => 'El servidor respondió con un error. Revisa la respuesta de error e inténtalo de nuevo.',
    'ssh_action_performed' => 'Contraseña actualizada para este elemento.<br /><br />Ahora puedes cerrar esta ventana.',
    ...
    'settings_disable_forgot_password_link_tip' => 'Ocultar el enlace "Olvidé mi contraseña" en la página de inicio porque no es gestionado por Teampass',
