...
$txt['admin_emails'] = "Correos Electrónicos";
$txt['admin_emails_configuration'] = "Configuración de correo electrónico";
...
$txt['admin_email_test_body'] = "Hola,<br><br>El correo electrónico ha sido enviado satisfactoriamente.<br><br>Atentamente.";
$txt['admin_email_test_configuration'] = "Probar configuración de Correo Electrónico";
...
$txt['admin_path_to_files_folder'] = "Ruta a la carpeta de Archivos";
$txt['admin_path_to_files_folder_tip'] = "<span style='font-size:11px;max-width:300px;'>La carpeta de Archivos se usa para almacenar todos los archivos generados por TeamPass y también algunos archivos subidos.<br />IMPORTANTE: por razones de seguridad, esta carpeta no tiene que estar en la carpeta WWW de su Website. Tiene que estar en una zona protegida con una regla de redirección en la configuración del Servidor.<br />IMPORTANTE 2:Puede ser bueno programar una tarea de CRON para limpiar periódicamente esta carpeta.</span>";
$txt['admin_path_to_upload_folder'] = "Ruta hacia carpeta Upload";
$txt['admin_path_to_upload_folder_tip'] = "<span style='font-size:11px;max-width:300px;'>La carpeta de Upload se usa para almacenar todos los archivos subidos asociados a los Elementos.<br />IMPORTANTE: por razones de seguridad, esta carpeta no tiene que estar en la carpeta WWW de su Website. Tiene que estar en una zona protegida con una regla de redirección en la configuración del Servidor.<br />IMPORTANTE 2: ¡Esta carpeta nunca tiene que ser eliminada! Esos archivos están asociados a Elementos.</span>";
...
$txt['admin_pwd_maximum_length_tip'] = "El valor por defecto de la longitud de clave está definida a 40. Es importante saber que estableciendo un valor elevado tiene un impacto en el rendimiento. Cuanto mayor es este valor, el servidor necesita más tiempo para encriptar y desencriptar, y también para mostrar las claves.";
...
$txt['admin_url_to_files_folder'] = "URL a la carpeta de Archivos";
$txt['admin_url_to_upload_folder'] = "URL hacia carpeta Upload";
...
$txt['at_automatically_deleted'] = "Automáticamente eliminado";
...
$txt['automatic_del_after_date_text'] = "o despues de fecha";
...
$txt['email_bodyalt_item_updated'] = "La clave de #item_label# ha sido actualizado.";
$txt['email_body_item_updated'] = "Hola,<br><br>La clave de '#item_label#' ha sido actualizada.<br><br>Puede consultarla <a href=\"\&quot;&quot;.@$_SESSION['settings']['cpassman_url'].&quot;/index.php?page=items&amp;group=#item_category#&amp;id=#item_id#\&quot;\">AQUI</a><br><br>Atentamente";
...
$txt['enable_personal_saltkey_cookie'] = "Permitir almacenar en una cookie el SALTKey personal";
...
$txt['pdf_password_warning'] = "¡Tiene que proporcionar una clave de encriptación!";
$txt['personal_folder'] = "Carpeta personal";
$txt['personal_saltkey_change_button'] = "Cambialo!";
$txt['personal_saltkey_cookie_duration'] = "Tiempo de vida en DIAS del SALTKey personal antes de que expire";
...
$txt['tags'] = "Etiquetas ";
$txt['Test the Email configuration'] = "Esta prueba tiene que enviar un correo electrónico a la dirección indicada. Si no lo recibe, revise sus credenciales.";
...
$txt['user_activity'] = "Actividad de Usuario";
