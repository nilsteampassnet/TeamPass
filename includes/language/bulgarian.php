...
$LANG = array (
    ...
    'email_ga_subject' => 'Вашият Google Authenticator еднократен код за Teampass',
    'email_ga_text' => 'Здравейте,<br><b',
    'settings_attachments_encryption' => 'Криптиране на прикачените файлове',
    'settings_attachments_encryption_tip' => 'ТАЗИ ОПЦИЯ МОЖЕ ДА ПОВРЕДИ СЪЩЕСТВУВАЩИТЕ ПРИКАЧЕНИ ФАЙЛОВЕ. МОЛЯ, ПРОЧЕТЕТЕ ВНИМАТЕЛНО СЛЕДВАЩИЯ ТЕК�',
    'admin_action_attachments_cryption' => 'Криптирай или декриптирай всички прикачените файлове',
    'admin_action_attachments_cryption_tip' => 'ВНИМАНИЕ: това действие да се предприема САМО след като промените съответните опции в настройките на TЕАMPASS. Препоръчително е да направите резервно копие на папката \'upload\' преди да започнете.',
    'encrypt' => 'Криптиране',
    'decrypt' => 'Декриптиране',
    'admin_ga_website_name' => 'Името за TEAMPASS показано в Google Authenticator',
    'admin_ga_website_name_tip' => 'Това име се използва за акаунта на идентификационния код в Google Authenticator.',
    'admin_action_pw_prefix_correct' => 'Поправи префикс за парола',
    'admin_action_pw_prefix_correct_tip' => 'Преди стартирането на този скрипт, моля запазете копие на базата данни. Този скрипт ще обнови префикса на паролите в базата. Използвайте този скрипт САМО за да поправите некоректно показващи се паро след ъпгрейт от по-стара версия.',
    'items_changed' => 'беше променен.',
    'ga_not_yet_synchronized' => 'Идентифицирай се с Google Authenticator',
    'ga_scan_url' => 'Моля, сканирайте този QR код с вашето Google Authenticator приложение. Използвайте кодовете от него за да се логвате.',
    ...
    'settings_get_tp_info' => 'Показване на новини и инфо за TEAMPASS на ГОШКО',
    'settings_get_tp_info_tip' => 'Когато е разрешена, тази опция показва информация като текуща версия, bug fixes и новини за нови версии на административната инфо страница.',
    'at_field' => 'Поле',
    'category_in_folders_title' => 'Показани в папки',
    'category_in_folders' => 'Избиране на папки които ще използват тази категория персонализирано поле',
    'select_folders_for_category' => 'Изберете папките които ще се асоциират с тази категория от полета',
    'offline_mode_warning' => 'OFFLINE режима позволява да свалите във HTML формат вашите записи, за да може да ги достъпвате когато не сте свързани със TEAMPASS сървъра. Паролите са кодирани с предоставен от вас ключ.',
    'offline_menu_title' => 'OFFLINE режим',
    'settings_offline_mode' => 'Активирай OFFLINE режим',
    'settings_offline_mode_tip' => 'OFFLINE режима създава отделна HTML страница която може да бъде свалена, като обектите в нея са криптирани със предоставена при създаването парола.',
    'offline_mode_key_level' => 'Минимално ниво на сигурност за OFFLINE режим',
    'categories' => 'Персонализирани полета',
    'new_category_label' => 'Име за нова категория',
    'no_category_defined' => 'Не беше създадена категория.',
    'confirm_deletion' => 'Избрали сте изтриване. Потвърждавате ли?',
    ...
    'move' => 'Преместване към',
    'field_add_in_category' => 'Добавяне на нов персонализиран етикет за поле',
    'rename' => 'Преименуване',
    'settings_item_extra_fields' => 'Персонализирани полета за обект са разрешени ',
    'settings_item_extra_fields_tip' => 'Разрешава допълнителен таб при създаване на обекти съдържащ персонализирани полета за допълнителни данни.',
    'html' => 'html',
    'more' => 'Още',
    ...
    'use_md5_password_as_salt' => 'Използване на паролата за логин като SALT ключ (по-лесно, по-несигурно)',
    'server_time' => 'Сървърно време',
    'settings_tree_counters' => 'Показване на още броячи в дървото на папките',
    'settings_tree_counters_tip' => 'Показва по 3 числа до всяка папка: брой на елементите в oсновната папка; брой на елементите включително в подпапките; брой на подпапките. ВАЖНО: Разрешаването на тази функция може да доведе до по-бавно зареждане.',
    'settings_encryptClientServer' => 'Комуникацията клиент-сървър е криптирана',
    'settings_encryptClientServer_tip' => 'Стандартно е разрешена енкрипция AES-256. Това е така дори ако не се използва HTTPS със SSL сертификат за да се подсигури връзкате между клиент и сървър. Ако използвате SSL протокол или Teampass във вътрешна мрежа, можете да деактивирате тази функция за да ускорите работата на  TEAMPASS.',
    'error_group_noparent' => 'Не е избрана перънт папка!',
    ...
    'admin_action_check_pf' => 'Създаване на персонални папки за всички освен един потребител',
    'admin_actions_title' => 'Задачи',
    'enable_personal_folder_feature_tip' => 'Персоналните папки са на отделна локация за всеки потребител. Обектите "парола" са криптирани с отделен SALT ключ за всеки потребител (което е по-сигурно) или с тяхната парола (за улеснение). Разрешаването на тази опция не създава самите папки за вече съществуващи потребители, допълнително трябва да изпълните и задачата "СЪЗДАВАНЕ НА ПАПКИ".',
    'is_administrated_by_role' => 'Потребителя е администриран от',
    'administrators_only' => 'Само за ГОШКО',
    'managers_of' => 'Мениджаъри на роля',
    'managed_by' => 'Мениджиран от',
    'admin_small' => 'ГОШКО',
    'setting_can_create_root_folder' => 'Съсдаване на папки от потребители в основната такава е разрешено',
    'settings_enable_sts' => 'HTTPS Strict Transport Security (HSTS) <strong>ВНИМАНИЕ</strong>: прочетете жокера!',
    'settings_enable_sts_tip' => 'ВНИМАНИЕ: Тази опция ще наложи HTTPS strict transport security (STS) политика. STS помага да се предотвратят man-in-the-middle атаки',
    'channel_encryption_no_gmp' => 'Разширението GMP не е заредено! Енкрипцията не може да бъде стартирана!',
    'channel_encryption_no_openssl' => 'Разширението OPENSSL не е заредено! Енкрипцията не може да бъде стартирана!',
    'channel_encryption_no_file' => 'Не беше намерен файл ключ! Моля, обновете скрипта.',
    'admin_action_generate_encrypt_keys' => 'Генерирай нови криптиращи ключове за сигурна връзка.',
    'admin_action_generate_encrypt_keys_tip' => 'Създаване на нов комплект ключове през определено време повишава сигурността',
    'settings_anyone_can_modify_bydefault' => 'Опцията \'<b><i>Всеки може да редактира</b></i>\' е активна по начало',
    'channel_encryption_in_progress' => 'Криптиране на канал ...',
    'channel_encryption_failed' => 'Аутентикацията неуспешна!',
    'purge_log' => 'Унищожи логове от',
    'to' => 'към',
    'purge_now' => 'Унищожи сега!',
    'purge_done' => 'Унищожаването приключи! Изтрити са :   елемента',
    'settings_upload_maxfilesize_tip' => 'Максимален обем позволен при качване на файл (в мегабайти, стандартно 10 МБ). Допълнително, може да се наложи да промените във вашето php.ini настройките upload_max_filesize и post_max_size, които стандартно са по 2 МБ.',
    'settings_upload_docext_tip' => 'Посочете разширенията за файловете за текстове и текстови процесори, които ще разрешите за качване като прикачени файлове. Избройте разрешените разширения на файлове, разделени със запетая (,)',
    'settings_upload_imagesext_tip' => 'Посочете разширенията за файловете с изображения, които ще разрешите за качване като прикачени файлове. Избройте разрешените разширения на файлове, разделени със запетая (,)',
    'settings_upload_pkgext_tip' => 'Посочете разширенията за файловете с архиви, които ще разрешите за качване като прикачени файлове. Избройте разрешените разширения на файлове, разделени със запетая (,)',
    'settings_upload_otherext_tip' => 'Посочете вички други разширенията на файловете, които ще разрешите за качване като прикачени файлове. Избройте разрешените разширения на файлове, разделени със запетая (,)',
    'settings_upload_imageresize_options_tip' => 'Преоразмеряване на качените големи снимки (задайте максимални размери в пиксели). Изображенията, които са по-широки от 1000 пиксела, може да не се показват добре в уеб браузъра.',
    'settings_upload_maxfilesize' => 'Максимален обем на файла',
    'settings_upload_docext' => 'Позволени разширения за документи',
    'settings_upload_imagesext' => 'Позволени разширения за изображения',
    'settings_upload_pkgext' => 'Позволени разширения за архиви',
    'settings_upload_otherext' => 'Други позволени разширения',
    'settings_upload_imageresize_options' => 'Преуразмеряване на изображения',
    'settings_upload_imageresize_options_w' => 'Максимална ширина на изображение',
    'settings_upload_imageresize_options_h' => 'Максимална височина на изображение',
    'settings_upload_imageresize_options_q' => 'Качество на преуразмерена картина',
    'admin_upload_title' => 'Качени файлове',
    'settings_importing' => 'Импортиране от KEEPASS или CVS файлове е разрешено',
    'admin_proxy_ip' => 'IP адрес на прокси сървър',
    'admin_proxy_ip_tip' => 'Ако се нуждаете от прокси сървър за да се свързвате с интернет, посочете IР адреса му тук. В противен случай, оставете празно.',
    'admin_proxy_port' => 'Порт на прокси сървър',
    'admin_proxy_port_tip' => 'Ако се нуждаете от прокси сървър за да се свързвате с интернет, посочете порта му тук. В противен случай, оставете празно.',
    'settings_ldap_elusers' => 'Само за локални потребители на ТЕАМPASS',
    ...
    'error_role_complex_not_set' => 'Не е заложена желана трудност на паролите.',
    'item_updated_text' => 'Този обект е бил променен. Трябва да го презаредите преди да можете да го промените.',
    ...
    'admin_email_auth_username' => 'Потребител за мейл сървър',
    'admin_email_auth_pwd' => 'Парола за мейл сървър',
    'admin_email_port' => 'порт на сървъра',
    'admin_email_from' => 'ОТ: Имейл адрес',
    'admin_email_from_name' => 'ОТ: Видимо име',
    'admin_email_test_configuration' => 'Изпратете си имейл за тест',
    'admin_email_test_configuration_tip' => 'Изпратете тест имейл до логнатия потребител. Първо трябва да се задали вашия имейл от иконката потебителски профил.',
    'admin_email_test_subject' => '[ТEAMPASS] Тест имейл',
    'admin_email_test_body' => 'Това е тест имейл изпратен с цел да се провери връзката с мейл сървъра. Ако четете това - ПОЗДРАВЛЕНИЯ!',
    'admin_email_result_ok' => 'Беше изпратен имейл до #email# ... моля, проверете кутията си.',
    ...
    'email_bodyalt_item_updated' => 'Паролата за #item_label# беше обновена.',
    ...
    'pdf_export' => 'Експорт към PDF',
    'pdf_password' => 'PDF ключ за енкрипция',
    'pdf_password_warning' => 'Трябва да предоставите ключ за енкрипция.',
    ...
    'migrate_pf_user_salt' => 'Въведете SALT ключа  за избрания потребител',
    'migrate_pf_no_sk' => 'Не сте въвели SALT ключ',
    'migrate_pf_no_sk_user' => 'Не сте въвели SALT ключ',
    ...
    'error_empty_data' => 'Няма нова информация.',
    ...
    'error_pw_too_long' => 'Паролата е по дълга от системния максимум (стандартно 40 символа).',
    'at_restriction' => 'Ограничение',
    'pw_encryption_error' => 'Грешка при криптиране на паролата.',
    ...
    'activity' => 'Активност',
    'add_button' => 'Добави',
    'add_new_group' => 'Добави нова папка',
    'add_role_tip' => 'Добави нова роля',
    'admin' => 'ГОШЕ',
    'admin_action' => 'Моля потвърдете вашето действие',
    'admin_action_db_backup' => 'Създай резервно копие на базата данни',
    'admin_action_db_backup_key_tip' => 'Моля, въведете парола за криптиране на резервното копие(или оставете празно за да не се криптира). Тази парола ще трябва при нужда от възстановяване.',
    ...
    'admin_misc_favicon' => 'Favicon (пълен URL)',
    'admin_misc_title' => 'Опции',
    'admin_one_shot_backup' => 'Ръчно архивиране и възстановяване на базата',
    ...
    'admin_script_backup_encryption' => 'Ключ за енкрипция (опционално)',
    ...
    'admin_script_backup_path' => 'Папка за архивно копие (пълен път)',
    ...
    'alert_message_personal_sk_missing' => 'Въведете вашия персонален SALT ключ.',
    'all' => 'всички',
    ...
    'at_category' => 'Папки',
    'at_copy' => 'Копирането приключи',
    'at_creation' => 'Създаване',
    'at_delete' => 'Изтриване',
    'at_del_file' => 'Файлът беше изтрит',
    ...
    'auteur' => 'Автор',
    'author' => 'Автор',
    'authorized_groups' => 'Разрешени папки',
    ...
    'bugs_page' => 'Ако откриете бъг или нередност, моля, информирайте ни. ',
    'by' => 'от',
    'cancel' => 'Отказ',
    ...
    'change_forbidden_groups' => 'Промени забранени папки',
    'change_function' => 'Промени роли',
    'change_group_autgroups_info' => 'Изберете папки разрешени за тави роля',
    ...
    'change_user_forgroups_title' => 'Персонализиране на забранени папки',
    'change_user_functions_info' => 'Нагласете правата на този акаунт',
    ...
    'admin_agses_hosted_apikey' => 'API ключ',
    ...
    'user_folders_rights' => 'Видими папки',
    ...
    'newly_created_user_role' => 'Но',
    'at_user_updated' => 'Потребител #user_login# беше обновен',
    'human_resources' => 'Супер мениджър',
    'login_attempts' => 'Опита за влизане от последната успешна конекция',
    ...
    'provide_yubico_identifiers' => 'Моля, предоставете вашия Yubico идентификатор',
    'admin_yubico_authentication_setting' => 'Разреши Yubico аутентикация',
    'yubico_user_id' => 'ID на клиент',
    'yubico_user_key' => 'Секретен ключ',
    'yubico_bad_code' => 'Грешна Yubico информация',
    'show_yubico_info_form' => 'Покажи  Yubico нещо си информация потребител',
    'press_your_yubico_key' => 'Натиснете вашия Yubico ключ',
    'position_in_list' => 'Позиция в списъка',
    'visible_by' => 'Видимо от',
    'restrict_visibility_to' => 'Ограничи видимост до',
    'every_roles' => 'Всички роли',
    'masked_text' => 'Маскиран текст',
