...
$LANG = array (
    ...
    'email_ga_text' => 'Будь-ласка, <a href=\'#link#\'>перейдіть за цим посиланням</a> і зіскануйте QR код за допомогою застосунка Google Authenticator. Це потрибно для налаштування вашого флеш-коду',
    ...
    'admin_ga_website_name' => 'Ім\'я, котре відображається в Гугл Аутентифікаторі для Teampass',
