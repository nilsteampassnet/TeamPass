...
$LANG = array(
    ...
    'admin_ga_website_name_tip' => 'Це ім\'я використовується для ідентифікаційного коду акаунту в Гугл Аутентифікаторі',
    'admin_action_pw_prefix_correct' => 'Відновити префікс паролю',
    ...
    'items_changed' => 'було змінено.',
    'ga_not_yet_synchronized' => 'Ідентифікуватися за допомогою Гугл Аутентифікатора',
    ...
    'at_field' => 'Поле',
    'category_in_folders_title' => 'Показувати в теках',
    'category_in_folders' => 'Оберіть теки, які будуть використовувати цю категорію користувацького поля',
    'select_folders_for_category' => 'Вибрати папки для асоціації з цією категорію полей',
    ...
    'offline_menu_title' => 'Режим офлайн',
    ...
    'confirm_rename' => 'Підтверджуєте перейменування?',
    'new_field_title' => 'Введіть назву нового поля',
    'confirm_creation' => 'Підтверджуєте створення?',
    'confirm_moveto' => 'Підтверджуєте переміщення поля?',
    'for_selected_items' => 'Редагувати категорію або позначку (вибрати об\'єкт вище)',
    'move' => 'Перемістити до',
    'field_add_in_category' => 'Додати нову назву користувацького поля',
    ...
    'html' => 'html',
    'more' => 'Більше',
    'save_categories_position' => 'Зберегти порядок сортування категорії',
    'reload_table' => 'Перезавантажити таблицю',
    'settings_ldap_type' => 'Тип ldap серверу',
    'use_md5_password_as_salt' => 'Використовувати пароль від аккаунту, як персональну сіль (простіше але менш захищено)',
    'server_time' => 'Час на сервері',
    'settings_tree_counters' => 'Показувати більше лічильників у дереві тек',
    ...
    'settings_encryptClientServer' => 'Кліент-серверний обмін зашифровано',
    ...
    'error_group_noparent' => 'Жодного батьківського об\'єкта не було вибрано!',
    'channel_encryption_no_iconv' => 'Розширення ICONV не завантажено! Шифрування не може бути використано!',
    ...
    'is_administrated_by_role' => 'Користувач адмініструється ',
    ...
    'channel_encryption_no_gmp' => 'Розширення GMP не завантажено! Шифрування не може бути використано!',
    'channel_encryption_no_openssl' => 'Розширення OPENSSL не завантажено! Шифрування не може бути використано!',
    ...
    'channel_encryption_in_progress' => 'Шифрування каналу...',
    'channel_encryption_failed' => 'Аутентифікація невдала!',
    ...
    'settings_upload_imageresize_options_q' => 'Якість jpeg',
    'admin_upload_title' => 'Завантаження',
    ...
    'error_role_complex_not_set' => 'Необхідно встановити складність паролю відповідно до вимог!',
    'item_updated_text' => 'This item has been edited. You need to update before you can change it.',
    'database_menu' => 'База данних',
    'db_items_edited' => 'Item currently being edited',
    'item_edition_start_hour' => 'Почато редагування',
    ...
    'admin_emails' => 'Електронна адреса',
    ...
    'enable_notify' => 'Активувати сповіщення',
    'disable_notify' => 'Деактивувати сповіщення',
    ...
    'migrate_pf_select_to' => 'Мігрувати персональні об\'єкти до користувача',
    ...
    'migrate_pf_no_user_id' => 'Необхідно вибрати користувача',
    ...
    'admin_action_purge_old_files_result' => 'файли було вилучено.',
    ...
    'admin_agses_hosted_url' => 'Посилання',
    ...
    'save_statistics_choice' => 'Зберегти ваші налаштування',
