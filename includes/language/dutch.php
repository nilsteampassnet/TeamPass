...
$LANG = array (
    ...
    'admin_action_pw_prefix_correct_tip' => 'Gaarne een backup van de database te maken voordat u deze taak uitvoert.  Deze taak zal de wachtwoord voorvoegsels in de database bijwerken. Deze taak alleen uitvoeren om foutief getoonde wachtwoorden te herstellen na het upgraden van een oudere versie.',
    ...
    'settings_get_tp_info_tip' => 'Wanneer aangevinkt zal informatie zoals huidige software versie, bug fixes en release nieuws worden getoond op de beheer info pagina van remote servers.',
    'at_field' => 'Veld',
    ...
    'settings_delay_for_item_edition' => 'Timeout in minuten op exclusieve bewerking van een item.',
    ...
    'user_profile_api_key' => 'Jouw API sleutel',
    'report_a_bug' => 'Meld een bug',
    'enable_http_request_login' => 'Automatisch inloggen met http header credentials',
    'duration_login_attempt' => 'Seconden tot auto login:',
    'newly_created_user_role' => 'Nieuwe gebruiker heeft rol',
    'at_user_updated' => 'Gebruiker #user_login# is bijgewerkt',
    'human_resources' => 'Super beheerder',
    'login_attempts' => 'Inlogpogingen sinds laatste succesvolle verbinding',
    'settings_secure_display_image' => 'Beveiligde afbeeldingen inschakelen',
    'settings_secure_display_image_tip' => 'Veilige afbeeldingsweergave maakt het mogelijk om de afbeelding te lezen via PHP wanneer een gebruiker een afbeelding bekijkt die aan een item is gekoppeld. Pro: de bijlage wordt buiten de sitemap opgeslagen en is niet toegankelijk voor een hacker. Con: het is iets langzamer dan direct vanuit een URL bekijken.',
    'provide_yubico_identifiers' => 'Geef aub je Yubico identifiers',
    'admin_yubico_authentication_setting' => 'Yubico authenticatie inschakelen',
    'yubico_user_id' => 'Client ID',
    'yubico_user_key' => 'Secret KEY',
    'yubico_bad_code' => 'Verkeerde Yubico informatie',
    'show_yubico_info_form' => 'Toon Yubico gebruiker formulier',
    'press_your_yubico_key' => 'Druk op je Yubico key',
    'position_in_list' => 'Positie in lijst',
    'visible_by' => 'Zichtbaar door',
    'restrict_visibility_to' => 'Beperk zichtbaarheid tot',
    'every_roles' => 'Alle rollen',
    'masked_text' => 'Gemaskeerde tekst',
    'textarea' => 'Textarea',
    'error_field_is_mandatory' => 'Tenminste één verplicht veld is leeg',
    'is_mandatory' => 'is verplicht',
    'main_template' => 'Gebruik als template',
    'create_item_based_upon_template_tip' => 'Wanneer ingeschakeld zal deze feature de schrijver de mogelijkheid geven om een template te kiezen gemaakt van Eigen Velden. Opmerking: Om deze feature te kunnen gebruiken dienen "Eigen Velden" ingeschakeld te zijn.',
    'create_item_based_upon_template' => 'Gebruik template voor item',
    'log_in' => 'Log in',
    'filter' => 'Filter',
    'upload_empty_file' => 'Upload leeg bestand',
    'upload_any_extension_file' => 'Upload bestanden ongeacht bestandsextentie',
    'upload_any_extension_file_tip' => 'Wanneer geactiveerd zal deze optie gebruikers toestaan bestanden van elk type te uploaden.',
