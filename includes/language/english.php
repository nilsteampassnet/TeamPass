...
$LANG = array (
    ...
    'role' => 'Role',
    'admin_2factors_authentication_setting' => 'Select 2-Factor authentication',
    'admin_2factors_authentication_setting_tip' => '<span style=\'font-size:11px;max-width:300px;\'><b>Google 2-Factor autentication</b> permits to add one more security level for user autentication. When user wants to login TeamPass, a QR code is generated. This QR code needs to be scanned by the user to get a one-time password.<br />WARNING: this extra needs an Internet connection and a scanner such as a smartphone.<br><b>Radius 2-Factor Authentication</b> requires you to specify a radius server list(comma delimited) and a secret to talk to the Radius Servers</span>',
    '2factors_tile' => '2-Factor Autentication',
    ...
    'bad_onetime_token' => 'Wrong One-Time Token or Bad Username/Password!',
    'radius_identification_code' => 'One-Time Token',
    'admin_radius_servers' => 'Radius Servers',
    'admin_radius_servers_tip' => 'IP or hostname of the Radius Server. Multiple Radius servers can be listed here, separated with a comma (eg: 10.0.0.10,10.0.0.11)',
    'admin_radius_secret' => 'Radius Server Secret',
    'admin_radius_secret_tip' => 'Radius Secret',
