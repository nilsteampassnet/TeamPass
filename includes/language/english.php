...
$txt['rename'] = "Rename";
$txt['settings_item_extra_fields'] = "More fields to be displayed (Categories activation)";
...
$txt['admin_action_check_pf'] = "Create Personal Folders for all users (where not already existing)";
...
$txt['setting_can_create_root_folder'] = "Allow new folder to be created at Root level";
...
$txt['settings_upload_docext_tip'] = "Document types. Indicate the allowed file extensions separated with a comma (,)";
$txt['settings_upload_imagesext_tip'] = "Image types. Indicate the allowed file extensions separated with a comma (,)";
$txt['settings_upload_pkgext_tip'] = "Package types. Indicate the allowed file extensions separated with a comma (,)";
$txt['settings_upload_otherext_tip'] = "Other types. Indicate the allowed file extensions separated with a comma (,)";
...
$txt['admin_2factors_authentication_setting'] = "Enable Google 2-factor authentication";
$txt['admin_2factors_authentication_setting_tip'] = "<span style='font-size:11px;max-width:300px;'>Google 2-factor autentication permits to add one more security level for user autentication. When user wants to login TeamPass, a QR code is generated. This QR code needs to be scanned by the user to get a one-time password.<br />WARNING: this extra needs an Internet connection and a scanner such as a smartphone.</span>";
$txt['2factors_tile'] = "2-Factor Authentication";
...
$txt['settings_insert_manual_entry_item_history'] = "Permit manual insertions in Items History log";
...
$txt['enable_send_email_on_user_login'] = "Send an email to Admins when a User logs in";
...
$txt['block_last_created'] = "Last items created:";
...
$txt['copy'] = "Copy";
$txt['copy_to_clipboard_small_icons'] = "Enable small 'copy to clipboard' icons in items page";
...
$txt['error_must_enter_all_fields'] = "You must fill in all fields.";
...
$txt['index_bas_pw'] = "Incorrect password for this account.";
...
$txt['index_last_pw_change'] = "Password last changed on";
$txt['index_last_seen'] = "Last login was on";
$txt['index_login'] = "User name";
$txt['index_maintenance_mode'] = "Maintenance mode has been activated. Only Administrators can log in.";
$txt['index_maintenance_mode_admin'] = "Maintenance mode is activated. Users currently cannot access TeamPass.";
$txt['index_new_pw'] = "New password";
$txt['index_password'] = "Password";
$txt['index_pw_error_identical'] = "The passwords must be identical.";
...
$txt['settings_default_language'] = "Default Language";
...
$txt['settings_maintenance_mode'] = "Put TeamPass in Maintenance mode";
...
$txt['settings_send_stats'] = "Send monthly statistics to the author to give a better understanding of TeamPass usage";
...
$txt['warning_screen_height'] = "WARNING: Your screen is not high enough to display the display items list.";
$txt['yes'] = "Yes";
