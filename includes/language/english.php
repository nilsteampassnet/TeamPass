...
return array(
    ...
    'bck_restore_navigation_locked' => 'A database restore is running. Navigation is temporarily locked during the operation. Please keep this window open.',
    'bck_restore_checking_key' => 'Checking decryption key...',
    'bck_restore_use_other_key' => 'Use a different decryption key (migration)',
    ...
    'bck_restore_other_key_help' => 'Use this only if the backup was encrypted on another TeamPass instance (migration).',
    ...
    'bck_instance_key_copy_failed' => 'Unable to copy instance key.',
    ...
    'bck_scheduled_backups_list' => 'Scheduled backups',
    'bck_scheduled_delete' => 'Delete',
    "bck_onthefly_server_backups" => "Backups available on server",
    "bck_onthefly_refresh_list" => "Refresh",
    "bck_onthefly_col_date" => "Date",
    "bck_onthefly_col_size" => "Size",
    "bck_onthefly_col_action" => "Action",
    "bck_onthefly_loading" => "Loading…",
    "bck_onthefly_no_backups_found" => "No backup file found in the files directory.",
    "bck_onthefly_use_for_restore" => "Use for restore",
    "bck_onthefly_selected_backup" => "Selected backup",
    "bck_onthefly_select_backup_first" => "Please select a backup file first.",
    "bck_onthefly_server_backups_help" => "These backups are read from the server files directory. Select one to restore it (you must provide the correct encryption key).",
    "bck_onthefly_confirm_delete" => "Do you really want to delete this backup file?",
