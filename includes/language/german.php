...
return array(
    ...
    'email_body_new_user' => 'Hallo,<br><br>dies ist eine generierte E-Mail von Teampass passwords manager.Ein Administrator hat für Sie ein Benutzerkonto auf Teampass erstellt. Wenn Sie sich das nächste Mal mit Teampass verbinden, verwenden Sie bitte die folgenden Anmeldedaten: <br><br>login: #login#<br><br>Kennwort: #password#<br><br>Verschlüsselungscode: #code#<br><br>',
    ...
    'ready_to_go' => 'Fertig zum Benutzen',
    ...
    'temporary_encryption_code' => 'Dein temporäre Encryptioncode',
    ...
    'provide_current_psk_and_click_launch' => 'Wenn fertig, dann klicke auf Launch',
    'start' => 'Start',
    'data_inconsistency' => 'Dateninkonsistenz festgestellt. Bitte die Seite neu laden!',
    ...
    'change_authentification_type_to_local' => 'Ändert den Authentifizierungstyp zu der Teampass lokalen Datenbank',
    ...
    'user_must_have_login_and_email' => 'Benutzer muss Login und E-Mail haben',
    ...
    'clipboard_password_life_duration_tip' => 'Ermöglicht die Definierung einer Verzögerung in Sekunden, bevor das in der Zwischenablage kopierte Kennwort aus der Zwischenablage des Browsers gelöscht wird. Zum Deaktivieren auf 0 setzen.',
    ...
    'server' => 'Server',
    'data_refreshed' => 'Daten erneuert',
    'loading_image' => 'Lade Bild',
    'compare_with_another_role' => 'Vergleich mit anderen Rollen',
    'only_display_folders_to_depth' => 'Zeigt Ordner an bis zur Tiefe',
    'propagate_rights_to_descendants' => 'Vererbung von Rechten zu anderen Benutzer',
    'loading_data' => 'Lade Daten',
    'password_overview_delay' => 'Verzögerung für PasswortübersichtDelay for password overview',
    ...
    'select_date_showing_items_expiration' => 'Auflistung der abgelaufnen Eintrage am',
    'renewal_page_info' => 'Auf dieser Seite können Sie die aktuell abgelaufenen oder in der nächsten Periode ablaufenden Einträge identifizieren.',
    'filename' => 'Dateiname',
    'exported_to_file' => 'In Datei exportieren',
    'operation_progress' => 'Vorgang wird bearbeitet',
    'exporting_items' => 'Exportiere Einträge',
    'select_folders_to_export' => 'Ordner für den Export auswählen',
    'export_format_type' => 'Wähle den Exportiertyp',
    'export_items' => 'Exportiere Einträge',
    'loading_item' => 'Lade Eintrag',
    ...
    'no_sharekey_found' => 'Kein Schlüssel wurde gefunden für die Datei oder Nutzer',
    ...
    'enabled' => 'Aktivieren',
    'confirmation_seems_wrong' => 'Bestätigung scheint falsch, bitte korrigieren',
    'i_cannot_remember' => 'Kann mich nicht errinnern.',
    'i_cannot_remember_info' => 'Diese Aktion ist nicht rückgängig zu machen. Sie löscht die in Ihren persönlichen Gegenständen gespeicherten Passwörter. Die Einträge werden nicht gelöscht, sondern nur ihre Passwörter. Wenn Sie sich nicht an Ihren persönlichen Saltkey erinnern können, ist dies die einzige Möglichkeit.',
    'user_has_psk_info' => 'Wir haben festgestellt, dass Sie einige persönliche Gegenstände mit einem alten persönlichen Saltkey verschlüsselt haben. Dieser Schritt zielt darauf ab, sie mit Ihrem neuen privaten Schlüssel neu zu verschlüsseln. Bitte teilen Sie uns Ihren persönlichen Saltkey mit.',
    'files' => 'Dateien',
    ...
    'change_login_password' => 'Ändere Loginpasswort',
