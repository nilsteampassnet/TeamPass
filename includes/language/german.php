...
$LANG = array (
    ...
    'admin_action_pw_prefix_correct_tip' => 'Bitte legen Sie vor der Ausführung dieses Skripts unbedingt eine Komplettsicherung Ihrer Datenbank an. Das Skript aktualisiert den Passwort-Prefix und sollte Ausschließlich eingesetzt werden, wenn Passwörter nach einem Upgrade von einer älteren Version falsch angezeigt werden.',
    'items_changed' => 'Änderung durchgeführt.',
    'ga_not_yet_synchronized' => 'Mit Google Authenticator identifizieren',
    'ga_scan_url' => 'Bitte scannen Sie diesen QR-Code mit Ihrer Google Authenticator App und kopieren hiervon den Identifizierungscode um sich einzuloggen.',
    ...
    'at_field' => 'Feld',
    'category_in_folders_title' => 'Zugeordnete Ordner',
    'category_in_folders' => 'Wählen Sie die Ordner aus in welcher das benutzerdefinierte Feld angezeigt werden soll.',
    'select_folders_for_category' => 'Ordner zum Zuordnen zu dieser Feldkategorie auswählen',
    ...
    'html' => 'HTML',
    'more' => 'Mehr',
    'save_categories_position' => 'Kategorie Reihenfolge speichern',
    'reload_table' => 'Tabelle neu laden',
    'settings_ldap_type' => 'Art des LDAP-Server',
    'use_md5_password_as_salt' => 'Benutze das Login-Passwort als SALTkey (einfacher, aber unsicherer)',
    ...
    'admin_emails_configuration' => 'Mailserver Einstellungen',
    ...
    'admin_email_send_backlog' => '#nb_emails# unversandte Mails - jetzt versenden',
    ...
    'admin_url_to_files_folder' => 'URL zum Ordner "files"',
    ...
    'enable_delete_after_consultation' => 'Passwörter können nach X-mal angesehen werden verfallen.',
    'times' => 'mal',
    'automatic_deletion_activated' => 'Automatisches Löschen aktiviert',
    'at_automatic_del' => 'automatisches Löschen',
    'error_times_before_deletion' => 'Anzahl der Ansehvorgänge muss größer als 0 sein!',
    ...
    'migrate_pf_user_salt' => 'Geben Sie den SALT-Schlüssel für den gewählten Benutzer ein',
    ...
    'personal_saltkey_lost' => 'Meinen persönlichen Salt-Key zurücksetzen',
    'new_saltkey_warning_lost' => 'Sie haben Ihren SALTKEY verloren? Er kann nicht wiederhergestellt werden. Bitte bedenken Sie Folgendes, bevor Sie fortfahren: beim Zurücksetzen Ihres SALTKEYs werden alle Ihre bestehenden persönlichen Elemente gelöscht! Wenn Sie Ihren alten Salt Key kennen, verwenden Sie stattdessen die Funktion"Change Key".',
    ...
    'home_personal_saltkey_button' => 'Salt-Schlüssel ändern',
    ...
    'login' => 'Benutzername',
    'login_attempts_on' => 'Anmeldeversuch Nr.',
    ...
    'masked' => 'Versteckt',
    'type' => 'Typ',
    'select_type_of_field' => 'Feldtyp auswählen',
    'define_new_field' => 'Neues Feldtyp definieren',
    'data_is_text' => 'Daten sind Text',
    'data_is_masked' => 'Daten sind versteckt',
    'at_export' => 'Export',
    'setting_disabled_by_admin' => 'Diese Einstellung ist vom Administrator deaktiviert',
    'confirm_change_field_type' => 'Änderung des Feldtyps bestätigen',
    'admin_script_backup_secret' => 'Schlüssel zur Ausführung von Backup',
    'admin_script_backup_secret_tip' => 'Der Schlüssel ist zum Backupstart erforderlich und muss als Parameter zum Script script.backup.php hinzugefügt werde',
    'access_level_for_roles' => 'Zugehörige Zugriffsrechte für Rollen',
    ...
    'error_psk_should_be_changed' => 'Aufgrund von Richtlinienänderungen müssen Sie Ihren persönlichen Saltkey ändern.',
    ...
    'request_access_to_item' => 'Zugriff auf dieses Passwort anfordern',
    'request_access_to_item_info' => 'Gib den Grund an, warum Du auf dieses Passwort zugreifen möchtest',
    'send_request' => 'Anfrage senden',
    'error_no_reason_of_access' => 'Bitte gebe einen Grund für den Zugriff auf diesen Entrag an.',
    'settings_ldap_and_local_authentication' => 'Lokaler und LDAP Benutzer',
    'settings_ldap_and_local_authentication_tip' => 'Aktiviere diese Option, damit LDAP und lokale Benutzer Zugriff erhalten.',
    'user_profile_api_key' => 'Dein API Schlüssel',
    'report_a_bug' => 'Einen Fehler melden',
    'enable_http_request_login' => 'Automatische Anmeldung mit HTTP-Header-Anmeldeinformationen',
    'duration_login_attempt' => 'Sekunden bis zur automatischen Anmeldung:',
    'newly_created_user_role' => 'Neu angelegte Benutzer erhalten Rolle',
    'at_user_updated' => 'Benutzer #user_login# wurde aktualisiert',
    'human_resources' => 'Supermanager',
    'login_attempts' => 'Loginversuche seit der letzten erfolgreichen Verbindung',
    'settings_secure_display_image' => 'Sichere Bildanzeige aktivieren',
    'settings_secure_display_image_tip' => 'Sichere Bildanzeige erlaubt es, die Vorschau-Bilder eines Eintrages mittels PHP anzuzeigen. Vorteil: Die Anhänge werden außerhalb des Website-Verzeichnisses gespeichert und Hacker haben keinen Zugriff. Nachteil: Es ist etwas langsamer, als die Bilder direkt per URL anzuzeigen.',
    'provide_yubico_identifiers' => 'Bitte gib Deine Yubico-IDs an',
    'admin_yubico_authentication_setting' => 'Aktiviere die Yubico Authentifizierung',
    'yubico_user_id' => 'Client ID',
    'yubico_user_key' => 'Geheimer Schlüssel',
    'yubico_bad_code' => 'Wrong Yubico information',
    'show_yubico_info_form' => 'Zeige das Yubico Benutzerinformationsformular',
    'press_your_yubico_key' => 'Press your Yubico key',
    'position_in_list' => 'Position in der Liste',
    'visible_by' => 'Sichtbar für',
    'restrict_visibility_to' => 'Sichtbar für',
    'every_roles' => 'Alle Rollen',
    'masked_text' => 'Markierter Text',
    'textarea' => 'Textfeld',
