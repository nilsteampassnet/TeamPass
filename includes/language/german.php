...
$txt['admin_email_test_configuration_tip'] = "Dieser Test sollte eine E-Mail an die angezeigte Adresse versenden. Wenn Sie keine erhalten haben überprüfen Sie bitte Ihre Zugangsdaten.";
...
$txt['add_history_entry'] = "Eintrag ins Logbuch hinzufügen";
...
$txt['admin_action_pw_prefix_correct'] = "Korregiert das Passwort-Präfix";
$txt['admin_action_pw_prefix_correct_tip'] = "Bevor Sie dieses Skript ausführen stellen Sie BIITE sicher, dass Sie ein Backup von Ihrer Datenbank gemacht haben. Diese Skript führt eine Aktualisierung der Passwort-Präfixe durch. Es sollte nur benutzt werden, wenn Ihre Passwörter mit seltsamen Präfixen angezeigt werden.";
...
$txt['admin_emails_configuration'] = "Einstellungen von E-Mail";
$txt['admin_emails_configuration_testing'] = "Einstellungen testen";
$txt['admin_email_auth'] = "Server SMTP verlangt Authentifizierung";
$txt['admin_email_auth_pwd'] = "Passwort zur Authentifizierung";
$txt['admin_email_auth_username'] = "Benutzername zur Authentifizierung";
$txt['admin_email_from'] = "E-Mail-Adresse des Absenders (von E-Mail)";
$txt['admin_email_from_name'] = "Name des Absenders (von Name)";
$txt['admin_email_port'] = "Server-Port";
$txt['admin_email_result_nok'] = "E-Mail wurde nicht versandt... Überprüfen Sie Ihre Einstellungen - siehe entsprechende Fehlermeldung.";
$txt['admin_email_result_ok'] = "E-Mail wurde versandt... Schauen Sie in Ihrer Mailbox nach.";
$txt['admin_email_send_backlog'] = "E-Mail-Protokoll versenden (insgesamt #nb_emails# E-Mails)";
$txt['admin_email_send_backlog_tip'] = "Dieses Script erzwingt das Versenden der E-Mails aus der Datenbank.<br>Dies kann - je nach Anzahl der E-Mails - einige Zeit in Anspruch nehmen.";
$txt['admin_email_smtp_server'] = "Server SMTP";
$txt['admin_email_test_body'] = "Hallo,<br><br>die E-Mail wurde erfolgreich versandt.<br><br>Gruß.";
$txt['admin_email_test_configuration'] = "E-Mail-Einstellungen testen";
$txt['admin_email_test_subject'] = " [TeamPass] Test-E-Mail";
...
$txt['admin_path_to_files_folder'] = "Pfad zum Verzeichnis Files";
$txt['admin_path_to_files_folder_tip'] = "<span style='font-size:11px;max-width:300px;'>Der Folder Files wird zum Speichern aller von TeamPass erzeugten sowie einiger upgeloadeter Dateien genutzt.<br>WICHTIG: Dieser Folder sollte aus Sicherheitsgründen nicht im WWW-Rootverzeichnis Ihrer Website liegen. Er sollte in einem geschützten Bereich platziert und mit entsprechender Umleitungsregel in der Serverkonfiguration versehen sein.<br>WICHTIG 2: Es ist sinnvoll einen CRONJOB zur periodischen Bereinigung dieses Folders aufzusetzen.</span>";
$txt['admin_path_to_upload_folder'] = "Pfad zum Upload-Verzeichnis";
$txt['admin_path_to_upload_folder_tip'] = "<span style='font-size:11px;max-width:300px;'>Der Folder Upload wird zum Speichern aller upgeloadeten und Elementen zugeordneten Dateien genutzt.<br>WICHTIG: Dieser Folder sollte aus Sicherheitsgründen nicht im WWW-Rootverzeichnis Ihrer Website liegen. Er sollte in einem geschützten Bereich platziert und mit entsprechender Umleitungsregel in der Serverkonfiguration versehen sein.<br>WICHTIG 2: Dieser Folder sollte nie bereinigt werden! Dessen Dateien sind Elementen zugeordnet.</span>";
$txt['admin_proxy_ip'] = "IP-Adresse vom Proxy-Server";
$txt['admin_proxy_ip_tip'] = "<span style='font-size:11px;max-width:300px;'>Falls Ihre Internet-Verbindung druch einen Proxy-Server geleitet wird, geben Sie hier die IP-Nr. des Proxy-Servers ein.<br />Lassen Sie leer, falls kein Proxy benutzt wird.</span>";
$txt['admin_proxy_port'] = "Port-Nr. vom Proxy-Server";
$txt['admin_proxy_port_tip'] = "<span style='font-size:11px;max-width:300px;'>Falls die IP-Nr. eines Proxy-Servers eingegeben wurde, geben Sie hier die Port-Nr. dieses Proxy-Servers ein (oft 8080). <br />Lassen Sie leer, falls kein Proxy benutzt wird.</span>";
$txt['admin_pwd_maximum_length'] = "Maximale Länge der Passwörter";
$txt['admin_pwd_maximum_length_tip'] = "Die Standardlänge der Passwörter beträgt 40 Zeichen. Bitte bedenken Sie, dass das Einstellen einer größeren Länge sich auf die Systemleistung auswirkt. Je länger das Passwort, desto länger braucht der Server zum Ver-/Entschlüsseln und Darstellen der Passwörter.  ";
...
$txt['admin_small'] = "Administrator";
$txt['admin_upload_title'] = "Uploads";
$txt['admin_url_to_files_folder'] = "URL zum Folder Files";
...
$txt['at_manual'] = "Manueller Vorgang";
$txt['at_manual_add'] = "Manuell hinzugefügt";
...
$txt['at_url'] = "URL";
$txt['at_user_added'] = "Benutzer #user_login# hinzugefügt";
$txt['at_user_deleted'] = "Benutzer #user_login# gelöscht";
$txt['at_user_email_changed'] = "E-Mail-Adresse des Benutzers #user_login# geändert";
$txt['at_user_initial_pwd_changed'] = "Initialpasswort des Benutzers #user_login# geändert";
$txt['at_user_locked'] = "Benutzer #user_login# gesperrt";
$txt['at_user_new_lastname'] = "Nachname von #user_login# geändert";
$txt['at_user_new_name'] = "Vorname von #user_login# geändert";
$txt['at_user_pwd_changed'] = "Passwort des Benutzers #user_login# geändert";
$txt['at_user_unlocked'] = "Benutzer #user_login# entsperrt";
$txt['auteur'] = "Autor";
$txt['author'] = "Autor";
...
$txt['bad_email_format'] = "Die E-Mail-Adresse hat nicht das erforderliche Format!";
$txt['bad_onetime_password'] = "Ungültiges Einmalpasswort!";
...
$txt['categories'] = "Kategorien";
$txt['category_in_folders'] = "Ordner dieser Kategorie bearbeiten";
$txt['category_in_folders_title'] = "verknüpfte Ordner";
...
$txt['channel_encryption_failed'] = "Authentifizierung gescheitert!";
$txt['channel_encryption_in_progress'] = "Kanal wird verschlüsselt...";
$txt['channel_encryption_no_bcmath'] = "Die Erweiterung BCMATH ist nicht geladen! Die Verschlüsselung kann nicht starten!";
$txt['channel_encryption_no_file'] = "Es wurden keine Chiffrier-Schlüssel gefunden!<br>Bitte führen Sie einen Upgrade durch.";
$txt['channel_encryption_no_file'] = "Es wurden keine Chiffrier-Schlüssel gefunden!<br>Bitte führen Sie einen Upgrade durch.";
$txt['channel_encryption_no_gmp'] = "Erweiterung GMP ist nicht geladen! Die Verschlüsselung kann nicht eingeleitet werden!";
$txt['channel_encryption_no_iconv'] = "Die Erweiterung ICONV ist nicht geladen! Die Verschlüsselung kann nicht starten!";
$txt['channel_encryption_no_openssl'] = "Erweiterung OpenSSL ist nicht geladen! Die Verschlüsselung kann nicht eingeleitet werden!";
...
$txt['confirm_moveto'] = "Verschieben bestätigen?";
$txt['confirm_rename'] = "Umbenennen bestätigen";
...
$txt['database_menu'] = "Datenbank";
$txt['date'] = "Datum";
$txt['date'] = "Datum";
$txt['date_format'] = "Datumsformat";
$txt['days'] = "Tage(n)";
$txt['db_items_edited'] = "Momentan bearbeitete Elemente";
$txt['db_users_logged'] = "Momentan protokollierte Benutzer";
...
$txt['disconnect_all_users'] = "Alle Benutzer (außer Administratoren) abmelden";
$txt['disconnect_all_users_sure'] = "Sie beabsichtigen alle Benutzer abzumelden. Sind Sie sicher?";
...
$txt['email_announce'] = "Dieses Element per E-Mail bekannt geben";
...
$txt['email_change'] = "Die E-Mail-Adresse des Benutzerkontos ändern";
$txt['email_changed'] = "E-Mail-Adresse wurde geändert!";
...
$txt['email_subject_item_updated'] = "Das Passwort wurde geändert.";
...
$txt['enable_email_notification_on_item_shown'] = "Benachrichtigung per E-Mail versenden, wenn das Element angesehen wird";
...
$txt['enable_personal_saltkey_cookie'] = "Speicherung des persönlichen SALT-Schlüssels in Cookie erlauben";
...
$txt['error_group_noparent'] = "Kein übergeordnetes Verzeichnis ausgewählt!";
...
$txt['error_mcrypt_not_loaded'] = "Das PHP-Modul 'mcrypt' ist nicht geladen. Dieses Modul ist für TeamPass erforderlich. Bitte informieren Sie den Administrator, falls diese Meldung erscheint. ";
...
$txt['error_no_edition_possible_locked'] = "Editieren nicht möglich! Das Element wird gerade bearbeitet!";
...
$txt['error_role_complex_not_set'] = "Eine Rolle muss die minimale Passwortkomplexität aufweisen!";
$txt['error_role_exist'] = "Diese Rolle existiert bereits!";
...
$txt['error_string_not_utf8'] = "Fehler - der String hat nicht das UTF8-Format!";
...
$txt['field_add_in_category'] = "Ein neues Feld in dieser Kategorie hinzufügen";
...
$txt['forgot_my_pw_email_sent'] = "E-Mail wurde verschickt";
$txt['forgot_my_pw_error_email_not_exist'] = "Diese E-Mail-Mail-Adresse existiert nicht!";
$txt['forgot_my_pw_text'] = "Ihr Passwort wird per E-Mail an die Ihrem Konto zugeordnete Adresse zugeschickt.";
...
$txt['for_selected_items'] = "Für ausgewähltes Element";
$txt['functions'] = "Rollen";
$txt['function_alarm_no_group'] = "Diese Rolle wurde keinem Ordner zugeordnet!";
$txt['ga_bad_code'] = "Der Google Authenticator Code ist falsch";
$txt['ga_enter_credentials'] = "Sie müssen Ihre Anmeldedaten eingeben.";
$txt['ga_identification_code'] = "Identication Code";
$txt['ga_not_yet_synchronized'] = "Identifizieren Sie sich mit dem Google Authenticator";
$txt['ga_scan_url'] = "Bitte scannen Sie diesen QR-Code mit Ihrer Google Authenticator-App. Kopieren Sie von ihr den Identifizierungscode.";
...
$txt['give_new_email'] = "Bitte geben Sie eine neue E-Mail-Adresse ein für";
...
$txt['index_get_identified'] = "Bitte melden Sie sich an.";
$txt['index_identify_button'] = "Anmelden";
...
$txt['info_list_of_connected_users_approximation'] = "Anmerkung: Diese Liste kann mehr angemeldete Benutzer als tatsächlich der Fall ist.";
$txt['is_admin'] = "Administrator";
$txt['is_administrated_by_role'] = "Benutzer wird verwaltet von";
$txt['is_manager'] = "Manager";
$txt['is_read_only'] = "ist nur lesbar";
$txt['items'] = "Elemente";
$txt['items_browser_title'] = "Ordner";
$txt['items_changed'] = "wurde geändert.";
$txt['item_copy_to_folder'] = "Bitte wählen Sie das Verzeichnis in welches das Element kopiert werden soll.";
$txt['item_edition_start_hour'] = "In Bearbeitung seit";
...
$txt['item_share_text'] = "Um dieses Element per E-Mail mitzuteilen, geben Sie die E-Mail-Adresse ein und drücken Sie die SEND-Taste.";
$txt['item_updated_text'] = "Dieses Element wurde verändert. Sie müssen es aktualisieren, bevor Sie es verändern.";
$txt['kbs'] = "KBs";
...
$txt['login_time'] = "Protokolliert seit";
$txt['logs'] = "Verbindungsprotokoll";
$txt['logs_1'] = "Protokoll für Passworterneuerungen erstellen vom";
$txt['logs_passwords'] = "Passwortprotokoll";
$txt['maj'] = "Großbuchstaben";
$txt['managed_by'] = "Verwaltet von";
$txt['managers_of'] = "Verwalter von Rolle";
...
$txt['new_category_label'] = "Neue Kategorie erstellen - Label eingeben";
$txt['new_field_title'] = "Den Titel des neuen Feldes eingeben";
...
$txt['pdf_export'] = "PDF-Export";
$txt['pdf_password'] = "PDF-Schlüssel zum Verschlüsseln";
$txt['pdf_password_warning'] = "Sie müssen einen Schlüssel eingeben!";
$txt['personal_folder'] = "Persönlicher Ordner";
$txt['personal_saltkey_change_button'] = "Ändern!";
$txt['personal_saltkey_cookie_duration'] = "Gültigkeitsdauer des Cookies des persönlichen SALT-Schlüssels vor Ablauf";
...
$txt['purge_done'] = "Bereinigung wurde durchgeführt!<br />Anzahl gelöschter Elemente: ";
$txt['purge_log'] = "Log-Einträge bereinigen von";
$txt['purge_now'] = "Jetzt bereinigen!";
$txt['pw'] = "Passwort";
...
$txt['pw_recovery_info'] = "Nach Anklicken der nebenstehenden Taste erhalten Sie eine E-Mail mit einem neuen Passwort zu Ihrem Benutzerkonto ";
...
$txt['reload_table'] = "Tabelle neuladen";
...
$txt['save_categories_position'] = "Reihenfolge der Kategorien speichern";
$txt['secure'] = "Sicher";
...
$txt['settings_encryptClientServer'] = "Datenaustausch zwischen Server und Client ist verschlüsselt";
$txt['settings_encryptClientServer_tip'] = "Die Verschlüsselung nach AES-256 ist aktiviert standardmäßig, d.h. falls für den abgesicherten Datenautausch zwischen Client und Server kein SSL-Zertifikat benutzt wird. Falls Sie das SSL-Protokoll benutzen oder Teampass im Intranet einsetzen, dann können Sie diese Option deaktivieren, um die Anzeige von Daten in Teampass zu beschleunigen. Bitte bedenken Sie, dass eine SSL-Verbindung zwischen Client und Server sicherer ist.";
...
$txt['settings_importing'] = "Import von Daten aus CVS-/Keypass-Dateien erlauben";
$txt['settings_insert_manual_entry_item_history'] = "Manuelles Hinzufügen von Einträgen in das Logbuch der Elemente erlauben";
...
$txt['settings_ldap_elusers'] = "Nur für lokale Benutzer von TeamPass";
$txt['settings_ldap_elusers_tip'] = "Diese Option ermöglicht es den Benutzern, sich über das LDAP zu authentifizieren. Deaktivieren Sie dies, wenn Sie ein LDAP-Verzeichnis durchgehen wollen.";
...
$txt['settings_ldap_type'] = "Typ von LDAP-server";
...
$txt['settings_offline_mode'] = "Offlinemodus aktivieren";
...
$txt['settings_tree_counters'] = "Mehr Zähler im Verzeichnisbaum anzeigen";
$txt['settings_tree_counters_tip'] = "Dies wird für jedes Verzeichnis 3 Zähler anzeigen: Anzahl von Elementen im Verzeichnis, Anzahl von Elementen in allen Verzeichnissen, Anzahl von Verzeichnissen. Diese Option erfordert mehr SQL-Anfragen und die Darstellung des Verzeichnisbaums kann verzögert werden.";
$txt['settings_upload_docext'] = "Erlaubte Namenserweiterungen für Dokumente.";
$txt['settings_upload_docext_tip'] = "Typen von Dokumenten. Bitte geben Sie die erlaubten Namenserweiterungen, getrennt durch Kommata (,) ein.";
$txt['settings_upload_imageresize_options'] = "Sollte die Größe der Bilder verändert werden?";
$txt['settings_upload_imageresize_options_h'] = "Neue Bildhöhe (in Pixeln)";
$txt['settings_upload_imageresize_options_q'] = "Neue Bildqualität";
$txt['settings_upload_imageresize_options_tip'] = "Wenn aktiviert, verändert diese Option die Größe der Bilder auf das angegebene Format.";
$txt['settings_upload_imageresize_options_w'] = "Neue Bildbreite (in Pixeln)";
$txt['settings_upload_imagesext'] = "Erlaubte Namenserweiterungen für Bilder.";
$txt['settings_upload_imagesext_tip'] = "Typen von Bildern. Bitte geben Sie die erlaubten Namenserweiterungen, getrennt durch Kommata (,) ein.";
$txt['settings_upload_maxfilesize'] = "Maximale Dateigröße (in Mb)";
$txt['settings_upload_maxfilesize_tip'] = "Maximal erlaubte Dateigröße. Sie sollte mit den Einstellungen Ihres Servers konsistent sein.";
$txt['settings_upload_otherext'] = "Andere erlaubte Namenserweiterungen.";
$txt['settings_upload_otherext_tip'] = "Andere Dateitypen. Bitte geben Sie die erlaubten Namenserweiterungen, getrennt durch Kommata (,) ein.";
$txt['settings_upload_pkgext'] = "Erlaubte Namenserweiterungen für Packages.";
$txt['settings_upload_pkgext_tip'] = "Typen von Packages. Bitte geben Sie die erlaubten Namenserweiterungen, getrennt durch Kommata (,) ein.";
$txt['setting_can_create_root_folder'] = "Authentifizieren zum Anlegen von neuen Verzeichnissen in Root-Ebene";
$txt['share'] = "Dieses Element mitteilen";
$txt['share_sent_ok'] = "Die E-Mail wurde versandt.";
$txt['show'] = "Zeigen";
...
$txt['symbols'] = "Symbole";
$txt['tags'] = "Tags";
$txt['Test the Email configuration'] = "Dieser Test versendet eine E-Mail an die eingegebene Adresse. Falls Sie diese E-Mail nicht erhalten, überprüfen Sie, bitte, Ihre Anmeldedaten.";
...
$txt['user_activity'] = "Benutzeraktivität";
...
$txt['user_login'] = "Anmeldung";
$txt['user_mngt'] = "Benutzerverwaltung";
$txt['use_md5_password_as_salt'] = "Benutze das Login-Passwort als SALT-Schlüssel";
