...
$txt['2factors_confirm_text'] = "Saisir le mot de passe unique";
$txt['2factors_image_text'] = "Merci de scanner le QR code";
$txt['2factors_tile'] = "Identification 2-Factors";
...
$txt['admin_2factors_authentication_setting'] = "Activer l'identification 2-Factors de Google";
$txt['admin_2factors_authentication_setting_tip'] = "<span style='font-size:11px;max-width:300px;'>L'identification Google 2-Factors permet d'accroitre la sécurité de connexion des Utilisateurs. Dès lors qu'un utilisateur veut se connecter, un code unique à flasher est généré. Ce code doit etre scanné et fournit par l'utilisateurs en plus de son mot de passe traditionnel.<br />ATTENTION : Cette fonctionnalité nécessite une connexion permanente à Internet ainsi qu'un smartphone.</span>";
