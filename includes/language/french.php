...
$txt['admin_proxy_ip'] = "IP du Proxy";
$txt['admin_proxy_ip_tip'] = "<span style='font-size:11px;max-width:300px;'>Si votre connexion Internet transite par un proxy. Indicer ici son IP.<br />Laisser vide si aucun Proxy n'est utilisé.</span>";
$txt['admin_proxy_port'] = "PORT du Proxy";
$txt['admin_proxy_port_tip'] = "<span style='font-size:11px;max-width:300px;'>Si vous avez saisi une adresse IP pour le Proxy, maintenant indiquer son PORT. Cela peut être 880.<br />Laisser vide si aucun Proxy n'est utilisé.</span>";
