...
return array(
    ...
    'open_website' => 'Accèder au site web',
    ...
    'user_disable_status' => 'Cocher la cache pour désactiver',
    ...
    'settings_ldap_additional_user_dn_tip' => 'Cette valeur est utilisé en plus de la base DN lors de la recherche et du chargement d\'utilisateurs. Si aucune valeur n\'est fournie, la recherche de sous-arbres commencera à partir de la base. Exemples: ou=Users ; cn=users',
    ...
    'perform_checks' => 'Vérification en cours',
    ...
    'ldap_user_password_is_used_for_authentication' => 'Le mot de passe utilisateur de l\'AD est utilisé pour l\'authentification',
    ...
    'clipboard_password_life_duration' => 'Délai en secondes avant effacement du presse-papier',
    ...
    'clipboard_will_be_cleared' => 'Le mot de passe a été copié. Il sera bientot supprimé ...',
    'file_folder_not_accessible' => 'Le répertoire Files n\'est pas accessible',
    'error_missing_id' => 'Une erreur est survenue. Un ID est manquant ... ?',
    ...
    'no_data_to_display' => 'Rien à afficher ! Soit aucun répertoire n\'existe, soit vous n\'avez aucun accès.',
    'server' => 'Serveur',
    ...
    'password_overview_delay_tip' => 'Permet de définir la durée d\'affichage en clair à l\'utilisateur d\'un mot de passe',
    ...
    'otv_message' => 'Vous pouvez partager cet objet à un invité. Cette vue permet à cet invité d’accéder à un certain nombre de champs de l\'objet sans avoir à s\'identifier. Merci de noter que le lien généré sera valide unique pour une durée de ##otv_expiration_period##  jours. Copier et partager le lien ci-dessous.',
    ...
    'no_data_selected' => 'Pas de données sélectionnées',
    ...
    'data_type_for_import' => 'Commencer par choisir le type de source à importer',
    ...
    'request_access_reason' => 'Fournir la raison de votre demande',
    ...
    'uploads_configuration' => 'Paramétres de téléversement',
    'email_configuration' => 'Paramétres des email',
    'email_configuration_test' => 'Tester le paramétrage des emails',
