...
return array(
    ...
    'explanation_for_oneshot_backup' => 'Créer une sauvegarde à la volée (sauvegardée dans le répertoires files)',
    ...
    'settings_ldap_group_objectclasses_attibute_tip' => 'Les objectClasses à utiliser lors de la recherche de groupes. Plusieurs objectClasses sont séparées par une virgule (,). Exemple: groupOfNames,group ou top,posixGroup',
    ...
    'bck_scheduled_output_dir_help' => 'Doit rester dans le dossier « files » de TeamPass (par sécurité).',
    ...
    'bck_onthefly_server_backups_help' => 'Ces sauvegardes « à la volée » sont stockées dans le répertoire files. Vous pouvez les télécharger ou les utiliser pour une restauration.',
    ...
    'bck_scheduled_email_report_help' => 'Envoyer un email de rapport aux administrateurs après chaque sauvegarde planifiée.',
    ...
    'inactive_users_never_connected' => 'Jamais connecté',
    ...
    'inactive_users_mgmt_email_body' => 'Bonjour #firstname#,<br><br>Votre compte <b>#login#</b> est inactif depuis <b>#inactivity_days#</b> jours.<br>Sans connexion dans les <b>#grace_days#</b> prochains jours, l’action suivante sera appliquée : <b>#action#</b>.<br><br>Vous pouvez vous connecter ici : <a href="#url#">#url#</a><br><br>Cordialement',
    ...
    'inactive_users_mgmt_tt_user_action_due_on' => 'Action (%s) en retard depuis le %s',
    'inactive_users_mgmt_tt_user_no_email' => 'Aucune adresse email pour avertir l’utilisateur',
    ...
    'health_overview' => 'Vue d\'ensemble',
    'health_top_labels' => 'Actions les plus fréquentes',
    'health_top_users' => 'Utilisateurs les plus actifs',
    'health_recent_events' => 'Évènements récents',
    'health_refresh' => 'Actualiser',
    'health_export' => 'Exporter JSON',
    'health_export_filename' => 'teampass-rapport-sante.json',
    ...
    'health_logs' => 'Logs',
    'health_migration_progress' => 'Avancement des migrations',
    'health_migration_users' => 'Utilisateurs migrés (phpseclib v3)',
    'health_migration_sharekeys_items' => 'Sharekeys (items) migrées',
    'health_migration_personal_items' => 'Éléments personnels migrés',
    'health_findings' => 'Points d’attention',
    'health_sharekeys_orphans' => 'Sharekeys orphelines',
    'health_hash_integrity' => 'Hash d’intégrité',
    'health_hash_missing' => 'Manquants',
    'health_hash_mismatch' => 'Non conformes',
    'health_hash_ok' => 'OK',
    'health_reason' => 'Raison',
    'health_reason_mismatch' => 'Hash non conforme',
    'health_reason_missing_seed' => 'Seed de dérivation manquante',
    'health_reason_missing_public_key' => 'Clé publique manquante',
    'health_reason_missing_hash' => 'Hash stocké manquant',
    'health_integrity_not_available' => 'Contrôle d’intégrité indisponible (fichier secure illisible ou librairie crypto absente).',
    ...
    'health_check_upload_limits_mismatch' => 'upload_maxfilesize Teampass (%s) est supérieur aux limites PHP (upload_max_filesize=%s, post_max_size=%s).',
    'health_check_execution_time' => 'Limites de temps d’exécution',
    'health_check_execution_time_mismatch' => 'task_maximum_run_time Teampass (%s s) est supérieur à max_execution_time PHP (%s s).',
    'health_database_version' => 'Version base',
    'health_database_latency' => 'Latence BDD',
    'health_database_size' => 'Taille base',
    'health_database_tables_sizes' => 'Tables les plus volumineuses',
    'health_db_fragmentation_note' => 'Une valeur FREE importante peut indiquer de la fragmentation ; envisager OPTIMIZE TABLE en fenêtre de maintenance.',
    'health_table' => 'Table',
    'health_rows' => 'Lignes',
    'health_size' => 'Taille',
    'health_free' => 'Libre',
    ...
    'health_sharekeys_distribution' => 'Répartition des sharekeys par table',
    ...
    'health_sharekeys_items_personal_shared' => 'Sharekeys des items : personnel vs partagé',
    'health_items_scope' => 'Périmètre',
    'health_items_personal' => 'Personnel',
    'health_items_shared' => 'Partagé',
    'health_orphans_missing_object' => 'Objet manquant',
    'health_orphans_missing_user' => 'Utilisateur manquant',
    'health_orphans_inactive_user' => 'Utilisateur inactif/supprimé',
    'health_phpseclib_migration' => 'Cohérence migration phpseclib',
    'health_sharekeys_user_mismatch' => 'Incohérence version utilisateur / sharekeys',
    ...
    'health_backup_status' => 'Statut sauvegarde',
    'health_backup_path' => 'Dossier de sauvegarde',
    'health_backup_tasks' => 'Tâches de sauvegarde',
    'health_backup_no_files' => 'Aucun fichier de sauvegarde trouvé.',
    'health_backup_path_not_readable' => 'Chemin de sauvegarde introuvable ou illisible.',
    'health_backup_old_fmt' => 'Dernière sauvegarde : il y a %s heures.',
    'health_backup_no_data' => 'Informations de sauvegarde indisponibles.',
    'health_modified' => 'Modifié',
    'health_task' => 'Tâche',
    'health_created' => 'Créée',
    'health_finished' => 'Terminée',
    'health_error' => 'Erreur / détails',
    'health_total_logs' => 'Total logs (24h)',
    'health_error_logs' => 'Erreurs (24h)',
    'health_connection_logs' => 'Connexions (24h)',
    'health_top_labels' => 'Labels (Top)',
    'health_top_users' => 'Utilisateurs (Top)',
    'health_recent_events' => 'Événements récents',
    'health_no_data' => 'Aucune donnée',
    'health_not_available' => 'Indisponible',
        'count' => 'Nombre',
