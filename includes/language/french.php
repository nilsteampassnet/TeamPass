...
return array(
    ...
    'restore_done_now_logout' => 'La restauration de la base de données a été effectuée. Vous allez être automatiquement déconnecté pour rafraîchir les variables de session.',
    'backup_and_restore' => 'Sauvegarder et restaurer',
    'explanation_for_oneshot_backup' => 'Créer une sauvegarde ponctuelle de la base de données (stockée dans le répertoire files).',
    'explanation_for_oneshot_restore' => 'Restaurer la base de données à partir d&apos;une sauvegarde précédemment générée.',
    ...
    'email_body_user_config_2' => 'Corps de l&apos;e-mail de configuration utilisateur 2',
    ...
    'bck_storage_usage_tooltip' => "Utilisé : %s / %s (%s%%) - Libre : %s\nChemin : %s",
    ...
    'bck_scheduled_backups_list' => 'Sauvegardes planifiées',
    'bck_scheduled_delete' => 'Supprimer',
    "bck_onthefly_server_backups" => "Sauvegardes disponibles sur le serveur",
    "bck_onthefly_refresh_list" => "Rafraîchir",
    "bck_onthefly_col_date" => "Date",
    "bck_onthefly_col_size" => "Taille",
    "bck_onthefly_col_action" => "Action",
    "bck_onthefly_loading" => "Chargement…",
    "bck_onthefly_no_backups_found" => "Aucun fichier de sauvegarde trouvé dans le répertoire files.",
    "bck_onthefly_use_for_restore" => "Utiliser pour restaurer",
    "bck_onthefly_selected_backup" => "Sauvegarde sélectionnée",
    "bck_onthefly_select_backup_first" => "Merci de sélectionner une sauvegarde d’abord.",
    "bck_onthefly_server_backups_help" => "Ces sauvegardes sont lues depuis le répertoire files du serveur. Sélectionne-en une pour la restaurer (la clé de chiffrement doit être correcte).",
    "bck_onthefly_confirm_delete" => "Souhaites-tu vraiment supprimer ce fichier de sauvegarde ?",
