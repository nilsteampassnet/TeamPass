...
var $maxStrLenRead;
    ...
    public function getMetrics($file, $presubset=0)
    {
        $this->filename = $file;
        ...
        $this->ascent = 0;
        $this->descent = 0;
        if ($presubset) { $this->skip(4); } else { $this->readHeader(); }
    ...
    public function readTableDirectory($presubset=1)
    {
...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function extractInfo($presubset=0)
    {
        ...
        if ($presubset) { $this->skip(18); } else {
    ...
    //            die('Font does not allow subsetting/embedding');
        ...
        ///////////////////////////////////
        $this->seek_table("hhea");
        if ($presubset) { $this->skip(32); } else {
            $ver_maj = $this->read_ushort();
            $ver_min = $this->read_ushort();
            if ($ver_maj != 1)
...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function makeSubset($subset)
    {
        ...
        for ($n=0;$n<$numGlyphs;$n++) {
            ...
            if ($glyphLen > 2 && ($up[1] & (1 << 15))) {
                ...
                while ($flags & GF_MORE) {
                    ...
                    if ($flags & GF_SCALE) { $pos_in_glyph += 2; } elseif ($flags & GF_XYSCALE) { $pos_in_glyph += 4; } elseif ($flags & GF_TWOBYTWO) { $pos_in_glyph += 8; }
                }
            }
            $glyf .= $data;
            $pos += $glyphLen;
