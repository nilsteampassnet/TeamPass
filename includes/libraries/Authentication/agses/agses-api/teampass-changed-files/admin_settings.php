...
if (isset($_POST['save_button'])) {
	...
	// Update agses_sm_enabled
	if (@$_SESSION['settings']['agses_sm_enabled'] != $_POST['agses_sm_enabled']) {
	    updateSettings('agses_sm_enabled', $_POST['agses_sm_enabled']);
	}	
	// Update agses_sm_type
	$agses_sm_type = "";
	if (isset($_POST['agses_sm_type']))
		$agses_sm_type = $_POST['agses_sm_type'];		
	if (@$_SESSION['settings']['agses_sm_type'] != $agses_sm_type) {
	    updateSettings('agses_sm_type', $agses_sm_type);
	}	
	
	// Update agses_sm_url
	if (@$_SESSION['settings']['agses_sm_url'] != $_POST['agses_sm_url']) {
	    updateSettings('agses_sm_url', rtrim($_POST['agses_sm_url'], '/') . '/');
	}
	// Update agses_sm_username
	if (@$_SESSION['settings']['agses_sm_username'] != $_POST['agses_sm_username']) {
	    updateSettings('agses_sm_username', $_POST['agses_sm_username']);
	}
	// Update agses_sm_pwd
	if (@$_SESSION['settings']['agses_sm_pwd'] != $_POST['agses_sm_pwd']) {
	    updateSettings('agses_sm_pwd', $_POST['agses_sm_pwd']);
	}
	
	// Update agses_aahosted_url
	if (@$_SESSION['settings']['agses_aahosted_url'] != $_POST['agses_aahosted_url']) {
	    updateSettings('agses_aahosted_url', rtrim($_POST['agses_aahosted_url'], '/') . '/');
	}
	// Update agses_aahosted_aaid
	if (@$_SESSION['settings']['agses_aahosted_aaid'] != $_POST['agses_aahosted_aaid']) {
	    updateSettings('agses_aahosted_aaid', $_POST['agses_aahosted_aaid']);
	}
	// Update agses_aahosted_apikey
	if (@$_SESSION['settings']['agses_aahosted_apikey'] != $_POST['agses_aahosted_apikey']) {
	    updateSettings('agses_aahosted_apikey', $_POST['agses_aahosted_apikey']);
	}
}
...
echo '
                    <tr style="margin-bottom:3px">
                        ...
                        <td>
                            <input id="agses_aahosted_url" name="agses_aahosted_url" type="text" size="40px" value="', !isset($_SESSION['settings']['agses_aahosted_url']) ? "" : $_SESSION['settings']['agses_aahosted_url'], '" />
                        </td>
                    </tr>';
// Agses auth username
echo '
                    <tr style="margin-bottom:3px">
                        ...
                        <td>
                            <input id="agses_aahosted_aaid" name="agses_aahosted_aaid" type="text" size="40px" value="', !isset($_SESSION['settings']['agses_aahosted_aaid']) ? "" : $_SESSION['settings']['agses_aahosted_aaid'], '" />
                        </td>
                    </tr>';
// Agses auth pwd
echo '
                    <tr style="margin-bottom:3px">
                        ...
                        <td>
                            <input id="agses_aahosted_apikey" name="agses_aahosted_apikey" type="text" size="40px" value="', !isset($_SESSION['settings']['agses_aahosted_apikey']) ? "" : $_SESSION['settings']['agses_aahosted_apikey'], '" />
                        </td>
                    </tr>
				</table>
			</div>';
            ...
            echo   '<div class="" style="padding: 0 .7em;margin-top:15px;">
                    <span class="ui-icon ui-icon-transferthick-e-w" style="float: left; margin-right: .3em;">&nbsp;</span>
                    <b>Agses SM</b>
                </div>
                <div style="margin:0 0 5px 20px;">
...
echo '
                    <tr style="margin-bottom:3px">
                        ...
                        <td>
                            <input id="agses_sm_type" name="agses_sm_type" type="checkbox" size="40px" value="', !isset($_SESSION['settings']['agses_sm_type']) ? "ownsm" : $_SESSION['settings']['agses_sm_type'], '" '.((isset($_SESSION['settings']['agses_sm_type']) && $_SESSION['settings']['agses_sm_type'] == "ownsm") ? 'checked="checked"' : '').' />
                        </td>
                    </tr>';
// Agses server
echo '
                    <tr style="margin-bottom:3px">
                        ...
                        <td>
                            <input id="agses_sm_url" name="agses_sm_url" type="text" size="40px" value="', !isset($_SESSION['settings']['agses_sm_url']) ? "" : $_SESSION['settings']['agses_sm_url'], '" />
                        </td>
                    </tr>';
// Agses auth username
echo '
                    <tr style="margin-bottom:3px">
                        ...
                        <td>
                            <input id="agses_sm_username" name="agses_sm_username" type="text" size="40px" value="', !isset($_SESSION['settings']['agses_sm_username']) ? "" : $_SESSION['settings']['agses_sm_username'], '" />
                        </td>
                    </tr>';
// Agses auth pwd
echo '
                    <tr style="margin-bottom:3px">
                        ...
                        <td>
                            <input id="agses_sm_pwd" name="agses_sm_pwd" type="password" size="40px" value="', !isset($_SESSION['settings']['agses_sm_pwd']) ? "" : $_SESSION['settings']['agses_sm_pwd'], '" />
                        </td>
                    </tr>
					</table>
                </div>';
...
echo '		<div class="" style="padding: 0 .7em;margin-top:15px;">
				...
				<div style="margin:0 0 5px 20px;">
					...
					<td width="200">
						  <span class="ui-icon ui-icon-disk" style="float: left; margin-right: .3em;">&nbsp;</span>
						  <label>Agses Authentication &nbsp;<img src="includes/images/question-small-white.png" class="tip" alt="" title="Enable/Disable Agses Authentication" /> </label>
					</td>
					<td>
						<div class="div_radio">
							<input type="radio" id="agses_sm_enabled_radio1" name="agses_sm_enabled" onclick="changeSettingStatus($(this).attr(\'name\'), 1)" value="1"', isset($_SESSION['settings']['agses_sm_enabled']) && $_SESSION['settings']['agses_sm_enabled'] == 1 ? ' checked="checked"' : '', ' /><label for="agses_sm_enabled_radio1">'.$LANG['yes'].'</label>
							
							<input type="radio" id="agses_sm_enabled_radio2" name="agses_sm_enabled" onclick="changeSettingStatus($(this).attr(\'name\'), 0)" value="0"', isset($_SESSION['settings']['agses_sm_enabled']) && $_SESSION['settings']['agses_sm_enabled'] != 1 ? ' checked="checked"' : (!isset($_SESSION['settings']['agses_sm_enabled']) ? ' checked="checked"':''), ' /><label for="agses_sm_enabled_radio2">'.$LANG['no'].'</label>
								<span class="setting_flag" id="flag_agses_sm_enabled"><img src="includes/images/status', isset($_SESSION['settings']['agses_sm_enabled']) && $_SESSION['settings']['agses_sm_enabled'] == 1 ? '' : '-busy', '.png" /></span>
						</div>
					  <td>
					</tr>
