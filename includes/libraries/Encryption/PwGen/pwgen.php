...
class pwgen
{
    ...
    /**
     * @param integer $length    Length of the generated password. Default: 8
     * @param boolean $secure    Generate completely random, hard-to-memorize passwords. These should only
     ...
     * @param boolean $numerals    Include at least one number in the password. This is the default.
     * @param boolean $capitalize    Include at least one capital letter in the password. This is the default.
     * @param boolean $ambiguous    Don't use characters that could be confused by the user when printed,
     ...
     * @param boolean $no-vowels    Generate random passwords that do not contain vowels or numbers that might be
     ...
     * @param boolean $symbols    Include at least one special character in the password.
     */
