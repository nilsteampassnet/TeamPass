            ...
            if ($data_count[0] > 0 && empty($show_error)) {
                ...
                foreach ($rows as $reccord) {
                    ...
                    if ( empty($id_managed) || $id_managed != $reccord['id'] ) {
                        ...
                        elseif ( in_array($_POST['id'],$_SESSION['personal_visible_groups']) && $reccord['perso'] == 1 ) {
                        ...
                        elseif ( !empty($reccord['restricted_to']) && in_array($_SESSION['user_id'],$restricted_users_array) || (isset($_SESSION['list_folders_editable_by_role']) && in_array($_POST['id'], $_SESSION['list_folders_editable_by_role'])) && in_array($_SESSION['user_id'],$restricted_users_array)) {
