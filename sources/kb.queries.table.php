...
foreach ($rows as $reccord) {
    ...
    //col2
    $ret_cat = $db->fetch_row("SELECT category FROM ".$pre."kb_categories WHERE id = ".$reccord['category_id']);
...
*/
    //col5
    $ret_author = $db->fetch_row( "SELECT login FROM ".$pre."users WHERE id = ".$reccord['author_id'] );
