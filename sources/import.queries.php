...
$separator = ',';
$enclosure = '"';
$fields_expected = ['Label', 'Login', 'Password', 'URL', 'Comments'];
...
//Get some info about personal folder
        ...
        foreach ($post_items as $item) {
            ...
            if (filter_input(INPUT_POST, 'import_csv_anyone_can_modify_in_role', FILTER_SANITIZE_STRING) !== null
...
//read xml file
         ...
         */
        function recursiveKeepassXML($xmlRoot, $xmlLevel = 0): void
        {
            ...
            foreach ($xmlRoot as $nom => $elem) {
                ...
                */
                ...
                //IMPORTING KEEPASS 2 XML FILE
                    ...
                    if ($root === true && $xmlLevel > $levelMin) {
                        //echo $elem.' - '.$nom.' - ';
            ...
            while (! feof($cacheFileF)) {
                ...
                if (! empty($folder)) {
                    ...
                    if (strrpos($folder, $foldersSeparator) > 0) {
                        ...
                        $fold = $folder;
                        $parent_id = $post_folder_id;
                        //permits to select the folder destination
                    }
 ...
 */
function sanitiseString(string $str, string $crLFReplacement): string
{
    $str = preg_replace('#[\r\n]#', $crLFReplacement, $str);
    $str = str_replace('\\', '&#92;', $str);
    $str = str_replace('"', '&quot;', $str);
 ...
 */
function cleanOutput(string &$value): string
{
