...
$rows = DB::query(
    ...
    $sLimit",
    array(
        '0' => filter_var($_GET['search'], FILTER_SANITIZE_STRING),
        '1' => filter_var($_GET['search'], FILTER_SANITIZE_STRING),
        '2' => filter_var($_GET['search'], FILTER_SANITIZE_STRING),
        '3' => filter_var($_GET['search'], FILTER_SANITIZE_STRING),
        '4' => filter_var($_GET['search'], FILTER_SANITIZE_STRING)
    )
);
