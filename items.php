...
if (isset($_GET['group']) && isset($_GET['id'])) {
    ...
    <input type="hidden" name="recherche_group_pf" id="recherche_group_pf" value="', in_array(htmlspecialchars($_GET['group']),
        $_SESSION['personal_visible_groups']) ? '1' : '', '" />
    ...
    echo '<input type="hidden" name="recherche_group_pf" id="recherche_group_pf" value="', in_array(htmlspecialchars($_GET['group']),
        $_SESSION['personal_visible_groups']) ? '1' : '', '" />';
...
if (isset($_SESSION['settings']['restricted_to']) && $_SESSION['settings']['restricted_to'] == 1) {
    echo '
            ...
            <!-- TODO remove author' . $LANG['remove_author'] . ' :<input type="checkbox" size="50" name="edit_remove_author" id="edit_remove_author" /> -->
            <div style="line-height:10px;">&nbsp;</div>
            </div>';
}
