			...
			$cat_field_type = 'checkbox';
                ...
                echo '
                    ...
                    <div style="margin:2px 0 2px 15px;">
                        ...
                        <input type="'.$cat_field_type.'" id="field_'.$field[0].'_'.$field[2].'" class="item_field input_'.$cat_field_type.' '.$cat_field_type.' ui-widget-content ui-corner-all" size="40">
                    </div>';
        }
        echo '
                </div>';
        ...
        foreach ($elem[2] as $field) {
            ...
            echo '
                    ...
                    <div style="margin:2px 0 2px 15px;">
                        ...
                        <input type="'.$cat_field_type.'" id="edit_field_'.$field[0].'_'.$elem[0].'" class="edit_item_field input_'.$cat_field_type.' '.$cat_field_type.' ui-widget-content ui-corner-all" size="40">
                    </div>';
        }
        echo '
                </div>';
