...
$txt['admin_emails_configuration'] = "Configuration des emails";
$txt['admin_emails_configuration_testing'] = "Test de la Configuration";
$txt['admin_email_auth'] = "Le serveur SMTP requière une autentification";
$txt['admin_email_auth_pwd'] = "Autentification mot de passe";
$txt['admin_email_auth_username'] = "Autentification Login";
$txt['admin_email_from'] = "Email de l'expéditeur";
$txt['admin_email_from_name'] = "Nom de l'expéditeur";
$txt['admin_email_port'] = "Port du Serveur";
$txt['admin_email_result_nok'] = "Email non envoyé ... vérifiez votre configuration. Erreur retournée : ";
$txt['admin_email_result_ok'] = "Email envoyé ... vérifiez votre boite de réception.";
$txt['admin_email_send_backlog'] = "Envoyer les emails dans le backlog (actuellement #nb_emails# emails)";
$txt['admin_email_send_backlog_tip'] = "Ce script permet de forcer l'envoi des emails dans la file d'attente de la base de données.<br /> Cela peut prendre plusieurs minutes en focntion du nombre d'emails à envoyer.";
$txt['admin_email_smtp_server'] = "Serveur SMTP";
$txt['admin_email_test_body'] = "Bonjour,<br><br>Email envoyé avec succès.<br><br>Salutations.";
$txt['admin_email_test_configuration'] = "Tester la configuration des emails";
$txt['admin_email_test_subject'] = "[TeamPass] Email de test";
...
$txt['admin_path_to_files_folder'] = "Chemin du répertoire Files";
$txt['admin_path_to_files_folder_tip'] = "<span style='font-size:11px;max-width:300px;'>Le répertoire Files est utilisé pour sauvegarder tous les fichiers générés par TeamPass et ainsi que certains fichiers uploadés.<br />IMPORTANT : pour des raisons de sécurité, ce répertoire ne devrait pas etre dans le répertoire WWW de votre server. Il devrait etre mis dans un endroit protégé avec une regle de redirection.<br />IMPORTANT 2 : Il serait bien de rajouter une tache périodique pour supprimer son contenu.</span>";
$txt['admin_path_to_upload_folder'] = "Chemin vers le répertoire Upload";
$txt['admin_path_to_upload_folder_tip'] = "<span style='font-size:11px;max-width:300px;'>Le répertoire Upload contient tous les fichiers attachés à vos Eléments.<br />IMPORTANT : Pour des raisons de sécurité, ce répertoire ne devrait pas etre dans le répertoire WWW de votre serveur. Il devrait etre mis dans un endroit protégé avec une regle de redirection.<br />IMPORTANT 2 : Ce répertoire ne doit absolument pas etre nettoyé ! Ces fichiers sont associés à vos éléments.</span>";
$txt['admin_pwd_maximum_length'] = "Longueur maximale des mots de passe";
$txt['admin_pwd_maximum_length_tip'] = "La valeur pas défaut est fixée à 40 caractères. Il est import de savoir qu'une taille plus grande aura un impact sur les performances de l'outil. En effet plus la longueur du mot de passe est grande et plus il faut de temps au serveur pour encrypter, décrypter et afficher les éléments.";
...
$txt['admin_url_to_files_folder'] = "URL du répertoire Files";
...
$txt['at_user_email_changed'] = "Email utilisateur #user_login# changé";
...
$txt['enable_personal_saltkey_cookie'] = "La clé de cryptage personnelle est sauvegardée dans un cookie";
...
$txt['pdf_password'] = "Clé d'encryptage du PDF";
$txt['pdf_password_warning'] = "Vous devez fournir une clé d'encryptage";
$txt['personal_folder'] = "Répertoire personnel";
$txt['personal_saltkey_change_button'] = "Changer !";
$txt['personal_saltkey_cookie_duration'] = "Durée avant expiration du cookie de la clé de cryptage personnelle";
...
$txt['tags'] = "Mots clé";
$txt['Test the Email configuration'] = "Ce test doit envoyer un email à l'adresse de l'expéditeur. Si vous ne le recevez pas, vérifiez vos informations.";
