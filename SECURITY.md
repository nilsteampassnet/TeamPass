...
| _pending_      | [GHSA-g797-4rh6-m2xp](https://github.com/nilsteampassnet/TeamPass/security/advisories/GHSA-g797-4rh6-m2xp) | Authorization bypass through a user-controlled key.                                                               | 3.2.1.5  |
| _pending_      | [GHSA-xrjw-r5hx-29rj](https://github.com/nilsteampassnet/TeamPass/security/advisories/GHSA-xrjw-r5hx-29rj) | Broken access control in `do_items_list_in_folder` exposing item metadata from folders the user cannot access.    | 3.2.1.5  |
...
| _pending_      | [GHSA-mwxw-gg4p-8xpc](https://github.com/nilsteampassnet/TeamPass/security/advisories/GHSA-mwxw-gg4p-8xpc) | Second-order stored XSS in the item history detail.                                                               | 3.2.2.1  |
| _pending_      | [GHSA-5vf9-rxqv-g8wp](https://github.com/nilsteampassnet/TeamPass/security/advisories/GHSA-5vf9-rxqv-g8wp) | Stored XSS in the search-results expand card via item label, login and URL.                                       | 3.2.2.1  |
| _pending_      | [GHSA-47xg-w656-j4v4](https://github.com/nilsteampassnet/TeamPass/security/advisories/GHSA-47xg-w656-j4v4) | Stored XSS in the item login field rendered as markup.                                                            | 3.2.2.1  |
| _pending_      | [GHSA-9823-p8pg-rfm4](https://github.com/nilsteampassnet/TeamPass/security/advisories/GHSA-9823-p8pg-rfm4) | API `item/changes` leaking instance-wide item change metadata to callers with no folder access.                   | 3.2.2.1  |
| _pending_      | [GHSA-mq4w-p2gw-pqp4](https://github.com/nilsteampassnet/TeamPass/security/advisories/GHSA-mq4w-p2gw-pqp4) | LAPR: missing endpoint authorization allowing any operator to rotate arbitrary privileged Linux accounts.         | 3.2.2.1  |
| _pending_      | [GHSA-h25r-8cc9-2cg8](https://github.com/nilsteampassnet/TeamPass/security/advisories/GHSA-h25r-8cc9-2cg8) | LAPR: SSH host key verified after authentication, disclosing the privileged credential to a man-in-the-middle.    | 3.2.2.1  |
| _pending_      | [GHSA-v7hq-28rv-qh3p](https://github.com/nilsteampassnet/TeamPass/security/advisories/GHSA-v7hq-28rv-qh3p) | LAPR: missing folder authorization in `delete_account` and `update_account_policy`.                               | 3.2.2.1  |
| _pending_      | [GHSA-fpv9-jxph-qg96](https://github.com/nilsteampassnet/TeamPass/security/advisories/GHSA-fpv9-jxph-qg96) | Unauthenticated HTTP access to the background scheduler entry point.                                              | 3.2.2.2  |
| _pending_      | [GHSA-gxc6-rgv6-wx99](https://github.com/nilsteampassnet/TeamPass/security/advisories/GHSA-gxc6-rgv6-wx99) | REST API ignoring item-level restrictions, exposing the password and TOTP secret of a restricted item.            | 3.2.2.4  |
| _pending_      | [GHSA-jr9q-x7pj-8qh9](https://github.com/nilsteampassnet/TeamPass/security/advisories/GHSA-jr9q-x7pj-8qh9) | Item access check accepting blocked ancestor folders, letting a subfolder grant read the parent folder passwords. | 3.2.2.4  |
| _pending_      | [GHSA-q47m-rvr6-jqw7](https://github.com/nilsteampassnet/TeamPass/security/advisories/GHSA-q47m-rvr6-jqw7) | Folder copy writing into inaccessible folders and copying restricted items; API item move ignoring no-delete.     | 3.2.2.5  |
| _pending_      | [GHSA-vxv5-cr34-5q7g](https://github.com/nilsteampassnet/TeamPass/security/advisories/GHSA-vxv5-cr34-5q7g) | Item edit form checking move rights on the destination folder instead of the item's source folder.                | 3.2.2.5  |
